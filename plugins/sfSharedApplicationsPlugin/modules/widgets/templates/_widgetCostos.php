...
WidgetCosto = function( config ){
    ...
    WidgetCosto.superclass.constructor.call(this, {
...
Ext.extend(WidgetCosto, Ext.form.ComboBox, {
    ...
    initComponent : function() {
        WidgetCosto.superclass.initComponent.call(this);
