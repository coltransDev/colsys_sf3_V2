...
<br />
<?
    if($nintentos <= Constantes::PASSW_INTE){
        ?>
        <form action="<?php echo url_for('adminUsers/changePasswd') ?>" method="POST">
            ...
            <br/>
            <h1><span style="color:red;"><?=$nintentos?$nintentos:0?> de 5 intentos</span></h1><br/>
        ...
        ?>
        <h1>El número de intentos ha acabado. El usuario ha sido bloqueado, por favor consultar con el &aacute;rea de Soporte T&eacute;cnico</h1>
