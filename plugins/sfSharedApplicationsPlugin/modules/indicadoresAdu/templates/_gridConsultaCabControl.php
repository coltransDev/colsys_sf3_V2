...
include_component("indicadoresAdu", "gridDetControl");
?>
<script>
    ...
    Ext.define('GridConsCabControl',{
        ...
        store: Ext.create('Ext.data.Store', {
            ...
            fields: [
                ...
                { name: 'ca_id_ind_cab_control'    , mapping: 'c_ca_id_ind_cab_control'}
            ],
            autoLoad:true,
            remoteSort: false,
             params: {foo: 'bar'},
            ...
            proxy: {
                type: 'ajax',
                url: '/indicadoresAdu/consultaCabControl',
                reader: {
                    type: 'json',
                    rootProperty: 'root'
                }
        ...
        columns: [
            ...
            { header: "Opciones", width: 75, resizable: false, dataIndex: '',
	         renderer: function(value, metaData, record, rowIndex, colIndex, store) {
                     ...
                     return '<a href="javascript:opcion(1,\''+record.data.ca_id_ind_cab_control+'\',\''+record.data.ca_hoja+'\',\''+this.id+'\')"><img src="/images/fam/delete.png" width="16" title="Eliminar"></a>'+
                          '<a href="javascript:opcion(2,\''+record.data.ca_id_ind_cab_control+'\',\''+record.data.ca_hoja+'\',\''+this.id+'\')"><img src="/images/fam/table_go.png" width=16 title="Ver Datos"></a>';
	             return '';
	         }
	     }
        ],
...
function panelGraficas(id)
{
        ...
        items: [
            {
                ...
                buttons: [{
                                ...
                                handler: function() {
                                    ...
                                    var variable=campo.getValue();
                                    var variabled=campo1.getValue();
 ...
 function opcion(tipo,id,hoja,idg)
 {
    if(tipo==1)
    {
        ...
        function showResult(btn){
            if(btn=="yes")
            {
                ...
                {
                    waitMsg: 'Enviando...',
                    url: '/indicadoresAdu/eliminarCabControl',
                    params :	{       
                        "id": id
                    },
    ...
    { 
        ...
        obj=[
            {
                ...
                items: [
                    new GridDetControl(
                            {'columns':<?=json_encode($fields)?>, 'id':'grid-det-control'+id,
                        'name':'grid-det-control'+id, 'idcabcontrol':id,'iditem':id,title: 'Datos'}),
                    panelGraficas(id)
                ]
            }
        ],
        ...
        Ext.getCmp('grid-det-control'+id).getStore().load({
            params: {
                idcabcontrol : id
            }
        });
