...
<!--$this->resul[$k]["ca_iddestino1"]=$ciu_simi["ca_idciudad"];
    ...
    <tr>
        <th>Fecha Siglo XXI</th><td><?=$resul["ca_fchsiga"]?> <input type="hidden" name="ca_fchsiga" id="ca_fchsiga" value="<?=$resul["ca_fchsiga"]?>"></td>
        <th>Fecha Entrega Transportador</th><td><?=$resul["ca_fchenttransportador"]?> <input type="hidden" name="ca_fchenttransportador" id="ca_fchenttransportador" value="<?=$resul["ca_fchenttransportador"]?>"></td>
    </tr>
    ...
    <tr>
        ...
        <th>Transporte</th><td><?= utf8_decode($resul["ca_transporte"])?> <input type="hidden" name="ca_transporte" id="ca_transporte" value="<?=utf8_decode($resul["ca_transporte"])?>"></td>
    </tr>
    
    <tr>
        <th>Reconocimiento</th><td><?=$resul["ca_reconocimiento"]?> <input type="hidden" name="ca_reconocimiento" id="ca_reconocimiento" value="<?=$resul["ca_reconocimiento"]?>"></td>
        <th></th><td></td>
    </tr>
