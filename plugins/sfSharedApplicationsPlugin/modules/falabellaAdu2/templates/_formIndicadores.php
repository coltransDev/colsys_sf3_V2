...
var winIndicadorAereo;
var datos=datosFact=datosAereo=null;
<?
if($idcliente=="900017447")
{
?>
...
{
?>
    var arrayColors=['#D63100','#004272','#4572A7', '#AA4643', '#89A54E', '#80699B', '#3D96AE', '#DB843D', '#92A8CD', '#A47D7C', '#B5CA92', '#0000FF', '#0066FF', '#00CCFF','#562F1E', '#AF7F24', '#263249', '#5F7F90', '#D9CDB6' ];
<?
}
    ...
    buttons: [{
        ...
        handler: function() {
            ...
            if(!tabpanel.getChildByElement('tab'+idtab) )
            {
                ...
                Ext.Ajax.request({
                    url: '<?=$pref?>/falabellaAdu2/datosPie',
                    params: {                            
                    ...
                    success: function(response, opts) {
                        ...
                        ///////////////////ENCABEZADOS////////////////////////////////                        
                                Ext.create('Ext.panel.Panel',{
                                    title: 'REPORTE DE OPERACIONES MARITIMAS',
                                    titleAlign:'center',
                                ...
                                Ext.create('Colsys.FalabellaAdu.PanelIndDet',{
                                    ...
                                    items: [
                                    {
                                        ...
                                        store: Ext.data.JsonStore({                        
                                            ...
                                            proxy: {                                                
                                                url: '<?=$pref?>/falabellaAdu2/datosGrafica',
                                                extraParams: {
    ...
    },
    {
        ...
        handler: function() {
            ...
            if(!tabpanel.getChildByElement('tabf'+idtab) )
            {
                ...
                Ext.Ajax.request({                    
                    url: '<?=$pref?>/falabellaAdu2/datosIndAereo',
                    params: {                            
                        fecha1:Ext.getCmp("fecha1").getRawValue(),
                        fecha2:Ext.getCmp("fecha2").getRawValue(),
                        eta1:Ext.getCmp("eta1").getRawValue(),
                    ...
                    success: function(response, opts) {
                        ...
                        if( res.success)
                        {
                            obj=[
                                ...
                                Ext.create('Ext.panel.Panel',{
                                    title: 'REPORTE DE OPERACIONES AEREAS',
                                    titleAlign:'center',
                                    id:"panel-operacionesA"+idtab,
                                    html: res.encabezados,
                                    bodyStyle: {                            
                                        align:'center',
                                        padding: '10px'
                                ...
                                Ext.create('Colsys.FalabellaAdu.PanelIndDet',{
                                    title: 'ETA-DOCUMENTOS ORIGINALES',
                                    id:"panel-indaereo1"+idtab,
                                    items: [
                                        grafica({id:'hci1a'+idtab,title:'INDICADOR DOCUMENTOS',datos:JSON.stringify(res.indicador1)}),
                                        {
                                            xtype:'Colsys.FalabellaAdu.GridDatosIndDet',
                                            id:'gi1a'+idtab,
                                            name:'gi1a'+idtab,
                                            columns: columnasgrid('AereoDocs','')
                                        }
                                    ]
                                }),
                                Ext.create('Colsys.FalabellaAdu.PanelIndDet',{
                                    title: 'ETA-DESCRIPCCIONES MINIMAS',
                                    id:"panel-indaereo2"+idtab,
                                    items: [
                                        grafica({id:'hci2a'+idtab,title:'INDICADOR DESCRIPCIONES',datos:JSON.stringify(res.indicador2)}),
                                        {
                                            xtype:'Colsys.FalabellaAdu.GridDatosIndDet',
                                            id:'gi2a'+idtab,
                                            name:'gi2a1'+idtab,
                                            columns: columnasgrid('AereoDesc','')
                                        }
                                    ]
                                }),
                                Ext.create('Colsys.FalabellaAdu.PanelIndDet',{
                                    title: 'INDICADOR DE OPTIMIZACION NACIONALIZACION',
                                    id:"panel-indaereo3"+idtab,
                                    items: [
                                        grafica({id:'hci3a'+idtab,title:'INDICADOR OPTIMIZACION',datos:JSON.stringify(res.indicador3)}),
                                        {
                                            xtype:'Colsys.FalabellaAdu.GridDatosIndDet',
                                            id:'gi3a'+idtab,
                                            name:'gi3a'+idtab,
                                            columns: columnasgrid('AereoNal','')
                                        }
                                    ]
                                }),
                                Ext.create('Colsys.FalabellaAdu.PanelIndDet',{
                                    title: 'LINEAS',
                                    id:"panel-indaereo4"+idtab,                        
                                    items: [
                                    {
                                        xtype: 'highchart',
                                        id:'hci4a'+idtab,
                                        name:'hci3a'+idtab,
                                        store: Ext.data.JsonStore({                        
                                            fields: ['tipo', 'Deposito','Consolidado'],
                                            proxy: {                                                
                                                url: '<?=$pref?>/falabellaAdu2/datosGrafica',
                                                extraParams: {
                                        ...
                                        chartConfig : {
                                            ...
                                            tooltip : {
                                                pointFormat: '<span style="color:{series.color}"><b>{series.name}</b></span>: <b>{point.y}<br/>',
                                                shared: true
                                    ...
                                    },
                                    {
                                        ...
                                        name:'gi4a'+idtab,
                                        columns: [                                            
                                            {text: "Linea", width: 120, dataIndex: 'Linea', sortable: true},
                                            {text: "Deposito", width: 120, dataIndex: 'Deposito', sortable: true},
                                            {text: "Consolidado", width: 120 , dataIndex: 'Consolidado', sortable: true}
                                        ]
                                    }
                                    ]
                                })
                        ...
                        store=Ext.getCmp('gi1a'+idtab).store;
                        store.loadData(res.indicador1grid);
                        
                        store=Ext.getCmp('gi2a'+idtab).store;
                        store.loadData(res.indicador2grid);
                        
                        store=Ext.getCmp('gi3a'+idtab).store;
                        store.loadData(res.indicador3grid);
                        
                        store=Ext.getCmp('gi4a'+idtab).store;
                        //alert(res.indicadior4grid.toSource());
                        store.loadData(res.indicador4grid);
                        
                        /*store=Ext.getCmp('gi4a'+idtab).store;
                        store.loadData(res.indicador4grid);
                        
                        store=Ext.getCmp('gi5a'+idtab).store;
                        store.loadData(res.indicador5grid);
                        
                        store=Ext.getCmp('gi6a'+idtab).store;
    ...
    },
    {
        ...
        handler: function() {
            ...
            if(!tabpanel.getChildByElement('tabf'+idtab) )
            {
                ...
                Ext.Ajax.request({                    
                    url: '<?=$pref?>/falabellaAdu2/datosIndFact',
                    params: {                            
                        fecha1:Ext.getCmp("fecha1").getRawValue(),
                        fecha2:Ext.getCmp("fecha2").getRawValue(),
                        eta1:Ext.getCmp("eta1").getRawValue(),
    ...
    
    {
        ...
        handler: function() {
            ...
            if(!tabpanel.getChildByElement('tab'+idtab) )
            {
                ...
                Ext.Ajax.request({                    
                    url: '<?=$pref?>/falabellaAdu2/datosFacturacion',
                    params: {                            
                        fecha1:Ext.getCmp("fecha1").getRawValue(),
                        fecha2:Ext.getCmp("fecha2").getRawValue(),
                        eta1:Ext.getCmp("eta1").getRawValue(),
...
function cargarWinAereo()
{
    
    if (!winIndicadorAereo) {        
        winIndicadorAereo = Ext.create('Ext.window.Window', {
            title: 'Resumen de Datos',
            header: {
                titlePosition: 2,
                titleAlign: 'center'
            ...
            items: [
                {
                    xtype:'Colsys.FalabellaAdu.GridDatosIndAereo',
                    id:'gresumenaereo',
                    name:'gresumenaereo'
                }
            ]
...
//return;
    ...
    else if(tipo=="AereoDocs" || tipo=="AereoDesc" || tipo=="AereoNal")
    {
        
         return columnsbasic= [            
            {text: (tipo=="AereoNal")?"Total Consolidados":"Total carpetas", width: 140, dataIndex: 'total_carpeta', summaryType: 'sum',sortable: true,
                renderer: function(value,metaData,record,rowIndex,colIndex,store,view) {
...
function callFunction(data,tipo)
{
    ...
    else if(tipo=="AereoDocs" || tipo=="AereoDesc" || tipo=="AereoNal" || tipo=="AereoDocs1" || tipo=="AereoDesc1" || tipo=="AereoNal1")
    {
        cargarWinAereo();
        winIndicadorAereo.show();
        store=Ext.getCmp('gresumenaereo').store;
        datosTemp=datosAereo;
    }
    else
    {
        //console.log(data);
