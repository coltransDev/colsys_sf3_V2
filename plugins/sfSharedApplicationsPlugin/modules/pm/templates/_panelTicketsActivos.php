...
PanelTicketsActivos = function( config ){
    ...
    */
    ...
    this.store = new Ext.data.GroupingStore({
        ...
        sortInfo:{field: 'opened', direction: "DESC"},
        //groupOnSort: true,
        groupField: 'group',
        listeners: {            
    ...
    PanelTicketsActivos.superclass.constructor.call(this, {
...
Ext.extend(PanelTicketsActivos, Ext.grid.GridPanel, {
