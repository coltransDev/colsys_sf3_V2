                    ...
                    <tr><td colspan="3"><table><tr><td width="135"><img src="https://www.colsys.com.co/images/logo_colsys.gif" width="178" height="30" alt="COLSYS"></td>
                        ...
                        <tr>
                            <td>&nbsp;</td><td>
                                ...
                                <font size="2" face="arial, helvetica, sans-serif" color="#000000"><b><?= ($es_auditoria) ? "Reportado a:" : "Reportado por:"; ?></b> <?= $ticket->getUsuario() ? $ticket->getUsuario()->getCaNombre() : $ticket->getCaLogin() ?> <?= $ticket->getCaReportedby() ? " por " . $ticket->getCaReportedby() : "" ?></font><br />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p><font size="2" face="arial, helvetica, sans-serif" color="#000000"><b>Respuestas</b></font><br></p>
                                    <?
                                    if(count($childrens)>0){
                                        echo "<br/><span style='color:blue;'><b>Ticket unificado con el (los) tickets: </b></span>";
                                        foreach($childrens as $children ){
                                            ?>
                                            <a href="https://www.colsys.com.co/pm/verTicket/id/<?=$children->getCaIdticket()?>" target="_blank"><?=$children->getCaIdticket()?></a>
                                            <!--<a href="#" onClick="openTab(<?=$children->getCaIdticket()?>)">Respuesta</a></div>-->
                                            <?  
                                        }
                                    }                                    
                        ...
                        if (count($entregas) > 0) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="https://www.colsys.com.co/images/spacer.gif" width="1" height="1" alt="">
                                    <p><font size="2" face="arial, helvetica, sans-serif" color="#000000"><b>Programaci&oacute;n de Entregas</b></font><br>
                                    <div style="background-color:#F6F6F6;border-color:#CCCCCC;border-style:dotted;border-width:1px;margin:12px 0 0;padding:12px 12px 24px;font-size: 12px;font-family: arial, helvetica, sans-serif;">
                                        <table class="box">
                                            <tr>
                                                <th>Etapa</th>
                                                <th>Detalle</th>
                                                <th>Fch. Estimada Entrega</th>
                                                <th>Fch. Real de Entrega</th>
                                            </tr>
                                            <?
                                            foreach($entregas as $entrega){
                                                ?>
                                                <tr>
                                                    <td><?=$entrega->getCaStage()?></td>
                                                    <td><?=$entrega->getCaDetail()?></td>
                                                    <td><?=$entrega->getCaEstimated()?></td>
                                                    <?
                                                    if($entrega->getCaIdresponse()){
                                                        ?>
                                                        <td><?=$entrega->getHdeskResponse()->getCaCreatedat()?></td>                                                        
                                                        <?
                                                    }else{
                                                        ?>
                                                        <td>&nbsp;</td>
                                ...
                                <td>
                                    ...
                                    if ($empresa != 'TPLogistics')
                                        if ($ticket->getUsuario()->getSucursal()->getEmpresa()->getCaIdempresa() == 4)
                                            ...
                                            $url = "https://www.colsys.com.co" . url_for("/pm/verTicket?id=" . $ticket->getCaIdticket());
                                        else
                                            $url = 'https://www.tplogistics.com.pe' . url_for("/pm/verTicket?id=" . $ticket->getCaIdticket());
                                    ?>
                                    <font size="1" face="arial, helvetica, sans-serif" color="#000000"> Si los links no estan funcionando, copie y pegue esta dirección en el navegador:<br><a target="_blank" href="<?= $url ?>"><?= $url ?>/</a> <br><br> Gracias por utilizar el sistema de tickets!<br><br>Colsys - Grupo Empresarial Coltrans<br></font>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
