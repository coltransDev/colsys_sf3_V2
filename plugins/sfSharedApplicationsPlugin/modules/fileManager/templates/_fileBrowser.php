...
<script type="text/javascript">
     ...
     *
     * @license FileBrowser is licensed under the terms of the Open Source
    ...
    FileBrowser = function(config){        
        var default_config = {
            actionURL:			'<?=url_for("fileManager/actions")?>/baseFolder/'+Base64.encode(config.baseFolder),
            border:				true,
            closeAction:		'hide',
            cls:				'filebrowser',
            draggable:			false,
    ...
    Ext.extend(FileBrowser, Ext.Panel, {
        ...
        initComponent : function(){
            ...
            FileBrowser.superclass.initComponent.call(this);
