...
Ext.define('Ext.colsys.wgTrafico', {
  extend: 'Ext.form.field.ComboBox',
  alias: 'widget.wTrafico',
  ...
  store: new Ext.data.Store( {
            fields: ['idtrafico','trafico'],
            data : <?=json_encode($data)?>
           }),
  qtip:'Listado de Traficos',
  labelWidth: 60,
  trigger1Class: 'x-form-select-trigger',
    trigger2Class: 'x-form-clear-trigger',
        onRender: function(ct, position){
            Ext.colsys.wgTrafico.superclass.onRender.call(this, ct, position);
            var id = this.getId();
            this.triggerConfig = {
