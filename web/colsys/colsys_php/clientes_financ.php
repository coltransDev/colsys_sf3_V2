...
require_once("menu.php");
	...
	while (!$rs->Eof() and !$rs->IsEmpty()) {                                                      // Lee la totalidad de los registros obtenidos en la instrucción Select
	   ...
	   $idcli = $rs->Value('ca_idcliente');
           ...
           echo " <TR>";
           echo "   <TD Class=listar style='$vetado' COLSPAN='4'><CENTER>Cumplimiento de la documentaci&oacute;n para Circular 0170</CENTER></TD>";
           echo " </TR>";
           echo " <TR>";
           echo "   <TD Class=listar style='$vetado'>Coltrans:<BR /><CENTER>" . $documentos[0]. "</CENTER></TD>";
           echo "   <TD Class=listar style='$vetado'>Colmas:<BR /><CENTER>" . $documentos[1]. "</CENTER></TD>";
           echo "   <TD Class=listar style='$vetado'>ColOTM:<BR /><CENTER>" . $documentos[2]. "</CENTER></TD>";
           echo "   <TD Class=listar style='$vetado'>ColDep&oacute;ositos:<BR /><CENTER>" . $documentos[3]. "</CENTER></TD>";
           echo " </TR>";            
	   echo "  </TABLE></TD>";
	   echo "</TR>";
	   ...
	   echo "  <TR>";
           ...
           echo "    <TD Class=invertir style='font-family: Arial, Helvetica, sans-serif; font-size: 9px; text-align: center'>" . $rs->Value('ca_colotm_std') . "</TD>";
           echo "    <TD Class=invertir style='font-family: Arial, Helvetica, sans-serif; font-size: 9px; text-align: center'>" . $rs->Value('ca_coldepositos_std') . "</TD>";
	   echo "  </TR>";
	   echo "  <TR>";
