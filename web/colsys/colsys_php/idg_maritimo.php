...
//  include_once 'include/seguridad.php';                                      // Control de Acceso al módulo
	...
	$queries = "select 	DISTINCT m.ca_ano, m.ca_mes, m.ca_trafico, i.ca_referencia, i.ca_idcliente, i.ca_compania, i.ca_hbls, i.ca_continuacion, ";
	$queries.= "case when i.ca_continuacion!='N/A' then (select min(ca_fchllegada) from tb_inoavisos_sea ia, tb_emails e where ia.ca_idemail = e.ca_idemail and ia.ca_referencia = i.ca_referencia and ia.ca_idcliente = i.ca_idcliente and ia.ca_hbls = i.ca_hbls and e.ca_tipo = 'Conf.LlegadaOTM' group by ia.ca_referencia, ia.ca_idcliente, ia.ca_hbls) ";
