...
require_once("menu.php");
    ...
    echo "<CENTER>";
    echo "<H3>$titulo</H3>";
    echo "<FORM METHOD=post NAME='menuform' ACTION='inosea_sucu.php' >";
...
//  include_once 'include/seguridad.php';                                      // Control de Acceso al módulo
    ...
    echo "    document.location.href = 'inosea_sucu.php?boton='+opcion+'\&id='+id;";
    echo "}";
...
require_once("menu.php");
    echo "<STYLE>@import URL(\"Coltrans.css\");</STYLE>";                      // Carga una hoja de estilo que estandariza las pantallas den sistema graficador
    echo "<CENTER>";
    echo "<FORM METHOD=post NAME='cabecera' ACTION='inosea_sucu.php'>";             // Hace una llamado nuevamente a este script pero con
...
require_once("menu.php");
             ...
             while (!$rs->Eof() and !$rs->IsEmpty()) {                                                      // Lee la totalidad de los registros obtenidos en la instrucción Select
                ...
                echo "  <TD Class=invertir COLSPAN=2 ROWSPAN=4 style='vertical-align:bottom;'><TABLE WIDTH=220 CELLSPACING=1></TD>";
				echo "		<TR>";
                ...
                echo "  </TABLE></TD>";
                echo "  <TD Class=listar ROWSPAN=4>&nbsp;</TD>";
...
*/
             ...
             echo "</TABLE><BR>";
             echo "<TABLE CELLSPACING=10>";
             echo "<TH><INPUT Class=button TYPE='BUTTON' NAME='boton' VALUE=' Regresar ' ONCLICK='javascript:document.location.href = \"inosea_sucu.php\"'></TH>";  // Cancela la operación
             echo "</TABLE>";
             echo "</FORM>";
             echo "</CENTER>";
//           echo "<P DIR='RTL'><A HREF=\"#\" ONCLICK='javascript:window.open(\"./help/$modulo.html\",\"Ayuda\",\"scrollbars=yes,width=600,height=400,top=200,left=150\")'><IMG SRC='./graficos/help.gif' border=0 ALT='Ayuda en Línea'><BR>Ayuda</A></P>";  // Link que proporciona la Ayuda en línea
