...
require_once("menu.php");
    ...
    echo "<TH><INPUT Class=button TYPE='BUTTON' NAME='boton' VALUE='Terminar' ONCLICK='javascript:document.location.href = \"clientes_adm.php?modalidad=N.i.t.&\criterio=".$rs->Value('ca_idcliente')."\"'></TH>";  // Cancela la operación
    echo "</TABLE>";
    echo "</FORM>";
    echo "</CENTER>";
...
require_once("menu.php");
             ...
             echo "<TH><INPUT Class=button TYPE='BUTTON' NAME='accion' VALUE='Cancelar' ONCLICK='javascript:document.location.href = \"concliente_adm.php?id=$id\"'></TH>";  // Cancela la operación
...
elseif (isset($accion)) {                                                      // Rutina que registra los cambios en la tabla de la base de datos
   ...
   echo "<script>document.location.href = 'concliente_adm.php?id=$id';</script>";  // Retorna a la pantalla principal de la opción
   }
?>