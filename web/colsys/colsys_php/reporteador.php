...
require_once("menu.php");
  ...
  echo "</TR>";
  echo "<TR>";
  echo "  <TD Class=mostrar><A HREF='repindicadores.php'; class='mudacor'>Generador de Indicadores</A></TD><TD Class=mostrar>Módulo Contructor de Indicadores de Gestión</TD>";
  echo "</TR>";
  echo "<TR>";
