...
require_once("menu.php");
    ...
    echo "  <TD Class=listar COLSPAN=5><A HREF=\"#\" ONCLICK='javascript:window.open(\"./links/TARIFAS LCL VENTA DE OTM BOGOTA.pdf\")'><B>Tarifas LCL Venta de OTM Bogotá&nbsp «Haga Click aquí para consultar».</A></B></TD>";
    echo "</TR>";
    echo "<TR>";
    ...
    echo "</TR>";
    echo "<TR>";
    echo "  <TD Class=listar COLSPAN=5><A HREF=\"#\" ONCLICK='javascript:window.open(\"./links/TARIFARIO ASW.xls\")'><B>Tarifario ASW &nbsp; «Haga Click aquí para consultar».</A></B></TD>";
    echo "</TR>";
    echo "<TR>";
    echo "  <TD Class=listar COLSPAN=5><A HREF=\"#\" ONCLICK='javascript:window.open(\"./links/TARIFAS EXPORTACION.xls\")'><B>Tarifario de Exportación &nbsp; «Haga Click aquí para consultar».</A></B></TD>";
    echo "</TR>";
	 echo "<TR>";
...
ADJUNTO LAS TARIFAS CON APLICACION PARA EMBARQUES CON CLIENTES EFECTIVOS Y/O ANTIGUOS (FAVOR HACER CLICK EN ESTE HIPERVÍNCULO):</strong>
            ...
            echo "</TABLE>";
            echo "<TABLE CELLSPACING=10>";
            echo "<TH><INPUT Class=button TYPE='BUTTON' NAME='accion' VALUE='Cerrar' ONCLICK='javascript:document.location.href = \"tarifario.php\"'></TH>";  // Cancela la operación
            echo "</TABLE>";
            echo "</FORM>";
            echo "</CENTER>";
//          echo "<P DIR='RTL'><A HREF=\"#\" ONCLICK='javascript:window.open(\"./help/$modulo.html\",\"Ayuda\",\"scrollbars=yes,width=600,height=400,top=200,left=150\")'><IMG SRC='./graficos/help.gif' border=0 ALT='Ayuda en Línea'><BR>Ayuda</A></P>";  // Link que proporciona la Ayuda en línea
