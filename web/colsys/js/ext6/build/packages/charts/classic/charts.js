Ext.define("Ext.draw.ContainerBase", {
    ...
    downloadCanvas: function (titulo, subtitulo, transporte) {
        var a = this.getImage();
        var grafica = this;
        var targetElement = a.data;
        var myWindow = window.open('', '', 'width=20,height=20');
        myWindow.document.write('<html><head>');
        myWindow.document.write('<title>' + titulo + '</title>');
        ...
        myWindow.document.write('<ul style="margin-left: 15%;border-radius:3px;border-color: rgba(0,0,0,0.6);list-style: none;width: 70%;display: table;float: left;border:0.5px solid;padding-top:6px;padding-bottom:6px;">');
        str = grafica.legendStore;
        myWindow.document.write('</ul>');
        myWindow.document.write(' <canvas id="myCanvas" width="' + (grafica.chartSize.width + 300) + '" height="' + (grafica.chartSize.height + 500) + '" style="background-color:#FFF;"></canvas> ');
        myWindow.document.write('<a id="download" hidden=true>Download as image</a>');
        ...
        logo.onload = function () {
            ctx.drawImage(logo, 50, 30);
        };
        logo.src = "../../images/coltrans_logo.png";
        ctx.stroke();
        var image = new Image();
        image.onload = function () {
            ctx.drawImage(image, 55, 80);
        };
        image.src = targetElement;
        ctx.stroke();

        ctx.rect(0, 0, grafica.chartSize.width + 300, grafica.chartSize.height + 500);
        ctx.fillStyle = "white";
        ctx.strokeStyle = "white";
        ctx.fill();

        ctx.rect(0, 321, 843, 100);
        ctx.fillStyle = "white";
        ctx.strokeStyle = "white";
        ctx.fill();
        ejex = grafica.chartSize.height + 100;
        if (str.getCount() > 0) {
            numerolineas = str.getCount();
            avanzar = (grafica.chartSize.width / 10) ;
            i = avanzar - 100;
            r = 0;
            while (r < numerolineas) {
                reco = str.getAt(r);
                ctx.beginPath();
                ctx.arc((i + 110), ejex, 4, 0, 2 * Math.PI);
                ctx.fillStyle = reco.get('mark');
                ctx.strokeStyle = reco.get('mark');
                ctx.stroke();
                ctx.fill();
                ctx.fillStyle = 'black';
                ctx.font = "5pt sans-serif";
                ctx.fillText(reco.get('name'), (i + 120), (ejex + 2));
                ctx.stroke(); // Draw it
                r++;
                ctx.beginPath();
                i += avanzar;
        ...
        ctx.rect(50, ejex +20 , grafica.chartSize.width, 3);
        ctx.fillStyle = "#38610B";
        ctx.strokeStyle = "#38610B";
        ctx.fill();
        ctx.beginPath();
        ctx.rect(50, ejex +23 , grafica.chartSize.width, 2);
        ctx.fillStyle = "#868A08";
        ctx.strokeStyle = "#868A08";
        ctx.fill();
         ctx.beginPath();
        
        ctx.fillStyle = 'black';
        ctx.font = "18pt sans-serif";
        ctx.fillText(titulo, (grafica.chartSize.width / 2), (ejex + 55));
        ctx.stroke(); // Draw it
        ctx.fillStyle = 'black';
        
        ctx.font = "10pt sans-serif";
        ctx.fillText(subtitulo, (grafica.chartSize.width / 2)+25, (ejex + 75));
        ctx.stroke(); // Draw it
        ctx.fillStyle = 'black';
        
        ctx.font = "10pt sans-serif";
        ctx.fillText(transporte, (grafica.chartSize.width / 2)+70, (ejex + 90));
        ctx.stroke(); // Draw it
        
        
        myWindow.document.getElementById('download').addEventListener('click', function () {
            this.href = myWindow.document.getElementById("myCanvas").toDataURL();
            this.download = 'image.png';
        }, false);
        setTimeout(function () {
            myWindow.document.getElementById('download').click();
        }, 1000);
    },
    previewIndicadores: function (titulo, subtitulo, transporte) {
        var a = this.getImage();
        var grafica = this;
        new Ext.window.Window({
            ...
            /*dockedItems: [{
             ...
             myWindow.document.write('<script type="text/javascript" src="http://dev.sencha.com/deploy/ext-4.0.1/bootstrap.js"></script>');
             myWindow.document.write('</head><body>');
             myWindow.document.write('<div style="margin-left: 15%"><img src="' + targetElement + '" ></img></div>');
             myWindow.document.write('<ul style="margin-left: 15%;border-radius:3px;border-color: rgba(0,0,0,0.6);list-style: none;width: 70%;display: table;float: left;border:0.5px solid;padding-top:6px;padding-bottom:6px;">');
             str = grafica.legendStore;
             for (i = 0; i < str.getCount(); i++) {
             myWindow.document.write('<li style="display: table-cell;overflow: hidden;font-size:10px;">');
             record = str.getAt(i);
             myWindow.document.write('<div style="margin-right:10%;float: left;border-radius:5px;width:10px;height:10px; background-color:' + record.get('mark') + '"></div>');
             myWindow.document.write('<div style="float: left;padding-right:10px;">' + record.get('name') + '</div>');
            ...
            listeners: {
                destoy: function (e, eOpts) {
                    Ext.getCmp('grafica-vistaprevia').remove();
                }
            ...
            items: {
                ...
                items: [{
                        xtype: "panel",
                        html: '<img style="float:left;width:200px;margin-left:10%;" src="../../images/coltrans_logo.jpg"></img>',
                        border: false
                    }, {
                        xtype: "image",
                        mode: "img",
                    ...
                    Ext.create('Ext.chart.Legend', {
                        id: 'grafica-vistaprevia',
                    ...
                    Ext.create('Ext.Panel', {
                        ...
                        html: '<div style="margin-top:15px;width:800px;height:2px;border:solid;border-color:#38610B;border-bottom-color:#868A08;"></div><div style="width:800px;height:60px;padding:0;margin:0;"><div><p style="width:90%;height:60px;text-align:center;font-weight:bold;font-size:22px;"><b>' + titulo + '</b><br><b style="font-size:10px;">' + subtitulo + '</b><br><b style="font-size:10px;">' + transporte + '</b></p></div></div>',
                        listeners: {
...
Ext.define("Ext.draw.Container", {
    ...
    download: function (d) {
        var grafica = this;
        /*this.add(Ext.create('Ext.chart.Legend', {
         id: 'grafica-vistaprevia',
         store: Ext.create('Ext.data.Store', {
         autoload: false,
         model: Ext.create('Ext.data.Model', {
        ...
        /*
         var legend = e.legend;
         var storeLegend = e.legendStore;
         
         var ll = this.innerElement.getSize(),
         aa = Array.prototype.slice.call(container),
         dd, gg, cc = this.surfaceZIndexes,
         ff, ee, bb, hh;
         for (ee = 1; ee < aa.length; ee++) {
         bb = aa[ee];
         hh = cc[bb.type];
         ff = ee - 1;
         while (ff >= 0 && cc[aa[ff].type] > hh) {
         aa[ff + 1] = aa[ff];
         ff--
         }
         aa[ff + 1] = bb
         }
         dd = aa[0].flatten(ll, aa);
         g = new Image();
         g.src = dd.data;
         dd.data = g;
         ...
         //type: "hidden",
         name: 'data1',
         //value:  Ext.String.htmlEncode(Ext.isObject(dd) ? Ext.JSON.encode(dd) : dd)
         value: dd.data.src
         }
         );*/
...
Ext.define("Ext.chart.PolarChart", {extend: "Ext.chart.AbstractChart", requires: ["Ext.chart.grid.CircularGrid", "Ext.chart.grid.RadialGrid"], xtype: "polar", isPolar: true, config: {center: [0, 0], radius: 0, innerPadding: 0}, getDirectionForAxis: function (a) {
        return a === "radial" ? "Y" : "X"
        ...
        var g = this, h = g.getAxes(), d = g.getSeries(), c, f, e, b;
        ...
        if (g.type === "radar" && f && f.length) {
            ...
            if (!a) {
                f.push({type: "category", position: "angular", fields: g.xField || g.angleField, style: {estStepSize: 1}, grid: true})
            }
        }
        ...
        try {
            ...
            var h = F.getSurface("chart").getRect(), v = F.getInsetPadding(), G = F.getInnerPadding(), l = Ext.apply({}, v), d, s = h[2] - v.left - v.right, r = h[3] - v.top - v.bottom, x = [v.left, v.top, s, r], u = F.getSeries(), p, t = s - G * 2, w = r - G * 2, D = [t * 0.5 + G, w * 0.5 + G], j = Math.min(t, w) * 0.5, A = F.getAxes(), f, a, k, m = [], o = [], E = j - G, z, n, b, q, y, c, C;
            F.setMainRect(x);
        ...
        var f = this, g = f.getAxes(), d, c = f.getSeries(), b, a, e;
        for (a = 0, e = g.length; a < e; a++) {
            d = g[a];
            d.getSprites()
        }
...
Ext.define("Ext.chart.SpaceFillingChart", {extend: "Ext.chart.AbstractChart", xtype: "spacefilling", config: {}, performLayout: function () {
        ...
        try {
            ...
            var k = j.getSurface("chart").getRect(), l = j.getInsetPadding(), a = k[2] - l.left - l.right, m = k[3] - l.top - l.bottom, h = [l.left, l.top, a, m], b = j.getSeries(), d, c, g;
...
Ext.define("Ext.chart.axis.sprite.Axis3D", {extend: "Ext.chart.axis.sprite.Axis", alias: "sprite.axis3d", type: "axis3d", inheritableStatics: {def: {processors: {depth: "number"}, defaults: {depth: 0}, triggers: {depth: "layout"}}}, config: {fx: {customDurations: {depth: 0}}}, layoutUpdater: function () {
        ...
        var e = h.attr, d = h.getLayout(), c = d.isDiscrete ? 0 : e.depth, g = f.getInherited().rtl, b = e.dataMin + (e.dataMax - e.dataMin) * e.visibleMin, i = e.dataMin + (e.dataMax - e.dataMin) * e.visibleMax, a = {attr: e, segmenter: h.getSegmenter(), renderer: h.defaultRenderer};
...
Ext.define("Ext.chart.axis.Axis3D", {extend: "Ext.chart.axis.Axis", xtype: "axis3d", requires: ["Ext.chart.axis.sprite.Axis3D"], config: {depth: 0}, onSeriesChange: function (e) {
...
Ext.define("Ext.chart.grid.HorizontalGrid3D", {extend: "Ext.chart.grid.HorizontalGrid", alias: "grid.horizontal3d", inheritableStatics: {def: {processors: {depth: "number"}, defaults: {depth: 0}}}, render: function (a, k, d) {
...
Ext.define("Ext.chart.grid.VerticalGrid3D", {extend: "Ext.chart.grid.VerticalGrid", alias: "grid.vertical3d", inheritableStatics: {def: {processors: {depth: "number"}, defaults: {depth: 0}}}, render_: function (c, d, f) {
...
Ext.define("Ext.chart.interactions.Crosshair", {extend: "Ext.chart.interactions.Abstract", requires: ["Ext.chart.grid.HorizontalGrid", "Ext.chart.grid.VerticalGrid", "Ext.chart.CartesianChart", "Ext.chart.axis.layout.Discrete"], type: "crosshair", alias: "interaction.crosshair", config: {axes: {top: {label: {}, rect: {}}, right: {label: {}, rect: {}}, bottom: {label: {}, rect: {}}, left: {label: {}, rect: {}}}, lines: {horizontal: {strokeStyle: "black", lineDash: [5, 5]}, vertical: {strokeStyle: "black", lineDash: [5, 5]}}, gesture: "drag"}, applyAxes: function (b, a) {
        ...
        if (D > 0 && D < n && C > 0 && C < M) {
            ...
            for (K = 0; K < E.length; K++) {
                ...
                o = u.label || u[z].label;
                L.labelText = L.add(Ext.apply(J, o, {type: "text", x: (function () {
                        switch (z) {
                            case"left":
                                g = a ? a.x + a.width : 0;
                                return g + (d - g - I) / 2 - j;
...
Ext.define("Ext.chart.interactions.ItemEdit", {extend: "Ext.chart.interactions.ItemHighlight", requires: ["Ext.tip.ToolTip"], type: "itemedit", alias: "interaction.itemedit", isItemEdit: true, config: {style: null, renderer: null, tooltip: true, gestures: {dragstart: "onDragStart", drag: "onDrag", dragend: "onDragEnd"}, cursors: {ewResize: "ew-resize", nsResize: "ns-resize", move: "move"}}, item: null, applyTooltip: function (b) {
        if (b) {
            var a = Ext.apply({}, b, {renderer: this.defaultTooltipRenderer, constrainPosition: true, shrinkWrapDock: true, autoHide: true, offsetX: 10, offsetY: 10});
        ...
        var c = this, a = c.getChart(), b = a.getHighlightItem();
        if (b) {
            a.fireEvent("beginitemedit", a, c, c.item = b);
            return false
        }
    }, onDrag: function (f) {
        var d = this, b = d.getChart(), c = b.getHighlightItem(), a = c && c.sprite.type;
        if (c) {
            switch (a) {
                case"barSeries":
        ...
        var e = this, d = e.getChart(), a = d.getFlipXY(), g = e.getCursors(), c = f && f.sprite.type, b = d.el.dom.style;
        e.callParent([f]);
        if (f) {
            switch (c) {
                case"barSeries":
        ...
        var m = this, k = m.getChart(), l = k.getInherited().rtl, f = k.isCartesian && k.getFlipXY(), q = k.getHighlightItem(), g = q.sprite.getMarker("items"), p = g.getMarkerFor(q.sprite.getId(), q.index), b = q.sprite.getSurface(), c = b.getRect(), r = b.getEventXY(i), o = q.sprite.attr.matrix, j = m.getRenderer(), a, n, d, h;
        if (f) {
            h = l ? c[2] - r[0] : r[0]
        } else {
            h = c[3] - r[1]
        ...
        if (f) {
            Ext.apply(t.target, {xField: o.series.getXField(), xValue: (s - k.getDX()) / k.getXX()})
        }
        ...
        var d = this, f = d.target, c = d.getChart(), b = c.getStore(), a;
        if (f) {
            a = b.getAt(f.index);
            if (f.yField) {
...
Ext.define("Ext.chart.interactions.Rotate", {extend: "Ext.chart.interactions.Abstract", type: "rotate", alias: "interaction.rotate", config: {gesture: "rotate", gestures: {rotate: "onRotate", rotateend: "onRotate", dragstart: "onGestureStart", drag: "onGesture", dragend: "onGestureEnd"}, rotation: 0}, oldRotations: null, getAngle: function (f) {
        ...
        var c = this, b = c.getRadius(d), a = c.getEventRadius(d);
        if (b >= a) {
            c.lockEvents("drag");
...
Ext.define("Ext.chart.interactions.RotatePie3D", {extend: "Ext.chart.interactions.Rotate", type: "rotatePie3d", alias: "interaction.rotatePie3d", getAngle: function (g) {
        ...
        var f = this.getChart(), a = f.getRadius(), d = f.getSeries(), h = d.length, c = 0, b, g;
        for (; c < h; c++) {
            b = d[c];
            if (b.isPie3D) {
                g = b.getRadius();
...
Ext.define("Ext.chart.plugin.ItemEvents", {extend: "Ext.plugin.Abstract", alias: "plugin.chartitemevents", moveEvents: false, mouseMoveEvents: {mousemove: true, mouseover: true, mouseout: true}, itemMouseMoveEvents: {itemmousemove: true, itemmouseover: true, itemmouseout: true}, init: function (b) {
        var a = "handleEvent";
        this.chart = b;
...
Ext.define("Ext.chart.series.Cartesian", {extend: "Ext.chart.series.Series", config: {xField: null, yField: null, xAxis: null, yAxis: null}, directions: ["X", "Y"], fieldCategoryX: ["X"], fieldCategoryY: ["Y"], applyXAxis: function (a, b) {
        ...
        if (this.getSprites()) {
            ...
            if (d) {
                ...
                if (c !== -1) {
                    e = {series: f, category: f.getItemInstancing() ? "items" : "markers", index: c, record: b.getData().items[c], field: f.getYField(), sprite: d};
                    return e
                }
            }
        }
...
Ext.define("Ext.chart.series.StackedCartesian", {extend: "Ext.chart.series.Cartesian", config: {stacked: true, splitStacks: true, fullStack: false, fullStackTotal: 100, hidden: []}, spriteAnimationCount: 0, themeColorCount: function () {
        ...
        var F = this, f = F.getStore(), r = f.getData().items, B = r.length, c = F["get" + D + "Axis"](), x = F.getHidden(), a = F.getSplitStacks(), z = F.getFullStack(), l = F.getFullStackTotal(), p = {min: 0, max: 0}, n = F["fieldCategory" + D], C = [], o = [], E = [], h, A = F.getStacked(), g = F.getSprites(), q = [], w, v, u, s, H, y, b, d, G, t;
        if (!g.length) {
            return
        }
...
Ext.define("Ext.chart.series.sprite.Cartesian", {extend: "Ext.chart.series.sprite.Series", inheritableStatics: {def: {processors: {labels: "default", labelOverflowPadding: "number", selectionTolerance: "number", flipXY: "bool", renderer: "default", visibleMinX: "number", visibleMinY: "number", visibleMaxX: "number", visibleMaxY: "number", innerWidth: "number", innerHeight: "number"}, defaults: {labels: null, labelOverflowPadding: 10, selectionTolerance: 20, flipXY: false, renderer: null, transformFillStroke: false, visibleMinX: 0, visibleMinY: 0, visibleMaxX: 1, visibleMaxY: 1, innerWidth: 1, innerHeight: 1}, triggers: {dataX: "dataX,bbox", dataY: "dataY,bbox", visibleMinX: "panzoom", visibleMinY: "panzoom", visibleMaxX: "panzoom", visibleMaxY: "panzoom", innerWidth: "panzoom", innerHeight: "panzoom"}, updaters: {dataX: function (a) {
                ...
                }}}}, processDataY: Ext.emptyFn, processDataX: Ext.emptyFn, updatePlainBBox: function (b) {
        var a = this.attr;
        b.x = a.dataMinX;
        b.y = a.dataMinY;
    ...
    }, renderClipped: Ext.emptyFn, getIndexNearPoint: function (f, e) {
...
Ext.define("Ext.chart.series.sprite.Area", {alias: "sprite.areaSeries", extend: "Ext.chart.series.sprite.StackedCartesian", inheritableStatics: {def: {processors: {step: "bool"}, defaults: {step: false}}}, renderClipped: function (q, s, A) {
...
Ext.define("Ext.chart.series.sprite.Bar", {alias: "sprite.barSeries", extend: "Ext.chart.series.sprite.StackedCartesian", inheritableStatics: {def: {processors: {minBarWidth: "number", maxBarWidth: "number", minGapWidth: "number", radius: "number", inGroupGapWidth: "number"}, defaults: {minBarWidth: 2, maxBarWidth: 100, minGapWidth: 5, inGroupGapWidth: 3, radius: 0}}}, drawLabel: function (k, i, s, h, o) {
        var q = this, n = q.attr, f = q.getMarker("labels"), d = f.getTemplate(), l = q.labelCfg || (q.labelCfg = {}), c = q.surfaceMatrix, j = n.labelOverflowPadding, b = d.attr.display, m = d.attr.orientation, g, e, a, r, t, p;
        l.x = c.x(i, h);
        l.y = c.y(i, h);
        if (!n.flipXY) {
        ...
        if (f) {
            i = Ext.callback(f, null, [g, j, {store: g.getStore()}, e], 0, g.getSeries());
            Ext.apply(j, i)
        }
        ...
        var q = this, o = q.attr, w = o.dataX, v = o.dataY, H = o.labels, n = o.dataStartY, m = o.groupCount, E = o.groupOffset - (m - 1) * 0.5, z = o.inGroupGapWidth, t = u.lineWidth, D = o.matrix, B = D.elements[0], j = D.elements[3], e = D.elements[4], d = G.roundPixel(D.elements[5]) - 1, J = (B < 0 ? -1 : 1) * B - o.minGapWidth, k = (Math.min(J, o.maxBarWidth) - z * (m - 1)) / m, A = G.roundPixel(Math.max(o.minBarWidth, k)), c = q.surfaceMatrix, g, I, b, h, K, a, l = 0.5 * o.lineWidth, L = Math.min(F[0], F[2]), x = Math.max(F[0], F[2]), y = Math.max(0, Math.floor(L)), p = Math.min(w.length - 1, Math.ceil(x)), f = H && q.getMarker("labels"), s, r;
        for (K = y; K <= p; K++) {
            s = n ? n[K] : 0;
            r = v[K];
            a = w[K] * B + e + E * (A + z);
            ...
            q.putMarker("markers", {translationX: c.x(a, h), translationY: c.y(a, h)}, K, true)
        }
...
Ext.define("Ext.chart.series.Bar", {extend: "Ext.chart.series.StackedCartesian", alias: "series.bar", type: "bar", seriesType: "barSeries", requires: ["Ext.chart.series.sprite.Bar", "Ext.draw.sprite.Rect"], config: {itemInstancing: {type: "rect", fx: {customDurations: {x: 0, y: 0, width: 0, height: 0, radius: 0}}}}, getItemForPoint: function (a, f) {
        if (this.getSprites()) {
        ...
        var e = this, g = e.getSprites(), d = g.length, f = [], a = {}, b;
        for (b = 0; b < d; b++) {
            if (!g[b].attr.hidden) {
                f.push(g[b])
            }
...
Ext.define("Ext.chart.series.sprite.Bar3D", {extend: "Ext.chart.series.sprite.Bar", alias: "sprite.bar3dSeries", requires: ["Ext.draw.gradient.Linear"], inheritableStatics: {def: {processors: {depthWidthRatio: "number", saturationFactor: "number", brightnessFactor: "number", colorSpread: "number"}, defaults: {depthWidthRatio: 1 / 3, saturationFactor: 1, brightnessFactor: 1, colorSpread: 1, transformFillStroke: true}, triggers: {groupCount: "panzoom"}, updaters: {panzoom: function (c) {
                ...
                }}}}, config: {showStroke: false}, depth: 0, drawBar: function (p, b, d, c, l, o, a, h) {
        var k = this, i = k.attr, n = {}, j = i.renderer, m, g, f, e;
        n.x = (c + o) * 0.5;
        n.y = l;
        n.width = (o - c) * 0.75;
        n.height = a - l;
...
Ext.define("Ext.chart.series.sprite.Box", {extend: "Ext.draw.sprite.Sprite", alias: "sprite.box", type: "box", inheritableStatics: {def: {processors: {x: "number", y: "number", width: "number", height: "number", depth: "number", orientation: "enums(vertical,horizontal)", showStroke: "bool", saturationFactor: "number", brightnessFactor: "number", colorSpread: "number"}, triggers: {x: "bbox", y: "bbox", width: "bbox", height: "bbox", depth: "bbox", orientation: "bbox"}, defaults: {x: 0, y: 0, width: 8, height: 8, depth: 8, orientation: "vertical", showStroke: false, saturationFactor: 1, brightnessFactor: 1, colorSpread: 1, lineJoin: "bevel"}}}, constructor: function (a) {
        ...
        var u = this, k = u.attr, r = k.x, j = k.y, f = j + k.height, i = j < f, e = k.width * 0.5, v = k.depth, d = k.orientation === "horizontal", g = k.globalAlpha < 1, c = k.fillStyle, n = Ext.draw.Color.create(c.isGradient ? c.getStops()[0].color : c), h = k.saturationFactor, o = k.brightnessFactor, t = k.colorSpread, b = n.getHSV(), a = {}, s, q, p;
        if (!k.showStroke) {
        ...
        u.topGradient.setStops([{offset: 0, color: Ext.draw.Color.fromHSV(b[0], Ext.Number.constrain(b[1] * h, 0, 1), Ext.Number.constrain((0.5 + t * 0.1) * o, 0, 1))}, {offset: 1, color: Ext.draw.Color.fromHSV(b[0], Ext.Number.constrain(b[1] * h, 0, 1), Ext.Number.constrain((0.5 - t * 0.11) * o, 0, 1))}]);
        u.rightGradient.setDegrees(d ? 45 : 90);
        u.rightGradient.setStops([{offset: 0, color: Ext.draw.Color.fromHSV(b[0], Ext.Number.constrain(b[1] * h, 0, 1), Ext.Number.constrain((0.5 - t * 0.14) * o, 0, 1))}, {offset: 1, color: Ext.draw.Color.fromHSV(b[0], Ext.Number.constrain(b[1] * (1 + t * 0.4) * h, 0, 1), Ext.Number.constrain((0.5 - t * 0.32) * o, 0, 1))}]);
        if (d) {
            u.frontGradient.setDegrees(0)
        } else {
            u.frontGradient.setRadians(Math.atan2(j - f, e * 2))
        }
        u.frontGradient.setStops([{offset: 0, color: Ext.draw.Color.fromHSV(b[0], Ext.Number.constrain(b[1] * (1 - t * 0.1) * h, 0, 1), Ext.Number.constrain((0.5 + t * 0.1) * o, 0, 1))}, {offset: 1, color: Ext.draw.Color.fromHSV(b[0], Ext.Number.constrain(b[1] * (1 + t * 0.1) * h, 0, 1), Ext.Number.constrain((0.5 - t * 0.23) * o, 0, 1))}]);
        if (g || i) {
            m.beginPath();
            m.moveTo(r - e, f);
            m.lineTo(r - e + v, f + v);
...
Ext.define("Ext.draw.LimitedCache", {config: {limit: 40, feeder: function () {
            return 0
        }, scope: null}, cache: null, constructor: function (a) {
        this.cache = {};
        this.cache.list = [];
        this.cache.tail = 0;
        this.initConfig(a)
...
Ext.define("Ext.draw.SegmentTree", {config: {strategy: "double"}, time: function (m, l, n, c, E, d, e) {
        ...
        var b = h.length, e = [], s = [], f = [], q = [], j = [], p = [], n = [], o = [], m = [], k = [], g = {startIdx: e, endIdx: s, minIdx: f, maxIdx: q, open: j, minX: p, minY: n, maxX: o, maxY: m, close: k}, l;
        for (l = 0; l < b; l++) {
            e[l] = l;
            s[l] = l;
            f[l] = l;
...
Ext.define("Ext.chart.series.sprite.CandleStick", {alias: "sprite.candlestickSeries", extend: "Ext.chart.series.sprite.Aggregative", inheritableStatics: {def: {processors: {raiseStyle: function (b, a) {
                    return Ext.merge({}, a || {}, b)
...
Ext.define("Ext.chart.series.Gauge", {alias: "series.gauge", extend: "Ext.chart.series.Polar", type: "gauge", seriesType: "pieslice", requires: ["Ext.draw.sprite.Sector"], config: {needle: false, needleLength: 90, needleWidth: 4, donut: 30, showInLegend: false, value: null, colors: null, sectors: null, minimum: 0, maximum: 100, rotation: 0, totalAngle: Math.PI / 2, rect: [0, 0, 1, 1], center: [0.5, 0.75], radius: 0.5, wholeDisk: false}, coordinateX: function () {
        ...
        var f = this, j = f.getStore(), a, d, h, b, g, e = j && j.first(), c, i;
        if (e) {
            c = f.getXField();
            if (c) {
                i = e.get(c)
...
Ext.define("Ext.chart.series.sprite.Line", {alias: "sprite.lineSeries", extend: "Ext.chart.series.sprite.Aggregative", inheritableStatics: {def: {processors: {smooth: "bool", fillArea: "bool", step: "bool", preciseStroke: "bool", xAxis: "default", yCap: "default"}, defaults: {smooth: false, fillArea: false, step: false, preciseStroke: true, xAxis: null, yCap: Math.pow(2, 20), yJump: 50}, triggers: {dataX: "dataX,bbox,smooth", dataY: "dataY,bbox,smooth", smooth: "smooth"}, updaters: {smooth: function (a) {
                ...
                }}}}, list: null, updatePlainBBox: function (d) {
        ...
        var w = this, o = w.attr, n = o.renderer, g = o.step, a = true, l = {type: "line", smooth: false, step: g}, m = [], l, z, v, f, k, j, t, c, s, b, r;
        ...
        var G = this, t = G.attr, d = t.step, z = t.matrix, s = t.renderer, e = z.getXX(), p = z.getYY(), m = z.getDX(), k = z.getDY(), r = G.smoothX, q = G.smoothY, I = G.calculateScale(t.dataX.length, b), o, F, n, E, h, g, B, a, A, w, H, D, l = {type: "line", smooth: true, step: d};
        v.beginPath();
        ...
        var q = this, n = q.attr, e = q.getMarker("labels"), d = e.getTemplate(), m = q.labelCfg || (q.labelCfg = {}), c = q.surfaceMatrix, g, f, j = n.labelOverflowPadding, l, b, r, p, s;
        m.x = c.x(i, h);
        m.y = c.y(i, h);
        if (n.flipXY) {
        ...
        var g = this, e = g.attr, f = e.renderer, c = g.surfaceMatrix, b = {}, i, a;
        ...
        var m = this, k = m.attr, s = k.dataX, r = k.dataY, h = k.labels, v = k.xAxis, a = k.yCap, g = k.smooth && m.smoothX && m.smoothY, d = h && m.getMarker("labels"), t = m.getMarker("markers"), E = k.matrix, u = N.devicePixelRatio, C = E.getXX(), f = E.getYY(), c = E.getDX(), b = E.getDY(), q = m.list || (m.list = []), F = B.minX, e = B.maxX, j = B.minY, P = B.maxY, U = B.startIdx, S = true, Q, T, L, K, R, G;
        m.rendererData = {store: m.getStore()};
        q.length = 0;
        for (R = w; R < l; R++) {
            var O = F[R], p = e[R], M = j[R], n = P[R];
            if (O < p) {
        ...
        if (q.length) {
            ...
            if (k.preciseStroke) {
                ...
                if (S && g && k.fillArea && !k.renderer) {
                    var A = s[s.length - 1] * C + c + u, z = r[r.length - 1] * f + b, J = s[0] * C + c - u, H = r[0] * f + b;
                    o.lineTo(A, z);
...
Ext.define("Ext.chart.series.sprite.PieSlice", {extend: "Ext.draw.sprite.Sector", mixins: {markerHolder: "Ext.chart.MarkerHolder"}, alias: "sprite.pieslice", inheritableStatics: {def: {processors: {doCallout: "bool", label: "string", rotateLabels: "bool", labelOverflowPadding: "number", renderer: "default"}, defaults: {doCallout: true, rotateLabels: true, label: "", labelOverflowPadding: 10, renderer: null}}}, config: {rendererData: null, rendererIndex: 0, series: null}, setGradientBBox: function (q, k) {
        ...
        if (a.renderer) {
            h = {type: "sector", text: a.text, centerX: a.centerX, centerY: a.centerY, margin: a.margin, startAngle: Math.min(a.startAngle, a.endAngle), endAngle: Math.max(a.startAngle, a.endAngle), startRho: Math.min(a.startRho, a.endRho), endRho: Math.max(a.startRho, a.endRho)};
            ...
            if (s.doCallout) {
                if (d.attr.display === "outside") {
                    ...
                    if (d.attr.display === "inside") {
                        ...
                        z.putMarker("labels", {callout: 1 - z.sliceContainsLabel(s, u)}, r)
                    }
                }
            } else {
...
Ext.define("Ext.chart.series.Pie", {extend: "Ext.chart.series.Polar", requires: ["Ext.chart.series.sprite.PieSlice"], type: "pie", alias: "series.pie", seriesType: "pieslice", config: {donut: 0, rotation: 0, clockwise: true, totalAngle: 2 * Math.PI, hidden: [], radiusFactor: 100, highlightCfg: {margin: 20}, style: {}}, directions: ["X"], applyLabel: function (a, b) {
        ...
        var t = this, f = t.getStore(), q = f.getData().items, c = q.length, b = t.getXField(), e = t.getYField(), l, a = 0, m, k, s = 0, o = t.getHidden(), d = [], p, g = 0, h = t.getTotalAngle(), r = t.getClockwise() ? 1 : -1, j = t.getSprites(), n;
        if (!j) {
            return
        }
        for (p = 0; p < c; p++) {
        ...
        for (p = 0; p < c; p++) {
            j[p].setAttributes({startAngle: g, endAngle: g = (m ? r * d[p] * m : 0), globalAlpha: 1})
        }
        ...
        for (p = c; p < t.sprites.length; p++) {
            j[p].setAttributes({startAngle: h, endAngle: h, globalAlpha: 0})
        }
        ...
        var g = this, j = g.getStore(), k = j.getAt(c), f = g.getYField(), d = g.getRadius(), a = {}, e, b, h;
        if (k) {
        ...
        this.doUpdateStyles()
    }, rotationOffset: -Math.PI / 2, updateRotation: function (a) {
        ...
        var t = this, c = t.getSprites();
        if (c) {
            var s = t.getCenter(), q = t.getOffsetX(), p = t.getOffsetY(), j = f - s[0] + q, h = e - s[1] + p, b = t.getStore(), g = t.getDonut(), o = b.getData().items, r = Math.atan2(h, j) - t.getRotation(), a = Math.sqrt(j * j + h * h), l = t.getRadius() * g * 0.01, m = t.getHidden(), n, d, k;
            for (n = 0, d = o.length; n < d; n++) {
                if (!m[n]) {
                    k = c[n].attr;
                    if (a >= l + k.margin && a <= k.endRho + k.margin) {
                        if (t.betweenAngle(r, k.startAngle, k.endAngle)) {
                            return{series: t, sprite: c[n], index: n, record: o[n], field: t.getXField()}
                        }
                    }
                }
            }
        ...
        var h = this, j = h.getStore();
        if (j) {
            var g = j.getData().items, b = h.getLabel().getTemplate().getField(), c = h.getXField(), e = h.getHidden(), d, a, k;
...
Ext.define("Ext.chart.series.sprite.Pie3DPart", {extend: "Ext.draw.sprite.Path", mixins: {markerHolder: "Ext.chart.MarkerHolder"}, alias: "sprite.pie3dPart", inheritableStatics: {def: {processors: {centerX: "number", centerY: "number", startAngle: "number", endAngle: "number", startRho: "number", endRho: "number", margin: "number", thickness: "number", bevelWidth: "number", distortion: "number", baseColor: "color", colorSpread: "number", baseRotation: "number", part: "enums(top,bottom,start,end,innerFront,innerBack,outerFront,outerBack)", label: "string"}, aliases: {rho: "endRho"}, triggers: {centerX: "path,bbox", centerY: "path,bbox", startAngle: "path,partZIndex", endAngle: "path,partZIndex", startRho: "path", endRho: "path,bbox", margin: "path,bbox", thickness: "path", distortion: "path", baseRotation: "path,partZIndex", baseColor: "partZIndex,partColor", colorSpread: "partColor", part: "path,partZIndex", globalAlpha: "canvas,alpha"}, defaults: {centerX: 0, centerY: 0, startAngle: Math.PI * 2, endAngle: Math.PI * 2, startRho: 0, endRho: 150, margin: 0, thickness: 35, distortion: 0.5, baseRotation: 0, baseColor: "white", colorSpread: 1, miterLimit: 1, bevelWidth: 5, strokeOpacity: 0, part: "top", label: ""}, updaters: {alpha: "alphaUpdater", partColor: "partColorUpdater", partZIndex: "partZIndexUpdater"}}}, bevelParams: [], constructor: function (a) {
        ...
        var d = this, c = a.globalAlpha, b = d.oldOpacity;
        if (c !== b && (c === 1 || b === 1)) {
            d.scheduleUpdater(a, "path", ["globalAlpha"]);
            d.oldOpacity = c
        }
    }, partColorUpdater: function (a) {
        var d = Ext.draw.Color.fly(a.baseColor), b = d.toString(), e = a.colorSpread, c;
        switch (a.part) {
            case"top":
        ...
        var c = Ext.draw.sprite.AttributeParser.angle, e = a.baseRotation, d = a.startAngle, b = a.endAngle, f;
        switch (a.part) {
            case"top":
                a.zIndex = 5;
                break;
        ...
        var f = this.attr, a = f.part, b = f.baseRotation, e = f.centerX, d = f.centerY, j, c, i, h, g, l;
        if (a === "start") {
            c = f.startAngle + b
        } else {
            if (a === "end") {
        ...
        var z = this, u = z.attr, t = u.attributeId, p = u.margin, c = u.distortion, i = u.centerX, h = u.centerY, j = u.baseRotation, v = u.startAngle + j, r = u.endAngle + j, m = (v + r) / 2, w = u.startRho + p, o = u.endRho + p, n = (w + o) / 2, a = Math.sin(m), b = Math.cos(m), e = z.surfaceMatrix, g = z.getMarker("labels"), f = g.getTemplate(), d = f.getCalloutLine(), s = d && d.length || 40, q = {}, l, k;
        ...
        var f = this, a = f.attr, e = a.bevelWidth, g = f.bevelParams, d;
        for (d = 0; d < g.length; d++) {
            c.beginPath();
        ...
        var k = this.attr, g = k.margin, c = k.distortion, i = k.centerX, h = k.centerY, f = k.baseRotation, j = k.startAngle + f, e = k.endAngle + f, d = (j + e) / 2, l = k.startRho, b = k.endRho, n = Math.sin(e), a = Math.cos(e);
        i += Math.cos(d) * g;
        h += Math.sin(d) * g * c;
        ...
        var o = this.attr, k = o.margin, g = o.centerX, f = o.centerY, e = o.distortion, h = o.baseRotation, p = o.startAngle + h, m = o.endAngle + h, a = o.thickness, q = o.startRho, j = o.endRho, r = (s === "start" && p) || (s === "end" && m), b = Math.sin(r), d = Math.cos(r), c = o.globalAlpha < 1, n = s === "start" && d < 0 || s === "end" && d > 0 || c, i;
        if (n) {
            i = (p + m) / 2;
            g += Math.cos(i) * k;
            f += Math.sin(i) * k * e;
        ...
        var w = this, s = w.attr, p = s.margin, h = s.centerX, g = s.centerY, d = s.distortion, i = s.baseRotation, t = Ext.draw.sprite.AttributeParser.angle, u = s.startAngle + i, r = s.endAngle + i, k = t((u + r) / 2), a = s.thickness, b = s.globalAlpha < 1, c, n, v;
        w.bevelParams = [];
        u = t(u);
        r = t(r);
        h += Math.cos(k) * p;
...
Ext.define("Ext.draw.PathUtil", function () {
    ...
    return{singleton: true, requires: ["Ext.draw.overrides.Path", "Ext.draw.overrides.sprite.Path", "Ext.draw.overrides.sprite.Instancing", "Ext.draw.overrides.Surface"], cubicRoots: function (m) {
...
Ext.define("Ext.chart.series.Pie3D", {extend: "Ext.chart.series.Polar", requires: ["Ext.chart.series.sprite.Pie3DPart", "Ext.draw.PathUtil"], type: "pie3d", seriesType: "pie3d", alias: "series.pie3d", isPie3D: true, config: {rect: [0, 0, 0, 0], thickness: 35, distortion: 0.5, donut: false, hidden: [], highlightCfg: {margin: 20}, shadow: false}, rotationOffset: -Math.PI / 2, setField: function (a) {
        ...
        if (a === true) {
            ...
            if (!Ext.isObject(a)) {
                a = {shadowColor: Ext.draw.Color.RGBA_NONE}
            }
        }
        return a
    }, updateShadow: function (g) {
        var e = this, f = e.getSprites(), d = e.spritesPerSlice, c = f && f.length, b, a;
        for (b = 1; b < c; b += d) {
            a = f[b];
        ...
        var d = this.callParent([b]), c = this.getStyle(), a = d.fillStyle || d.fill || d.color, e = c.strokeStyle || c.stroke;
        if (a) {
            d.baseColor = a;
            delete d.fillStyle;
            delete d.fill;
        ...
        var g = this, h = g.getSprites(), f = g.spritesPerSlice, e = h && h.length, c = 0, b = 0, a, d;
        for (; c < e; c += f, b++) {
        ...
        var w = this, m = w.getChart(), u = m && m.getAnimation(), f = w.getStore(), t = f.getData().items, d = t.length, b = w.getXField(), p = w.getRotation(), s = w.getHidden(), n, c = 0, h, e = [], k = w.getSprites(), a = k.length, l = w.spritesPerSlice, g = 0, o = Math.PI * 2, v = 1e-10, r, q;
        for (r = 0; r < d; r++) {
        ...
        for (r = 0; r < d; r++) {
            for (q = 0; q < l; q++) {
                k[r * l + q].setAttributes({startAngle: g, endAngle: e[r] - v, globalAlpha: 1, baseRotation: p})
            }
            g = e[r]
        }
        for (r *= l; r < a; r++) {
        ...
        var l = this, m = l.getStore(), k = m.getData().items, h = l.getSprites(), b = l.getLabel().getTemplate().getField(), f = l.getHidden(), a = l.spritesPerSlice, d, c, g, e, n;
        if (h.length && b) {
            e = [];
        ...
        var f = this, d = f.getChart(), h = d.getInnerPadding(), e = d.getMainRect() || [0, 0, 1, 1], c = e[2] - h * 2, a = e[3] - h * 2 - f.getThickness(), g = c / 2, b = g * f.getDistortion();
        if (b > a / 2) {
        ...
        var y = this, e = y.getStore();
        if (!e) {
            return[]
        }
        var n = y.getChart(), p = y.getSurface(), t = e.getData().items, l = y.spritesPerSlice, a = t.length, v = y.getAnimation() || n && n.getAnimation(), x = y.getCenter(), w = y.getOffsetX(), u = y.getOffsetY(), b = y.getRadius(), q = y.getRotation(), d = y.getHighlight(), c = {centerX: x[0] + w, centerY: x[1] + u - y.getThickness() / 2, endRho: b, startRho: b * y.getDonut() / 100, thickness: y.getThickness(), distortion: y.getDistortion()}, k = y.sprites, h = y.getLabel(), f = h.getTemplate(), m, g, o, s, r;
        for (s = 0; s < a; s++) {
        ...
        var h = this, g = h.getSprites();
        if (g) {
            var l = h.getStore(), b = l.getData().items, a = h.spritesPerSlice, e = h.getHidden(), c, f, m, d;
            for (c = 0, f = b.length; c < f; c++) {
                if (!e[c]) {
                    d = c * a;
                    m = g[d];
                    if (m.hitTest([k, j])) {
                        return{series: h, sprite: g.slice(d, d + a), index: c, record: b[c], category: "sprites", field: h.getXField()}
                    }
                }
            }
            return null
        ...
        if (k) {
            var g = k.getData().items, b = h.getLabel().getTemplate().getField(), j = h.getField(), e = h.getHidden(), d, a, c;
            for (d = 0; d < g.length; d++) {
                a = h.getStyleByIndex(d);
                c = a.baseColor;
...
Ext.define("Ext.chart.series.sprite.Radar", {alias: "sprite.radar", extend: "Ext.chart.series.sprite.Polar", getDataPointXY: function (d) {
...
Ext.define("Ext.chart.series.Radar", {extend: "Ext.chart.series.Polar", type: "radar", seriesType: "radar", alias: "series.radar", requires: ["Ext.chart.series.sprite.Radar"], themeColorCount: function () {
        ...
        if (m && e) {
            ...
            for (d = 0; d < a; d++) {
                ...
                if (Math.abs(p[0] - k) < b && Math.abs(p[1] - j) < b) {
                    o = {series: h, sprite: m, index: d, category: "markers", record: l.getData().items[d], field: h.getYField()};
                    return o
                }
            }
        }
        ...
        var a = this.callParent(), b = {customDurations: {translationX: 0, translationY: 0, rotationRads: 0, dataMinX: 0, dataMaxX: 0}};
        if (a.fx) {
            Ext.apply(a.fx, b)
        } else {
            a.fx = b
        ...
        var d = this, c = d.getChart(), e = d.getAnimation() || c && c.getAnimation(), b = d.sprites[0], a;
        if (!c) {
            return[]
        }
        if (!b) {
...
Ext.define("Ext.chart.series.sprite.Scatter", {alias: "sprite.scatterSeries", extend: "Ext.chart.series.sprite.Cartesian", renderClipped: function (r, s, w, u) {
        if (this.cleanRedraw) {
            return
        }
        var C = this, q = C.attr, l = q.dataX, h = q.dataY, z = q.labels, j = C.getSeries(), b = z && C.getMarker("labels"), t = C.attr.matrix, c = t.getXX(), p = t.getYY(), m = t.getDX(), k = t.getDY(), n = {}, D, B, d = r.getInherited().rtl && !q.flipXY ? -1 : 1, a, A, o, e, g, f, v;
        if (q.flipXY) {
            a = u[1] - c * d;
            A = u[1] + u[3] + c * d;
            o = u[0] - p;
        ...
        var r = this, m = r.attr, d = r.getMarker("labels"), c = d.getTemplate(), l = r.labelCfg || (r.labelCfg = {}), b = r.surfaceMatrix, f, e, i = m.labelOverflowPadding, o = m.flipXY, k, n, s, q;
        l.text = j;
...
Ext.define("Ext.draw.Point", {requires: ["Ext.draw.Draw", "Ext.draw.Matrix"], isPoint: true, x: 0, y: 0, length: 0, angle: 0, angleUnits: "degrees", statics: {fly: (function () {
        ...
        var b = this, a = b.length, c = b.angle;
        ...
        var d = b.sub(c).normalize(), a = c.sub(this);
...
Ext.define("Ext.draw.plugin.SpriteEvents", {extend: "Ext.plugin.Abstract", alias: "plugin.spriteevents", requires: ["Ext.draw.PathUtil"], mouseMoveEvents: {mousemove: true, mouseover: true, mouseout: true}, spriteMouseMoveEvents: {spritemousemove: true, spritemouseover: true, spritemouseout: true}, init: function (a) {
        var b = "handleEvent";
...
Ext.define("Ext.chart.TipSurface", {extend: "Ext.draw.Container", spriteArray: false, renderFirst: true, constructor: function (a) {
        this.callParent([a]);
        if (a.sprites) {
