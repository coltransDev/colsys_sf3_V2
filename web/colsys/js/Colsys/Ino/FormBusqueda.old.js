                                ...
                                tabpanel.add(
                                        {
                                            ...
                                            closable: true,
                                            autoScroll: true,
                                            items: [new Colsys.Ino.Mainpanel({"idmaster": ref, "idtransporte": record.data.m_ca_transporte, "idimpoexpo": record.data.m_ca_impoexpo, "idreferencia": record.data.m_ca_referencia,'permisos': permisos}),
                                                {
                                                    region: 'south',
