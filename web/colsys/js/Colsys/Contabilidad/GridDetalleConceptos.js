Ext.define('Colsys.Contabilidad.GridDetalleConceptos', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.Colsys.Contabilidad.GridDetalleConceptos',    
    autoHeight: true,
    autoScroll: true,    
    height:400,    
//    plugins: [
        ...
        beforerender: function(ct, position){            
            this.reconfigure(
                store = Ext.create('Ext.data.Store', {
                    ...
                    proxy: {
                        type: 'ajax',
                        url: '/contabilidad/datosDetalleConceptos',
                        reader: {
                            type: 'json',
                            rootProperty: 'root'
                        }
                ...
                [
                    ...
                    {text: "Flete",             dataIndex: 'ca_flete'+this.idgrid,          xtype:  'checkcolumn',  sortable: true, flex: 1, cls: 'grid-maestra'},            
                    {text: "Recargo Local",     dataIndex: 'ca_recargolocal'+this.idgrid,   xtype:  'checkcolumn',  sortable: true, flex: 1, cls: 'grid-maestra'},
                    {text: "Recargo Origen",    dataIndex: 'ca_recargoorigen'+this.idgrid,  xtype:  'checkcolumn',  sortable: true, flex: 1, cls: 'grid-maestra'},
                    {text: "Recarto Otm",       dataIndex: 'ca_recargootmdta'+this.idgrid,  xtype:  'checkcolumn',  sortable: true, flex: 1, cls: 'grid-maestra'},
                    {text: "Costo",             dataIndex: 'ca_costo'+this.idgrid,          xtype:  'checkcolumn',  sortable: true, flex: 1, cls: 'grid-maestra'},
                    {text: "Aplicaciones",      dataIndex: 'ca_aplicaciones'+this.idgrid,                           sortable: true, flex: 1, cls: 'grid-maestra',
            ...
            var obj = {
                ...
                items: [{
                    ...
                    handler: function () {                        
                        ...
                        if (str.length > 5){
                            Ext.Ajax.request({
                                url: '/contabilidad/guardarDetalleConceptos',
                                params: {
                                    datos: str
                                },
