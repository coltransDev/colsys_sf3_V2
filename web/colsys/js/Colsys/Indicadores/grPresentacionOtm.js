Ext.define('Colsys.Indicadores.grPresentacionOtm', {
    ...
    listeners: {
        afterrender: function (ct, position) {
            ...
            grOtm3 = Ext.getCmp('graficaOtm3' + indice + idform);
                            ...
                            items: [
                                ...
                                },*/
                                {
                                    ...
                                    handler: function (btn, e, eOpts) {
                                        grOtm3.downloadCanvas('Oportunidad en la Llegada', subtitulo, transporte);
                                    }
                                },
                                {
                                    text: 'Vista Previa',
                                    iconCls: 'photo_img',
                                    handler: function (btn, e, eOpts) {
                                        grOtm3.previewIndicadores('Oportunidad en la Llegada', subtitulo, transporte);
                                    }
                                },
                                {
        ...
        grOtm3.addSeries([{
                ...
                listeners: {
                    itemdblclick: function (series, item, event, eOpts) {
                        mostrardatosMesOtm("presentacion", item.record.data.name);
                    }
                }
