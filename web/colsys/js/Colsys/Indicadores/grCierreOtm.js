Ext.define('Colsys.Indicadores.grCierreOtm', {
    ...
    listeners: {
        afterrender: function (ct, position) {
            ...
            grOtm4 = Ext.getCmp('graficaOtm4' + indice + idform);
                            ...
                            items: [
                                ...
                                },*/
                                {
                                    ...
                                    handler: function (btn, e, eOpts) {
                                        grOtm4.downloadCanvas('Oportunidad en la Llegada', subtitulo, transporte);
                                    }
                                },
                                {
                                    text: 'Vista Previa',
                                    iconCls: 'photo_img',
                                    handler: function (btn, e, eOpts) {
                                        grOtm4.previewIndicadores('Oportunidad en la Llegada', subtitulo, transporte);
                                    }
                                },
                                {
        ...
        grOtm4.addSeries([{
                ...
                listeners: {
                    itemdblclick: function (series, item, event, eOpts) {
                        mostrardatosMesOtm("cierre", item.record.data.name);
                    }
                }
