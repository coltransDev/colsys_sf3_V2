...
//            asignarinfo(me, datos);
//            this.asignarAxes(res[indice].y, idgrafica, indice, idform,  tipo);
//            this.asignarSeries(idgrafica, res[indice].y, tipo, idform, indice,res);
    ...
    asignarAxes: function (dato, idgrafica, indice, idform, tipo) {
        ...
        this.setAxes(
            [{
                ...
                position: 'left',
                grid: true,
                id: 'axes-numeric3d-' + idgrafica + indice + idform,
                title: {
    ...
    asignarSeries: function (dato, idgrafica, indice, idform,  res, tipo) {       
       if (tipo == "FCL") {
            this.addSeries({
                id: 'series-'+ idgrafica + indice + idform,
                type: 'bar3d',
                xField: 'name',
                yField: dato,
                stacked: false,
            ...
            this.addSeries({
                ...
                listeners: {
                    itemdblclick: function (series, item, event, eOpts) {
                        ...
                        console.log("518");
                        console.log(datos);
                        mostrardatosVolumen(item.record.data.name, item.field, 'LCL', "volumen", idform, datos);
                    }
                }
