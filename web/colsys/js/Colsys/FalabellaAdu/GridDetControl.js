...
//            remoteSort: false,
            proxy: {
                type: 'ajax',
                url: '/falabellaAdu2/datosDetControl',
                reader: {
                    type: 'json',
                    rootProperty: 'root'
                }
        ...
        listeners:{
            ...
            {
                me.setHeight(Ext.getCmp('tab-panel-id').getHeight()-150);
                me.setWidth(Ext.getCmp('tab-panel-id').getWidth()-150);
            }
        }
});
