...
list($class, $parameters) = (array) sfConfig::get('sf_loginValidation_filter', array('loginValidationFilter', array (
  'cookie_name' => 'coltranscookie',
)));
$filter = new $class(sfContext::getInstance(), $parameters);
$this->register($filter);

list($class, $parameters) = (array) sfConfig::get('sf_localeValidation_filter', array('localeFilter', array (
  'culture' => 'es_ES',
)));
$filter = new $class(sfContext::getInstance(), $parameters);
$this->register($filter);
