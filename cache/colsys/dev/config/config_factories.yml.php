...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/abotero/Desarrollo/colsys_sf3/log/colsys_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/abotero/Desarrollo/colsys_sf3/cache/colsys/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/abotero/Desarrollo/colsys_sf3/apps/colsys/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/abotero/Desarrollo/colsys_sf3/cache/colsys/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/home/abotero/Desarrollo/colsys_sf3/apps/colsys/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('colsys'),
'database' => $this->getDatabaseManager()->getDatabase('doctrine'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'colsys',
  'db_table' => 'control.tb_sessions',
  'db_id_col' => 'sess_id',
  'db_data_col' => 'sess_data',
  'db_time_col' => 'sess_time',
  'db_maxinactive_col' => 'max_inactive',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/abotero/Desarrollo/colsys_sf3/cache/colsys/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/abotero/Desarrollo/colsys_sf3/apps/colsys/template',
)));
