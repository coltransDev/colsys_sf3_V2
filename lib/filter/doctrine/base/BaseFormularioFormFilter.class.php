...
abstract class BaseFormularioFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ca_color'            => new sfWidgetFormFilterInput(),
      'ca_bold'             => new sfWidgetFormFilterInput(),
      'ca_strong'           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'ca_color'            => new sfValidatorPass(array('required' => false)),
      'ca_bold'             => new sfValidatorPass(array('required' => false)),
      'ca_strong'           => new sfValidatorPass(array('required' => false)),
