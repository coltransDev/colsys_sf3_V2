...
/**
 * Base class that represents a row from the 'tb_cotseguimientos' table.
 *
 * 
 *
...
abstract class BaseCotSeguimiento extends BaseObject  implements Persistent {
  ...
  const PEER = 'CotSeguimientoPeer';
	...
	/**
	 * The value for the ca_fchseguimiento field.
	 * @var        string
	 */
	...
	/**
	 * The value for the ca_seguimiento field.
	 * @var        string
	 */
	...
	/**
	 * Initializes internal state of BaseCotSeguimiento object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [ca_fchseguimiento] column value.
	 * 
	 *
	...
	/**
	 * Get the [ca_seguimiento] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     CotSeguimiento The current object (for fluent API support)
	 */
	...
	/**
	 * Sets the value of [ca_fchseguimiento] column to a normalized version of the date/time value specified.
	 * 
	...
	/**
	 * Set the value of [ca_seguimiento] column.
	 * 
	 * @param      string $v new value
	 * @return     CotSeguimiento The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = CotSeguimientoPeer::NUM_COLUMNS - CotSeguimientoPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CotSeguimiento (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CotSeguimiento Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getCotizacion(PropelPDO $con = null)
	{
		if ($this->aCotizacion === null && ($this->ca_idcotizacion !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCotizacion->addCotSeguimientos($this);
			 */
		}
	...
	/**
	 * Declares an association between this object and a CotProducto object.
	 *
	 * @param      CotProducto $v
	 * @return     CotSeguimiento The current object (for fluent API support)
	 * @throws     PropelException
	...
	public function setCotProducto(CotProducto $v = null)
	{
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the CotProducto object, it will not be re-added.
		if ($v !== null) {
			$v->addCotSeguimiento($this);
		}
	...
	/**
	 * Get the associated CotProducto object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     CotProducto The associated CotProducto object.
	 * @throws     PropelException
	 */
	public function getCotProducto(PropelPDO $con = null)
	{
		if ($this->aCotProducto === null && ($this->ca_idproducto !== null && $this->ca_idcotizacion !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCotProducto->addCotSeguimientos($this);
			 */
		}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuario->addCotSeguimientos($this);
			 */
		}
