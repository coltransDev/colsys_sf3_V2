...
/**
 * Base class that represents a row from the 'tb_cotopciones' table.
 *
 * 
 *
...
abstract class BaseCotOpcion extends BaseObject  implements Persistent {
  ...
  const PEER = 'CotOpcionPeer';
	...
	/**
	 * Initializes internal state of BaseCotOpcion object.
	 * @see        applyDefaults()
	 */
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setCaIdopcion($pk);  //[IMV] update autoincrement primary key
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CotOpcion (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaIdopcion(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CotOpcion Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getCotProducto(PropelPDO $con = null)
	{
		if ($this->aCotProducto === null && ($this->ca_idproducto !== null && $this->ca_idcotizacion !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCotProducto->addCotOpcions($this);
			 */
		}
	...
	public function getConcepto(PropelPDO $con = null)
	{
		if ($this->aConcepto === null && ($this->ca_idconcepto !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aConcepto->addCotOpcions($this);
			 */
		}
	 ...
	 * Otherwise if this CotOpcion has previously been saved, it will retrieve
	 * related CotRecargos from storage. If this CotOpcion is new, it will return
	 ...
	 * Otherwise if this CotOpcion is new, it will return
	 * an empty collection; or if this CotOpcion has previously
	 * been saved, it will retrieve related CotRecargos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CotOpcion.
	 */
