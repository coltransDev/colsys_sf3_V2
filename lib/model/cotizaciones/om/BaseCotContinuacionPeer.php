...
abstract class BaseCotContinuacionPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('oid', 'caIdcotizacion', 'caTipo', 'caModalidad', 'caOrigen', 'caDestino', 'caIdconcepto', 'caIdmoneda', 'caIdequipo', 'caTarifa', 'caValorTar', 'caValorMin', 'caFrecuencia', 'caTiempotransito', 'caObservaciones', 'caFchcreado', 'caUsucreado', 'caFchactualizado', 'caUsuactualizado', ),
		BasePeer::TYPE_COLNAME => array (self::OID, self::CA_IDCOTIZACION, self::CA_TIPO, self::CA_MODALIDAD, self::CA_ORIGEN, self::CA_DESTINO, self::CA_IDCONCEPTO, self::CA_IDMONEDA, self::CA_IDEQUIPO, self::CA_TARIFA, self::CA_VALOR_TAR, self::CA_VALOR_MIN, self::CA_FRECUENCIA, self::CA_TIEMPOTRANSITO, self::CA_OBSERVACIONES, self::CA_FCHCREADO, self::CA_USUCREADO, self::CA_FCHACTUALIZADO, self::CA_USUACTUALIZADO, ),
