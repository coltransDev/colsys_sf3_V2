...
/**
 * Base static class for performing query and update operations on the 'tb_cotarchivos' table.
 *
 * 
 *
...
abstract class BaseCotArchivoPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CotArchivoPeer::CA_IDARCHIVO, CotArchivoPeer::CA_IDCOTIZACION, CotArchivoPeer::CA_NOMBRE, CotArchivoPeer::CA_TAMANO, CotArchivoPeer::CA_TIPO, CotArchivoPeer::CA_FCHCREADO, CotArchivoPeer::CA_USUCREADO, CotArchivoPeer::CA_DATOS, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CotArchivoPeer::CA_IDARCHIVO => 0, CotArchivoPeer::CA_IDCOTIZACION => 1, CotArchivoPeer::CA_NOMBRE => 2, CotArchivoPeer::CA_TAMANO => 3, CotArchivoPeer::CA_TIPO => 4, CotArchivoPeer::CA_FCHCREADO => 5, CotArchivoPeer::CA_USUCREADO => 6, CotArchivoPeer::CA_DATOS => 7, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.cotizaciones.map.CotArchivoMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = CotArchivoPeer::getTableMap();
	 ...
	 * @param      string $column The column name for current table. (i.e. CotArchivoPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	const COUNT = 'COUNT(tb_cotarchivos.CA_IDARCHIVO)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_cotarchivos.CA_IDARCHIVO)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(CotArchivoPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(CotArchivoPeer::COUNT);
		}
		...
		$rs = CotArchivoPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return CotArchivoPeer::populateObjects(CotArchivoPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinCotizacion(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(CotArchivoPeer::CA_IDCOTIZACION, CotizacionPeer::CA_IDCOTIZACION);
	...
	/**
	 * Selects a collection of CotArchivo objects pre-filled with their Cotizacion objects.
	 *
	 * @return     array Array of CotArchivo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCotizacion(Criteria $c, $con = null)
	{
		...
		$startcol = (CotArchivoPeer::NUM_COLUMNS - CotArchivoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		CotizacionPeer::addSelectColumns($c);

		$c->addJoin(CotArchivoPeer::CA_IDCOTIZACION, CotizacionPeer::CA_IDCOTIZACION);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addCotArchivo($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initCotArchivos();
				$obj2->addCotArchivo($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	/**
	 * Selects a collection of CotArchivo objects pre-filled with all related objects.
	 *
	 * @return     array Array of CotArchivo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		CotArchivoPeer::addSelectColumns($c);
		$startcol2 = (CotArchivoPeer::NUM_COLUMNS - CotArchivoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a CotArchivo or Criteria object.
	 *
	 * @param      mixed $values Criteria or CotArchivo object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from CotArchivo object
		}

		$criteria->remove(CotArchivoPeer::CA_IDARCHIVO); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method perform an UPDATE on the database, given a CotArchivo or Criteria object.
	 *
	 * @param      mixed $values Criteria or CotArchivo object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, $con = null)
	{
		...
		} else { // $values is CotArchivo object
	...
	/**
	 * Method to DELETE all rows from the tb_cotarchivos table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a CotArchivo or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or CotArchivo object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given CotArchivo object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      CotArchivo $obj The object to validate.
...
if (Propel::isInit()) {
	...
	try {
		BaseCotArchivoPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.cotizaciones.map.CotArchivoMapBuilder');
}
