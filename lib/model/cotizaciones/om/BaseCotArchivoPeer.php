...
abstract class BaseCotArchivoPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of CotArchivo objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array CotArchivo[]
	 */
	 ...
	 *
	 * @param      CotArchivo $value A CotArchivo object.
	 ...
	 *
	 * @param      mixed $value A CotArchivo object or a primary key value.
	 */
	 ...
	 * @return     CotArchivo Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinCotizacion(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (CotArchivo) to $obj2 (Cotizacion)
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (CotArchivo) to the collection in $obj2 (Cotizacion)
				$obj2->addCotArchivo($obj1);
...
//
// NOTE: This static code cannot call methods on the CotArchivoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CotArchivoPeer class:
//
// Propel::getDatabaseMap(CotArchivoPeer::DATABASE_NAME)->addTableBuilder(CotArchivoPeer::TABLE_NAME, CotArchivoPeer::getMapBuilder());
//
