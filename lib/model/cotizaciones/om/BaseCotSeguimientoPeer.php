...
/**
 * Base static class for performing query and update operations on the 'tb_cotseguimientos' table.
 *
 * 
 *
...
abstract class BaseCotSeguimientoPeer {
	...
	/** the column name for the CA_FCHSEGUIMIENTO field */
	...
	/** the column name for the CA_SEGUIMIENTO field */
	...
	/**
	 * An identiy map to hold any loaded instances of CotSeguimiento objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array CotSeguimiento[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. CotSeguimientoPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      CotSeguimiento $value A CotSeguimiento object.
	 ...
	 *
	 * @param      mixed $value A CotSeguimiento object or a primary key value.
	 */
	 ...
	 * @return     CotSeguimiento Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of CotSeguimiento objects pre-filled with their Cotizacion objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of CotSeguimiento objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCotizacion(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (CotSeguimiento) to $obj2 (Cotizacion)
	...
	/**
	 * Selects a collection of CotSeguimiento objects pre-filled with their CotProducto objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of CotSeguimiento objects.
	...
	public static function doSelectJoinCotProducto(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (CotSeguimiento) to $obj2 (CotProducto)
				$obj2->addCotSeguimiento($obj1);
	...
	/**
	 * Selects a collection of CotSeguimiento objects pre-filled with their Usuario objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of CotSeguimiento objects.
	...
	public static function doSelectJoinUsuario(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (CotSeguimiento) to $obj2 (Usuario)
				$obj2->addCotSeguimiento($obj1);
	...
	/**
	 * Selects a collection of CotSeguimiento objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (CotSeguimiento) to the collection in $obj2 (Cotizacion)
				$obj2->addCotSeguimiento($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (CotSeguimiento) to the collection in $obj3 (CotProducto)
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (CotSeguimiento) to the collection in $obj4 (Usuario)
	...
	/**
	 * Selects a collection of CotSeguimiento objects pre-filled with all related objects except Cotizacion.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptCotizacion(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = CotSeguimientoPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (CotSeguimiento) to the collection in $obj2 (CotProducto)
				$obj2->addCotSeguimiento($obj1);
				...
				// Add the $obj1 (CotSeguimiento) to the collection in $obj3 (Usuario)
				$obj3->addCotSeguimiento($obj1);
	...
	/**
	 * Selects a collection of CotSeguimiento objects pre-filled with all related objects except CotProducto.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of CotSeguimiento objects pre-filled with all related objects except Usuario.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a CotSeguimiento or Criteria object.
	 *
	 * @param      mixed $values Criteria or CotSeguimiento object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from CotSeguimiento object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a CotSeguimiento or Criteria object.
	 *
	 * @param      mixed $values Criteria or CotSeguimiento object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is CotSeguimiento object
	...
	/**
	 * Method to DELETE all rows from the tb_cotseguimientos table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a CotSeguimiento or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or CotSeguimiento object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given CotSeguimiento object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      CotSeguimiento $obj The object to validate.
	 ...
	 * @param      int $ca_idcotizacion
	   ...
	   @param      string $ca_fchseguimiento
...
} // BaseCotSeguimientoPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the CotSeguimientoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CotSeguimientoPeer class:
//
// Propel::getDatabaseMap(CotSeguimientoPeer::DATABASE_NAME)->addTableBuilder(CotSeguimientoPeer::TABLE_NAME, CotSeguimientoPeer::getMapBuilder());
//
