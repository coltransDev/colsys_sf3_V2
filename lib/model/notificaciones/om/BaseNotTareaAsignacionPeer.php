...
/**
 * Base static class for performing query and update operations on the 'notificaciones.tb_tareas_asignaciones' table.
 *
 * 
 *
...
abstract class BaseNotTareaAsignacionPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of NotTareaAsignacion objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array NotTareaAsignacion[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. NotTareaAsignacionPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      NotTareaAsignacion $value A NotTareaAsignacion object.
	 ...
	 *
	 * @param      mixed $value A NotTareaAsignacion object or a primary key value.
	 */
	 ...
	 * @return     NotTareaAsignacion Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of NotTareaAsignacion objects pre-filled with their NotTarea objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of NotTareaAsignacion objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinNotTarea(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (NotTareaAsignacion) to $obj2 (NotTarea)
	...
	/**
	 * Selects a collection of NotTareaAsignacion objects pre-filled with their Usuario objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of NotTareaAsignacion objects.
	...
	public static function doSelectJoinUsuario(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (NotTareaAsignacion) to $obj2 (Usuario)
				$obj2->addNotTareaAsignacion($obj1);
	...
	/**
	 * Selects a collection of NotTareaAsignacion objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (NotTareaAsignacion) to the collection in $obj2 (NotTarea)
				$obj2->addNotTareaAsignacion($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (NotTareaAsignacion) to the collection in $obj3 (Usuario)
	...
	/**
	 * Selects a collection of NotTareaAsignacion objects pre-filled with all related objects except NotTarea.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptNotTarea(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = NotTareaAsignacionPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (NotTareaAsignacion) to the collection in $obj2 (Usuario)
				$obj2->addNotTareaAsignacion($obj1);
	...
	/**
	 * Selects a collection of NotTareaAsignacion objects pre-filled with all related objects except Usuario.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a NotTareaAsignacion or Criteria object.
	 *
	 * @param      mixed $values Criteria or NotTareaAsignacion object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from NotTareaAsignacion object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a NotTareaAsignacion or Criteria object.
	 *
	 * @param      mixed $values Criteria or NotTareaAsignacion object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is NotTareaAsignacion object
	...
	/**
	 * Method to DELETE all rows from the notificaciones.tb_tareas_asignaciones table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a NotTareaAsignacion or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or NotTareaAsignacion object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given NotTareaAsignacion object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      NotTareaAsignacion $obj The object to validate.
...
} // BaseNotTareaAsignacionPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the NotTareaAsignacionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the NotTareaAsignacionPeer class:
//
// Propel::getDatabaseMap(NotTareaAsignacionPeer::DATABASE_NAME)->addTableBuilder(NotTareaAsignacionPeer::TABLE_NAME, NotTareaAsignacionPeer::getMapBuilder());
//
