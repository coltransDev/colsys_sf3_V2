...
abstract class BaseNotListaTareasPeer {
    ...
    foreach (sfMixer::getCallables('BaseNotListaTareasPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseNotListaTareasPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseNotListaTareasPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseNotListaTareasPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseNotListaTareasPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseNotListaTareasPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseNotListaTareasPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseNotListaTareasPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseNotListaTareasPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseNotListaTareasPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseNotListaTareasPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseNotListaTareasPeer', $values, $con, $ret);
    }
