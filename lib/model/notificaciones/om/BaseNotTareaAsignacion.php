...
/**
 * Base class that represents a row from the 'notificaciones.tb_tareas_asignaciones' table.
 *
 * 
 *
...
abstract class BaseNotTareaAsignacion extends BaseObject  implements Persistent {
  ...
  const PEER = 'NotTareaAsignacionPeer';
	...
	/**
	 * Initializes internal state of BaseNotTareaAsignacion object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     NotTareaAsignacion The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = NotTareaAsignacionPeer::NUM_COLUMNS - NotTareaAsignacionPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of NotTareaAsignacion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     NotTareaAsignacion Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getNotTarea(PropelPDO $con = null)
	{
		if ($this->aNotTarea === null && ($this->ca_idtarea !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aNotTarea->addNotTareaAsignacions($this);
			 */
		}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuario->addNotTareaAsignacions($this);
			 */
		}
