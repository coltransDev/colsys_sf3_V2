...
/**
 * Base class that represents a row from the 'ids.tb_ids' table.
 *
 * 
 *
...
abstract class BaseIds extends BaseObject  implements Persistent {
  ...
  const PEER = 'IdsPeer';
	...
	/**
	 * The value for the ca_dv field.
	 * @var        int
	 */
	protected $ca_dv;

	/**
	 * The value for the ca_idalterno field.
	 * @var        string
	 */
	protected $ca_idalterno;

	/**
	 * The value for the ca_tipoidentificacion field.
	 * @var        string
	 */
	...
	/**
	 * The value for the ca_actividad field.
	 * @var        string
	 */
	protected $ca_actividad;

	/**
	 * The value for the ca_sectoreco field.
	 * @var        string
	 */
	...
	/**
	 * @var        IdsProveedor one-to-one related IdsProveedor object
	 */
	...
	/**
	 * Initializes internal state of BaseIds object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [ca_idalterno] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [ca_tipoidentificacion] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [ca_actividad] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [ca_sectoreco] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     Ids The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [ca_idalterno] column.
	 * 
	...
	/**
	 * Set the value of [ca_tipoidentificacion] column.
	 * 
	 * @param      string $v new value
	 * @return     Ids The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [ca_actividad] column.
	 * 
	 * @param      string $v new value
	 * @return     Ids The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [ca_sectoreco] column.
	 * 
	 * @param      string $v new value
	 * @return     Ids The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 13; // 13 = IdsPeer::NUM_COLUMNS - IdsPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Ids (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Ids Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * Otherwise if this Ids has previously been saved, it will retrieve
	 * related IdsSucursals from storage. If this Ids is new, it will return
	 ...
	 * Otherwise if this Ids is new, it will return
	 * an empty collection; or if this Ids has previously
	 * been saved, it will retrieve related IdsSucursals from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Ids.
	 */
	...
	/**
	 * Gets a single IdsProveedor object, which is related to this object by a one-to-one relationship.
	 *
	 * @param      PropelPDO $con
	 * @return     IdsProveedor
	 * @throws     PropelException
	...
	/**
	 * Sets a single IdsProveedor object as related to this object by a one-to-one relationship.
	 *
	 * @param      IdsProveedor $l IdsProveedor
	 * @return     Ids The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setIdsProveedor(IdsProveedor $v)
	{
		...
		// Make sure that that the passed-in IdsProveedor isn't already associated with this object
		if ($v->getIds() === null) {
			$v->setIds($this);
		}
