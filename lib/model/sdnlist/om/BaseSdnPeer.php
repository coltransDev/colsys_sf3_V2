...
/**
 * Base static class for performing query and update operations on the 'tb_sdn' table.
 *
 * 
 *
...
abstract class BaseSdnPeer {
	...
	/** the column name for the CA_SDNTYPE field */
	const CA_SDNTYPE = 'tb_sdn.CA_SDNTYPE';

	/** the column name for the CA_REMARKS field */
	const CA_REMARKS = 'tb_sdn.CA_REMARKS';

	/**
	 * An identiy map to hold any loaded instances of Sdn objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. SdnPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      mixed $value A Sdn object or a primary key value.
	 */
	 ...
	 * @return     Sdn Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Sdn or Criteria object.
	 *
	 * @param      mixed $values Criteria or Sdn object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Sdn object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Sdn or Criteria object.
	 *
	 * @param      mixed $values Criteria or Sdn object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the tb_sdn table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Sdn or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Sdn object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Sdn object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Sdn $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the SdnPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SdnPeer class:
//
// Propel::getDatabaseMap(SdnPeer::DATABASE_NAME)->addTableBuilder(SdnPeer::TABLE_NAME, SdnPeer::getMapBuilder());
//
