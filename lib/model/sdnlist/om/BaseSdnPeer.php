...
abstract class BaseSdnPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (SdnPeer::CA_UID, SdnPeer::CA_FIRSTNAME, SdnPeer::CA_LASTNAME, SdnPeer::CA_TITLE, SdnPeer::CA_SDNTYPE, SdnPeer::CA_REMARKS, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (SdnPeer::CA_UID => 0, SdnPeer::CA_FIRSTNAME => 1, SdnPeer::CA_LASTNAME => 2, SdnPeer::CA_TITLE => 3, SdnPeer::CA_SDNTYPE => 4, SdnPeer::CA_REMARKS => 5, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.sdnlist.map.SdnMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(tb_sdn.CA_UID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_sdn.CA_UID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(SdnPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(SdnPeer::COUNT);
		}
		...
		$rs = SdnPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return SdnPeer::populateObjects(SdnPeer::doSelectRS($criteria, $con));
	}
	/**
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('lib.model.sdnlist.map.SdnMapBuilder');
}
