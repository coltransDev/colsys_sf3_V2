...
abstract class BaseSdnAddressPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of SdnAddress objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array SdnAddress[]
	 */
	 ...
	 *
	 * @param      SdnAddress $value A SdnAddress object.
	 ...
	 *
	 * @param      mixed $value A SdnAddress object or a primary key value.
	 */
	 ...
	 * @return     SdnAddress Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinSdn(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SdnAddress) to $obj2 (Sdn)
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SdnAddress) to the collection in $obj2 (Sdn)
				$obj2->addSdnAddress($obj1);
...
//
// NOTE: This static code cannot call methods on the SdnAddressPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SdnAddressPeer class:
//
// Propel::getDatabaseMap(SdnAddressPeer::DATABASE_NAME)->addTableBuilder(SdnAddressPeer::TABLE_NAME, SdnAddressPeer::getMapBuilder());
//
