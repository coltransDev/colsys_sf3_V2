...
abstract class BaseSdnAkaPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of SdnAka objects.
	 ...
	 *
	 * @param      SdnAka $value A SdnAka object.
	 ...
	 *
	 * @param      mixed $value A SdnAka object or a primary key value.
	 */
	 ...
	 * @return     SdnAka Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinSdn(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SdnAka) to $obj2 (Sdn)
				$obj2->addSdnAka($obj1);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SdnAka) to the collection in $obj2 (Sdn)
				$obj2->addSdnAka($obj1);
...
//
// NOTE: This static code cannot call methods on the SdnAkaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SdnAkaPeer class:
//
// Propel::getDatabaseMap(SdnAkaPeer::DATABASE_NAME)->addTableBuilder(SdnAkaPeer::TABLE_NAME, SdnAkaPeer::getMapBuilder());
//
