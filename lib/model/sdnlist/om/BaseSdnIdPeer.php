...
abstract class BaseSdnIdPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (SdnIdPeer::CA_UID, SdnIdPeer::CA_UID_ID, SdnIdPeer::CA_IDTYPE, SdnIdPeer::CA_IDNUMBER, SdnIdPeer::CA_IDCOUNTRY, SdnIdPeer::CA_ISSUEDATE, SdnIdPeer::CA_EXPIRATIONDATE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (SdnIdPeer::CA_UID => 0, SdnIdPeer::CA_UID_ID => 1, SdnIdPeer::CA_IDTYPE => 2, SdnIdPeer::CA_IDNUMBER => 3, SdnIdPeer::CA_IDCOUNTRY => 4, SdnIdPeer::CA_ISSUEDATE => 5, SdnIdPeer::CA_EXPIRATIONDATE => 6, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.sdnlist.map.SdnIdMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(tb_sdnid.CA_UID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_sdnid.CA_UID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(SdnIdPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(SdnIdPeer::COUNT);
		}
		...
		$rs = SdnIdPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return SdnIdPeer::populateObjects(SdnIdPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinSdn(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(SdnIdPeer::CA_UID, SdnPeer::CA_UID);
	...
	public static function doSelectJoinSdn(Criteria $c, $con = null)
	{
		...
		$startcol = (SdnIdPeer::NUM_COLUMNS - SdnIdPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		SdnPeer::addSelectColumns($c);

		$c->addJoin(SdnIdPeer::CA_UID, SdnPeer::CA_UID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addSdnId($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initSdnIds();
				$obj2->addSdnId($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		SdnIdPeer::addSelectColumns($c);
		$startcol2 = (SdnIdPeer::NUM_COLUMNS - SdnIdPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SdnIdPeer::CA_UID, $vals[0], Criteria::IN);
			$criteria->add(SdnIdPeer::CA_UID_ID, $vals[1], Criteria::IN);
		}
	 ...
	 * @param double $ca_uid
	   @param double $ca_uid_id
	   
	 * @param      Connection $con
	 * @return     SdnId
	 */
	public static function retrieveByPK( $ca_uid, $ca_uid_id, $con = null) {
		if ($con === null) {
			$con = Propel::getConnection(self::DATABASE_NAME);
		}
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('lib.model.sdnlist.map.SdnIdMapBuilder');
}
