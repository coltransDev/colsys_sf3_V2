...
abstract class BaseSdnIdPeer {
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseSdnIdPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseSdnIdPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseSdnIdPeer', $c, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseSdnIdPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSdnIdPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseSdnIdPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSdnIdPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseSdnIdPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseSdnIdPeer', $values, $con, $ret);
    }
