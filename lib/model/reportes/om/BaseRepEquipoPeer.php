...
/**
 * Base static class for performing query and update operations on the 'tb_repequipos' table.
 *
 * 
 *
...
abstract class BaseRepEquipoPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (RepEquipoPeer::CA_IDREPORTE, RepEquipoPeer::CA_IDCONCEPTO, RepEquipoPeer::CA_CANTIDAD, RepEquipoPeer::CA_IDEQUIPO, RepEquipoPeer::CA_OBSERVACIONES, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (RepEquipoPeer::CA_IDREPORTE => 0, RepEquipoPeer::CA_IDCONCEPTO => 1, RepEquipoPeer::CA_CANTIDAD => 2, RepEquipoPeer::CA_IDEQUIPO => 3, RepEquipoPeer::CA_OBSERVACIONES => 4, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.reportes.map.RepEquipoMapBuilder');
	}
	/**
	 ...
	 * @param      string $column The column name for current table. (i.e. RepEquipoPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	const COUNT = 'COUNT(tb_repequipos.CA_IDREPORTE)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_repequipos.CA_IDREPORTE)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(RepEquipoPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(RepEquipoPeer::COUNT);
		}
		...
		$rs = RepEquipoPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return RepEquipoPeer::populateObjects(RepEquipoPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinConcepto(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(RepEquipoPeer::CA_IDCONCEPTO, ConceptoPeer::CA_IDCONCEPTO);
	...
	/**
	 * Selects a collection of RepEquipo objects pre-filled with their Reporte objects.
	 *
	 * @return     array Array of RepEquipo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinReporte(Criteria $c, $con = null)
	{
		...
		$startcol = (RepEquipoPeer::NUM_COLUMNS - RepEquipoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		ReportePeer::addSelectColumns($c);

		$c->addJoin(RepEquipoPeer::CA_IDREPORTE, ReportePeer::CA_IDREPORTE);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addRepEquipo($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initRepEquipos();
				$obj2->addRepEquipo($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	/**
	 * Selects a collection of RepEquipo objects pre-filled with their Concepto objects.
	 *
	 * @return     array Array of RepEquipo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinConcepto(Criteria $c, $con = null)
	{
		...
		$c->addJoin(RepEquipoPeer::CA_IDCONCEPTO, ConceptoPeer::CA_IDCONCEPTO);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	/**
	 * Selects a collection of RepEquipo objects pre-filled with all related objects.
	 *
	 * @return     array Array of RepEquipo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		RepEquipoPeer::addSelectColumns($c);
		$startcol2 = (RepEquipoPeer::NUM_COLUMNS - RepEquipoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addRepEquipo($obj1); // CHECKME
					break;
				}
			}
	...
	/**
	 * Selects a collection of RepEquipo objects pre-filled with all related objects except Reporte.
	 *
	 * @return     array Array of RepEquipo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Selects a collection of RepEquipo objects pre-filled with all related objects except Concepto.
	 *
	 * @return     array Array of RepEquipo objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a RepEquipo or Criteria object.
	 *
	 * @param      mixed $values Criteria or RepEquipo object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from RepEquipo object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a RepEquipo or Criteria object.
	 *
	 * @param      mixed $values Criteria or RepEquipo object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, $con = null)
	{
		...
		} else { // $values is RepEquipo object
	...
	/**
	 * Method to DELETE all rows from the tb_repequipos table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a RepEquipo or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or RepEquipo object or primary key or array of primary keys
	 ...
	 */
	 ...
	 {
		if ($con === null) {
			$con = Propel::getConnection(RepEquipoPeer::DATABASE_NAME);
		}
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(RepEquipoPeer::CA_IDREPORTE, $vals[0], Criteria::IN);
			$criteria->add(RepEquipoPeer::CA_IDCONCEPTO, $vals[1], Criteria::IN);
		}
	...
	/**
	 * Validates all modified columns of given RepEquipo object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      RepEquipo $obj The object to validate.
	 ...
	 * @return     RepEquipo
	 */
	public static function retrieveByPK( $ca_idreporte, $ca_idconcepto, $con = null) {
		if ($con === null) {
			$con = Propel::getConnection(self::DATABASE_NAME);
		}
...
if (Propel::isInit()) {
	...
	try {
		BaseRepEquipoPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.reportes.map.RepEquipoMapBuilder');
}
