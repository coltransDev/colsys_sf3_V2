...
/**
 * Base class that represents a row from the 'tb_repstatusrespuestas' table.
 *
 * 
 *
...
abstract class BaseRepStatusRespuesta extends BaseObject  implements Persistent {
  ...
  const PEER = 'RepStatusRespuestaPeer';
	...
	/**
	 * Initializes internal state of BaseRepStatusRespuesta object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [ca_respuesta] column value.
	 * 
	 * @return     string
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = RepStatusRespuestaPeer::NUM_COLUMNS - RepStatusRespuestaPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Generic method to set the primary key (ca_idrepstatusrespuestas column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RepStatusRespuesta (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RepStatusRespuesta Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Declares an association between this object and a RepStatus object.
	 *
	 * @param      RepStatus $v
	 * @return     RepStatusRespuesta The current object (for fluent API support)
	 * @throws     PropelException
	...
	public function setRepStatus(RepStatus $v = null)
	{
		...
		// If this object has already been added to the RepStatus object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated RepStatus object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     RepStatus The associated RepStatus object.
	 * @throws     PropelException
	 */
	public function getRepStatus(PropelPDO $con = null)
	{
		if ($this->aRepStatus === null && ($this->ca_idreporte !== null && $this->ca_idemail !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aRepStatus->addRepStatusRespuestas($this);
			 */
		}
