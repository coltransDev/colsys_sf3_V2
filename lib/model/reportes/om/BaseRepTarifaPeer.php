...
abstract class BaseRepTarifaPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of RepTarifa objects.
	 ...
	 *
	 * @param      RepTarifa $value A RepTarifa object.
	 ...
	 *
	 * @param      mixed $value A RepTarifa object or a primary key value.
	 */
	 ...
	 * @return     RepTarifa Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinReporte(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RepTarifa) to $obj2 (Reporte)
	...
	public static function doSelectJoinConcepto(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RepTarifa) to $obj2 (Concepto)
				$obj2->addRepTarifa($obj1);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RepTarifa) to the collection in $obj2 (Reporte)
				$obj2->addRepTarifa($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (RepTarifa) to the collection in $obj3 (Concepto)
	...
	public static function doSelectJoinAllExceptReporte(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = RepTarifaPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (RepTarifa) to the collection in $obj2 (Concepto)
				$obj2->addRepTarifa($obj1);
...
//
// NOTE: This static code cannot call methods on the RepTarifaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the RepTarifaPeer class:
//
// Propel::getDatabaseMap(RepTarifaPeer::DATABASE_NAME)->addTableBuilder(RepTarifaPeer::TABLE_NAME, RepTarifaPeer::getMapBuilder());
//
