...
abstract class BaseRepAviso extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->ca_introduccion = $rs->getString($startcol + 2);

			$this->ca_fchsalida = $rs->getDate($startcol + 3, null);

			$this->ca_fchllegada = $rs->getDate($startcol + 4, null);

			$this->ca_fchcontinuacion = $rs->getString($startcol + 5);

			$this->ca_piezas = $rs->getString($startcol + 6);

			$this->ca_peso = $rs->getString($startcol + 7);

			$this->ca_volumen = $rs->getString($startcol + 8);

			$this->ca_fchenvio = $rs->getTimestamp($startcol + 9, null);

			$this->ca_usuenvio = $rs->getString($startcol + 10);

			$this->ca_doctransporte = $rs->getString($startcol + 11);

			$this->ca_idnave = $rs->getString($startcol + 12);

			$this->ca_notas = $rs->getString($startcol + 13);

			$this->ca_etapa = $rs->getString($startcol + 14);

			$this->ca_docmaster = $rs->getString($startcol + 15);

			$this->ca_equipos = $rs->getString($startcol + 16);

			$this->ca_horasalida = $rs->getTime($startcol + 17, null);

			$this->ca_tipo = $rs->getString($startcol + 18);
