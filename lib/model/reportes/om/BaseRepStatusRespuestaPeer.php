...
/**
 * Base static class for performing query and update operations on the 'tb_repstatusrespuestas' table.
 *
 * 
 *
...
abstract class BaseRepStatusRespuestaPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of RepStatusRespuesta objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array RepStatusRespuesta[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. RepStatusRespuestaPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      RepStatusRespuesta $value A RepStatusRespuesta object.
	 ...
	 *
	 * @param      mixed $value A RepStatusRespuesta object or a primary key value.
	 */
	 ...
	 * @return     RepStatusRespuesta Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of RepStatusRespuesta objects pre-filled with their RepStatus objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of RepStatusRespuesta objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a RepStatusRespuesta or Criteria object.
	 *
	 * @param      mixed $values Criteria or RepStatusRespuesta object containing data that is used to create the INSERT statement.
	...
	/**
	 * Method perform an UPDATE on the database, given a RepStatusRespuesta or Criteria object.
	 *
	 * @param      mixed $values Criteria or RepStatusRespuesta object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is RepStatusRespuesta object
	...
	/**
	 * Method to DELETE all rows from the tb_repstatusrespuestas table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a RepStatusRespuesta or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or RepStatusRespuesta object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given RepStatusRespuesta object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      RepStatusRespuesta $obj The object to validate.
...
} // BaseRepStatusRespuestaPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the RepStatusRespuestaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the RepStatusRespuestaPeer class:
//
// Propel::getDatabaseMap(RepStatusRespuestaPeer::DATABASE_NAME)->addTableBuilder(RepStatusRespuestaPeer::TABLE_NAME, RepStatusRespuestaPeer::getMapBuilder());
//
