...
abstract class BaseRepCostoPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (RepCostoPeer::OID, RepCostoPeer::CA_IDREPORTE, RepCostoPeer::CA_IDCOSTO, RepCostoPeer::CA_TIPO, RepCostoPeer::CA_VLRCOSTO, RepCostoPeer::CA_MINCOSTO, RepCostoPeer::CA_NETCOSTO, RepCostoPeer::CA_IDMONEDA, RepCostoPeer::CA_DETALLES, RepCostoPeer::CA_FCHCREADO, RepCostoPeer::CA_USUCREADO, RepCostoPeer::CA_FCHACTUALIZADO, RepCostoPeer::CA_USUACTUALIZADO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (RepCostoPeer::OID => 0, RepCostoPeer::CA_IDREPORTE => 1, RepCostoPeer::CA_IDCOSTO => 2, RepCostoPeer::CA_TIPO => 3, RepCostoPeer::CA_VLRCOSTO => 4, RepCostoPeer::CA_MINCOSTO => 5, RepCostoPeer::CA_NETCOSTO => 6, RepCostoPeer::CA_IDMONEDA => 7, RepCostoPeer::CA_DETALLES => 8, RepCostoPeer::CA_FCHCREADO => 9, RepCostoPeer::CA_USUCREADO => 10, RepCostoPeer::CA_FCHACTUALIZADO => 11, RepCostoPeer::CA_USUACTUALIZADO => 12, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.reportes.map.RepCostoMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(tb_repaduanadet.OID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_repaduanadet.OID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(RepCostoPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(RepCostoPeer::COUNT);
		}
		...
		$rs = RepCostoPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return RepCostoPeer::populateObjects(RepCostoPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinReporte(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(RepCostoPeer::CA_IDREPORTE, ReportePeer::CA_IDREPORTE);
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinCosto(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(RepCostoPeer::CA_IDCOSTO, CostoPeer::CA_IDCOSTO);
	...
	public static function doSelectJoinReporte(Criteria $c, $con = null)
	{
		...
		$startcol = (RepCostoPeer::NUM_COLUMNS - RepCostoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		ReportePeer::addSelectColumns($c);

		$c->addJoin(RepCostoPeer::CA_IDREPORTE, ReportePeer::CA_IDREPORTE);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addRepCosto($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initRepCostos();
				$obj2->addRepCosto($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCosto(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		while($rs->next()) {
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getCosto(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addRepCosto($obj1); //CHECKME
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		RepCostoPeer::addSelectColumns($c);
		$startcol2 = (RepCostoPeer::NUM_COLUMNS - RepCostoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

		ReportePeer::addSelectColumns($c);
		$startcol3 = $startcol2 + ReportePeer::NUM_COLUMNS;

		CostoPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + CostoPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getCosto(); // CHECKME
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addRepCosto($obj1); // CHECKME
					break;
				}
			}
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptCosto(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptReporte(Criteria $c, $con = null)
	{
		...
		CostoPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + CostoPeer::NUM_COLUMNS;
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptCosto(Criteria $c, $con = null)
	{
		$c = clone $c;
...
if (Propel::isInit()) {
	...
	try {
		BaseRepCostoPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.reportes.map.RepCostoMapBuilder');
}
