...
/**
 * Base class that represents a row from the 'tb_repasignaciones' table.
 *
 * 
 *
 * @package    lib.model.reportes.om
 */
abstract class BaseRepAsignacion extends BaseObject  implements Persistent {


  const PEER = 'RepAsignacionPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        RepAsignacionPeer
	 */
	...
	/**
	 * Initializes internal state of BaseRepAsignacion object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     RepAsignacion The current object (for fluent API support)
	 */
	public function setCaIdreporte($v)
	{
		...
		if ($this->ca_idreporte !== $v) {
			$this->ca_idreporte = $v;
			$this->modifiedColumns[] = RepAsignacionPeer::CA_IDREPORTE;
		}
	...
	public function setCaIdtarea($v)
	{
		...
		if ($this->ca_idtarea !== $v) {
			$this->ca_idtarea = $v;
			$this->modifiedColumns[] = RepAsignacionPeer::CA_IDTAREA;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ca_idtarea = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = RepAsignacionPeer::NUM_COLUMNS - RepAsignacionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RepAsignacion object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RepAsignacionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			RepAsignacionPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			RepAsignacionPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RepAsignacionPeer::doInsert($this, $con);
					...
					$affectedRows += RepAsignacionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RepAsignacionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RepAsignacionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RepAsignacionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getCaIdreporte(),
			$keys[1] => $this->getCaIdtarea(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCaIdtarea($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RepAsignacionPeer::CA_IDREPORTE)) $criteria->add(RepAsignacionPeer::CA_IDREPORTE, $this->ca_idreporte);
		if ($this->isColumnModified(RepAsignacionPeer::CA_IDTAREA)) $criteria->add(RepAsignacionPeer::CA_IDTAREA, $this->ca_idtarea);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RepAsignacion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RepAsignacion Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RepAsignacionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RepAsignacionPeer();
		}
		return self::$peer;
	}
	...
	public function getReporte(PropelPDO $con = null)
	{
		if ($this->aReporte === null && ($this->ca_idreporte !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aReporte->addRepAsignacions($this);
			 */
		}
	...
	public function getNotTarea(PropelPDO $con = null)
	{
		if ($this->aNotTarea === null && ($this->ca_idtarea !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aNotTarea->addRepAsignacions($this);
			 */
		}
