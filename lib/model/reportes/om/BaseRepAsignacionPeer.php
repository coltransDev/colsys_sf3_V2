...
/**
 * Base static class for performing query and update operations on the 'tb_repasignaciones' table.
 *
 * 
 *
...
abstract class BaseRepAsignacionPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of RepAsignacion objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array RepAsignacion[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. RepAsignacionPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      RepAsignacion $value A RepAsignacion object.
	 ...
	 *
	 * @param      mixed $value A RepAsignacion object or a primary key value.
	 */
	 ...
	 * @return     RepAsignacion Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of RepAsignacion objects pre-filled with their Reporte objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of RepAsignacion objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinReporte(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RepAsignacion) to $obj2 (Reporte)
	...
	/**
	 * Selects a collection of RepAsignacion objects pre-filled with their NotTarea objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of RepAsignacion objects.
	...
	public static function doSelectJoinNotTarea(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RepAsignacion) to $obj2 (NotTarea)
				$obj2->addRepAsignacion($obj1);
	...
	/**
	 * Selects a collection of RepAsignacion objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (RepAsignacion) to the collection in $obj2 (Reporte)
				$obj2->addRepAsignacion($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (RepAsignacion) to the collection in $obj3 (NotTarea)
	...
	/**
	 * Selects a collection of RepAsignacion objects pre-filled with all related objects except Reporte.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptReporte(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = RepAsignacionPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (RepAsignacion) to the collection in $obj2 (NotTarea)
				$obj2->addRepAsignacion($obj1);
	...
	/**
	 * Selects a collection of RepAsignacion objects pre-filled with all related objects except NotTarea.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a RepAsignacion or Criteria object.
	 *
	 * @param      mixed $values Criteria or RepAsignacion object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from RepAsignacion object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a RepAsignacion or Criteria object.
	 *
	 * @param      mixed $values Criteria or RepAsignacion object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is RepAsignacion object
	...
	/**
	 * Method to DELETE all rows from the tb_repasignaciones table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a RepAsignacion or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or RepAsignacion object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given RepAsignacion object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      RepAsignacion $obj The object to validate.
...
} // BaseRepAsignacionPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the RepAsignacionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the RepAsignacionPeer class:
//
// Propel::getDatabaseMap(RepAsignacionPeer::DATABASE_NAME)->addTableBuilder(RepAsignacionPeer::TABLE_NAME, RepAsignacionPeer::getMapBuilder());
//
