...
class ReporteConceptoSeaMapBuilder {

	
	const CLASS_NAME = 'lib.model.reportes.map.ReporteConceptoSeaMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('tb_repmaritimo');
		$tMap->setPhpName('ReporteConceptoSea');
		...
		$tMap->addColumn('CA_CANTIDAD', 'CaCantidad', 'double', CreoleTypes::NUMERIC, true);

		$tMap->addColumn('CA_NETA_TAR', 'CaNetaTar', 'double', CreoleTypes::NUMERIC, true);

		$tMap->addColumn('CA_NETA_MIN', 'CaNetaMin', 'double', CreoleTypes::NUMERIC, true);
