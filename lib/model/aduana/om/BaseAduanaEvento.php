...
abstract class BaseAduanaEvento extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->ca_realizado = $rs->getInt($startcol + 1);

			$this->ca_idevento = $rs->getInt($startcol + 2);

			$this->ca_usuario = $rs->getString($startcol + 3);

			$this->ca_fchevento = $rs->getTimestamp($startcol + 4, null);

			$this->ca_notas = $rs->getString($startcol + 5);
