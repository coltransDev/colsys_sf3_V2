...
/**
 * Base class that represents a row from the 'tb_brk_evento' table.
 *
 * 
 *
...
abstract class BaseAduanaEvento extends BaseObject  implements Persistent {
  ...
  const PEER = 'AduanaEventoPeer';
	...
	/**
	 * The value for the ca_realizado field.
	 * @var        int
	 */
	...
	/**
	 * Initializes internal state of BaseAduanaEvento object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [ca_realizado] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [ca_fchevento] column value.
	 * 
	 *
	 ...
	 * @return     AduanaEvento The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [ca_realizado] column.
	 * 
	...
	/**
	 * Sets the value of [ca_fchevento] column to a normalized version of the date/time value specified.
	 * 
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = AduanaEventoPeer::NUM_COLUMNS - AduanaEventoPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AduanaEvento (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AduanaEvento Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function setAduanaMaestra(AduanaMaestra $v = null)
	{
		...
		// If this object has already been added to the AduanaMaestra object, it will not be re-added.
		if ($v !== null) {
	...
	public function getAduanaMaestra(PropelPDO $con = null)
	{
		if ($this->aAduanaMaestra === null && (($this->ca_referencia !== "" && $this->ca_referencia !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aAduanaMaestra->addAduanaEventos($this);
			 */
		}
