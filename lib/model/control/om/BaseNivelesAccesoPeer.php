...
abstract class BaseNivelesAccesoPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of NivelesAcceso objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array NivelesAcceso[]
	 */
	 ...
	 *
	 * @param      NivelesAcceso $value A NivelesAcceso object.
	 ...
	 *
	 * @param      mixed $value A NivelesAcceso object or a primary key value.
	 */
	 ...
	 * @return     NivelesAcceso Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinUsuario(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (NivelesAcceso) to $obj2 (Usuario)
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (NivelesAcceso) to the collection in $obj2 (Usuario)
				$obj2->addNivelesAcceso($obj1);
...
//
// NOTE: This static code cannot call methods on the NivelesAccesoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the NivelesAccesoPeer class:
//
// Propel::getDatabaseMap(NivelesAccesoPeer::DATABASE_NAME)->addTableBuilder(NivelesAccesoPeer::TABLE_NAME, NivelesAccesoPeer::getMapBuilder());
//
