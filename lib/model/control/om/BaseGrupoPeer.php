...
/**
 * Base static class for performing query and update operations on the 'control.tb_grupos' table.
 *
 * 
 *
...
abstract class BaseGrupoPeer {
	...
	const TABLE_NAME = 'control.tb_grupos';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.control.Grupo';
	...
	const CA_NOMBRE = 'control.tb_grupos.CA_NOMBRE';

	/**
	 * An identiy map to hold any loaded instances of Grupo objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CaNombre', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('caNombre', ),
		BasePeer::TYPE_COLNAME => array (self::CA_NOMBRE, ),
		BasePeer::TYPE_FIELDNAME => array ('ca_nombre', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CaNombre' => 0, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('caNombre' => 0, ),
		BasePeer::TYPE_COLNAME => array (self::CA_NOMBRE => 0, ),
		BasePeer::TYPE_FIELDNAME => array ('ca_nombre' => 0, ),
		BasePeer::TYPE_NUM => array (0, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new GrupoMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(GrupoPeer::CA_NOMBRE);
	 ...
	 *
	 * @param      Grupo $value A Grupo object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Grupo $obj, $key = null)
	{
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Grupo or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Grupo or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(GrupoPeer::CA_NOMBRE);
			$selectCriteria->add(GrupoPeer::CA_NOMBRE, $criteria->remove(GrupoPeer::CA_NOMBRE), $comparison);
	...
	/**
	 * Method to DELETE all rows from the control.tb_grupos table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Grupo or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof Grupo) {
			...
			$criteria->add(GrupoPeer::CA_NOMBRE, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(GrupoPeer::CA_NOMBRE, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(GrupoPeer::DATABASE_NAME);
			$criteria->add(GrupoPeer::CA_NOMBRE, $pks, Criteria::IN);
...
//
// NOTE: This static code cannot call methods on the GrupoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the GrupoPeer class:
//
// Propel::getDatabaseMap(GrupoPeer::DATABASE_NAME)->addTableBuilder(GrupoPeer::TABLE_NAME, GrupoPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseGrupoPeer::DATABASE_NAME)->addTableBuilder(BaseGrupoPeer::TABLE_NAME, BaseGrupoPeer::getMapBuilder());
