...
/**
 * Base class that represents a row from the 'control.tb_perfiles' table.
 *
 * 
 *
...
abstract class BasePerfil extends BaseObject  implements Persistent {
  ...
  const PEER = 'PerfilPeer';
	...
	/**
	 * The value for the ca_perfil field.
	 * @var        string
	 */
	protected $ca_perfil;
	...
	/**
	 * @var        array AccesoPerfil[] Collection to store aggregation of AccesoPerfil objects.
	 */
	protected $collAccesoPerfils;

	/**
	 * @var        Criteria The criteria used to select the current contents of collAccesoPerfils.
	 */
	...
	/**
	 * Get the [ca_perfil] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [ca_perfil] column.
	 * 
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = PerfilPeer::NUM_COLUMNS - PerfilPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Generic method to set the primary key (ca_perfil column).
	 *
		...
		if ($deepCopy) {
			...
			foreach ($this->getAccesoPerfils() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addAccesoPerfil($relObj->copy($deepCopy));
				}
			}
	...
	public function getDepartamento(PropelPDO $con = null)
	{
		if ($this->aDepartamento === null && (($this->ca_departamento !== "" && $this->ca_departamento !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aDepartamento->addPerfils($this);
			 */
		}
	...
	/**
	 * Clears out the collAccesoPerfils collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addAccesoPerfils()
	 */
	public function clearAccesoPerfils()
	{
		$this->collAccesoPerfils = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collAccesoPerfils collection (array).
	 *
	 * By default this just sets the collAccesoPerfils collection to an empty array (like clearcollAccesoPerfils());
	...
	/**
	 * Gets an array of AccesoPerfil objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Perfil has previously been saved, it will retrieve
	 * related AccesoPerfils from storage. If this Perfil is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array AccesoPerfil[]
	 * @throws     PropelException
	 */
	...
	/**
	 * Returns the number of related AccesoPerfil objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related AccesoPerfil objects.
	 * @throws     PropelException
	 */
	...
	/**
	 * Method called to associate a AccesoPerfil object to this object
	 * through the AccesoPerfil foreign key attribute.
	 *
	 * @param      AccesoPerfil $l AccesoPerfil
	 * @return     void
	 * @throws     PropelException
	 */
	public function addAccesoPerfil(AccesoPerfil $l)
	{
		...
		if (!in_array($l, $this->collAccesoPerfils, true)) { // only add it if the **same** object is not already associated
			array_push($this->collAccesoPerfils, $l);
			$l->setPerfil($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Perfil has previously been saved, it will retrieve
	 * related UsuarioPerfils from storage. If this Perfil is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
