...
/**
 * Base static class for performing query and update operations on the 'control.tb_usuarios_log' table.
 *
 * 
 *
...
abstract class BaseUsuarioLogPeer {
	...
	/** the column name for the CA_EVENT field */
	...
	/**
	 * An identiy map to hold any loaded instances of UsuarioLog objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array UsuarioLog[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. UsuarioLogPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      UsuarioLog $value A UsuarioLog object.
	 ...
	 *
	 * @param      mixed $value A UsuarioLog object or a primary key value.
	 */
	 ...
	 * @return     UsuarioLog Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of UsuarioLog objects pre-filled with their Usuario objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of UsuarioLog objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuario(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (UsuarioLog) to $obj2 (Usuario)
	...
	/**
	 * Selects a collection of UsuarioLog objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (UsuarioLog) to the collection in $obj2 (Usuario)
				$obj2->addUsuarioLog($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a UsuarioLog or Criteria object.
	 *
	 * @param      mixed $values Criteria or UsuarioLog object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from UsuarioLog object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a UsuarioLog or Criteria object.
	 *
	 * @param      mixed $values Criteria or UsuarioLog object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is UsuarioLog object
	...
	/**
	 * Method to DELETE all rows from the control.tb_usuarios_log table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a UsuarioLog or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or UsuarioLog object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given UsuarioLog object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      UsuarioLog $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the UsuarioLogPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the UsuarioLogPeer class:
//
// Propel::getDatabaseMap(UsuarioLogPeer::DATABASE_NAME)->addTableBuilder(UsuarioLogPeer::TABLE_NAME, UsuarioLogPeer::getMapBuilder());
//
