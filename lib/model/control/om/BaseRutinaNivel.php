...
/**
 * Base class that represents a row from the 'control.tb_rutinas_niveles' table.
 *
 * 
 *
...
abstract class BaseRutinaNivel extends BaseObject  implements Persistent {
  ...
  const PEER = 'RutinaNivelPeer';
	...
	/**
	 * Initializes internal state of BaseRutinaNivel object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     RutinaNivel The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = RutinaNivelPeer::NUM_COLUMNS - RutinaNivelPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RutinaNivel (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RutinaNivel Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Declares an association between this object and a Rutina object.
	 *
	 * @param      Rutina $v
	 * @return     RutinaNivel The current object (for fluent API support)
	 * @throws     PropelException
	...
	public function setRutina(Rutina $v = null)
	{
		...
		// If this object has already been added to the Rutina object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated Rutina object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Rutina The associated Rutina object.
	 * @throws     PropelException
	 */
	public function getRutina(PropelPDO $con = null)
	{
		if ($this->aRutina === null && (($this->ca_rutina !== "" && $this->ca_rutina !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aRutina->addRutinaNivels($this);
			 */
		}
		return $this->aRutina;
	}
