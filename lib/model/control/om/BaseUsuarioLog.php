...
/**
 * Base class that represents a row from the 'control.tb_usuarios_log' table.
 *
 * 
 *
...
abstract class BaseUsuarioLog extends BaseObject  implements Persistent {
  ...
  const PEER = 'UsuarioLogPeer';
	...
	/**
	 * Initializes internal state of BaseUsuarioLog object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     UsuarioLog The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = UsuarioLogPeer::NUM_COLUMNS - UsuarioLogPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UsuarioLog (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UsuarioLog Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuario->addUsuarioLogs($this);
			 */
		}
