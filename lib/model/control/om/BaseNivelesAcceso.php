...
abstract class BaseNivelesAcceso extends BaseObject  implements Persistent {
  ...
  const PEER = 'NivelesAccesoPeer';
	...
	/**
	 * Initializes internal state of BaseNivelesAcceso object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     NivelesAcceso The current object (for fluent API support)
	 */
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuario->addNivelesAccesos($this);
			 */
		}
