...
abstract class BaseRutinaPeer {
	 ...
	 * @param      string $column The column name for current table. (i.e. RutinaPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Rutina $value A Rutina object.
	 ...
	 *
	 * @param      mixed $value A Rutina object or a primary key value.
	 */
	 ...
	 * @return     Rutina Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Rutina or Criteria object.
	 *
	 * @param      mixed $values Criteria or Rutina object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Rutina object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Rutina or Criteria object.
	 *
	 * @param      mixed $values Criteria or Rutina object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method perform a DELETE on the database, given a Rutina or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Rutina object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Rutina object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Rutina $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the RutinaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the RutinaPeer class:
//
// Propel::getDatabaseMap(RutinaPeer::DATABASE_NAME)->addTableBuilder(RutinaPeer::TABLE_NAME, RutinaPeer::getMapBuilder());
//
