...
abstract class BaseRutinaPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (RutinaPeer::CA_RUTINA, RutinaPeer::CA_OPCION, RutinaPeer::CA_DESCRIPCION, RutinaPeer::CA_PROGRAMA, RutinaPeer::CA_GRUPO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (RutinaPeer::CA_RUTINA => 0, RutinaPeer::CA_OPCION => 1, RutinaPeer::CA_DESCRIPCION => 2, RutinaPeer::CA_PROGRAMA => 3, RutinaPeer::CA_GRUPO => 4, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.control.map.RutinaMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(control.tb_rutinas.CA_RUTINA)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT control.tb_rutinas.CA_RUTINA)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(RutinaPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(RutinaPeer::COUNT);
		}
		...
		$rs = RutinaPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return RutinaPeer::populateObjects(RutinaPeer::doSelectRS($criteria, $con));
	}
	/**
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('lib.model.control.map.RutinaMapBuilder');
}
