...
/**
 * Base static class for performing query and update operations on the 'control.tb_accesos_perfiles' table.
 *
 * 
 *
...
abstract class BaseAccesoPerfilPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of AccesoPerfil objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array AccesoPerfil[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. AccesoPerfilPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      AccesoPerfil $value A AccesoPerfil object.
	 ...
	 *
	 * @param      mixed $value A AccesoPerfil object or a primary key value.
	 */
	 ...
	 * @return     AccesoPerfil Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of AccesoPerfil objects pre-filled with their Perfil objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of AccesoPerfil objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinPerfil(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AccesoPerfil) to $obj2 (Perfil)
	...
	/**
	 * Selects a collection of AccesoPerfil objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AccesoPerfil) to the collection in $obj2 (Perfil)
				$obj2->addAccesoPerfil($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a AccesoPerfil or Criteria object.
	 *
	 * @param      mixed $values Criteria or AccesoPerfil object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from AccesoPerfil object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a AccesoPerfil or Criteria object.
	 *
	 * @param      mixed $values Criteria or AccesoPerfil object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is AccesoPerfil object
	...
	/**
	 * Method to DELETE all rows from the control.tb_accesos_perfiles table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a AccesoPerfil or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or AccesoPerfil object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given AccesoPerfil object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      AccesoPerfil $obj The object to validate.
...
} // BaseAccesoPerfilPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the AccesoPerfilPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AccesoPerfilPeer class:
//
// Propel::getDatabaseMap(AccesoPerfilPeer::DATABASE_NAME)->addTableBuilder(AccesoPerfilPeer::TABLE_NAME, AccesoPerfilPeer::getMapBuilder());
//
