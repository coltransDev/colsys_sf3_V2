...
/**
 * Base class that represents a row from the 'control.tb_rutinas_old' table.
 *
 * 
 *
 * @package    lib.model.control.om
 */
abstract class BaseRutinaOld extends BaseObject  implements Persistent {


  const PEER = 'RutinaOldPeer';
	...
	/**
	 * Initializes internal state of BaseRutinaOld object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     RutinaOld The current object (for fluent API support)
	 */
	public function setCaRutina($v)
	{
		...
		if ($this->ca_rutina !== $v) {
			$this->ca_rutina = $v;
			$this->modifiedColumns[] = RutinaOldPeer::CA_RUTINA;
		}
	...
	public function setCaOpcion($v)
	{
		...
		if ($this->ca_opcion !== $v) {
			$this->ca_opcion = $v;
			$this->modifiedColumns[] = RutinaOldPeer::CA_OPCION;
		}
	...
	public function setCaDescripcion($v)
	{
		...
		if ($this->ca_descripcion !== $v) {
			...
			$this->modifiedColumns[] = RutinaOldPeer::CA_DESCRIPCION;
		}
	...
	public function setCaPrograma($v)
	{
		...
		if ($this->ca_programa !== $v) {
			$this->ca_programa = $v;
			$this->modifiedColumns[] = RutinaOldPeer::CA_PROGRAMA;
		}
	...
	public function setCaGrupo($v)
	{
		...
		if ($this->ca_grupo !== $v) {
			$this->ca_grupo = $v;
			$this->modifiedColumns[] = RutinaOldPeer::CA_GRUPO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = RutinaOldPeer::NUM_COLUMNS - RutinaOldPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating RutinaOld object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = RutinaOldPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			RutinaOldPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			RutinaOldPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RutinaOldPeer::doInsert($this, $con);
					...
					$affectedRows += RutinaOldPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RutinaOldPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RutinaOldPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RutinaOldPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RutinaOldPeer::CA_RUTINA)) $criteria->add(RutinaOldPeer::CA_RUTINA, $this->ca_rutina);
		if ($this->isColumnModified(RutinaOldPeer::CA_OPCION)) $criteria->add(RutinaOldPeer::CA_OPCION, $this->ca_opcion);
		if ($this->isColumnModified(RutinaOldPeer::CA_DESCRIPCION)) $criteria->add(RutinaOldPeer::CA_DESCRIPCION, $this->ca_descripcion);
		if ($this->isColumnModified(RutinaOldPeer::CA_PROGRAMA)) $criteria->add(RutinaOldPeer::CA_PROGRAMA, $this->ca_programa);
		if ($this->isColumnModified(RutinaOldPeer::CA_GRUPO)) $criteria->add(RutinaOldPeer::CA_GRUPO, $this->ca_grupo);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RutinaOldPeer::CA_RUTINA, $this->ca_rutina);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of RutinaOld (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     RutinaOld Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     RutinaOldPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new RutinaOldPeer();
		}
		return self::$peer;
	}
