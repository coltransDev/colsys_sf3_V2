...
/**
 * Base class that represents a row from the 'control.tb_grupos' table.
 *
 * 
 *
...
abstract class BaseGrupo extends BaseObject  implements Persistent {
  ...
  const PEER = 'GrupoPeer';
	...
	public function setCaNombre($v)
	{
		...
		if ($this->ca_nombre !== $v) {
			$this->ca_nombre = $v;
			$this->modifiedColumns[] = GrupoPeer::CA_NOMBRE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 1; // 1 = GrupoPeer::NUM_COLUMNS - GrupoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GrupoPeer::CA_NOMBRE)) $criteria->add(GrupoPeer::CA_NOMBRE, $this->ca_nombre);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GrupoPeer::CA_NOMBRE, $this->ca_nombre);
