...
/**
 * Base static class for performing query and update operations on the 'control.tb_sucursales' table.
 *
 * 
 *
...
abstract class BaseSucursalPeer {
	...
	/** the column name for the CA_TELEFONO field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (SucursalPeer::CA_NOMBRE, SucursalPeer::CA_TELEFONO, SucursalPeer::CA_FAX, SucursalPeer::CA_DIRECCION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (SucursalPeer::CA_NOMBRE => 0, SucursalPeer::CA_TELEFONO => 1, SucursalPeer::CA_FAX => 2, SucursalPeer::CA_DIRECCION => 3, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.control.map.SucursalMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(control.tb_sucursales.CA_NOMBRE)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT control.tb_sucursales.CA_NOMBRE)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(SucursalPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(SucursalPeer::COUNT);
		}
		...
		$rs = SucursalPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return SucursalPeer::populateObjects(SucursalPeer::doSelectRS($criteria, $con));
	}
	/**
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Sucursal or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Sucursal or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the control.tb_sucursales table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Sucursal or Criteria object OR a primary key value.
	 *
...
if (Propel::isInit()) {
	...
	try {
		BaseSucursalPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.control.map.SucursalMapBuilder');
}
