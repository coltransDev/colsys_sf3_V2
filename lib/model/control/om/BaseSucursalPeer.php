...
abstract class BaseSucursalPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Sucursal objects.
	 ...
	 *
	 * @param      Sucursal $value A Sucursal object.
...
//
// NOTE: This static code cannot call methods on the SucursalPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SucursalPeer class:
//
// Propel::getDatabaseMap(SucursalPeer::DATABASE_NAME)->addTableBuilder(SucursalPeer::TABLE_NAME, SucursalPeer::getMapBuilder());
//
