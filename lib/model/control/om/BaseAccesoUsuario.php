...
abstract class BaseAccesoUsuario extends BaseObject  implements Persistent {
  ...
  const PEER = 'AccesoUsuarioPeer';
	...
	/**
	 * Initializes internal state of BaseAccesoUsuario object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AccesoUsuario The current object (for fluent API support)
	 */
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuario->addAccesoUsuarios($this);
			 */
		}
