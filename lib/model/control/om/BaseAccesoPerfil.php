...
/**
 * Base class that represents a row from the 'control.tb_accesos_perfiles' table.
 *
 * 
 *
...
abstract class BaseAccesoPerfil extends BaseObject  implements Persistent {
  ...
  const PEER = 'AccesoPerfilPeer';
	...
	/**
	 * Initializes internal state of BaseAccesoPerfil object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AccesoPerfil The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = AccesoPerfilPeer::NUM_COLUMNS - AccesoPerfilPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of AccesoPerfil (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     AccesoPerfil Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getPerfil(PropelPDO $con = null)
	{
		if ($this->aPerfil === null && (($this->ca_perfil !== "" && $this->ca_perfil !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPerfil->addAccesoPerfils($this);
			 */
		}
		return $this->aPerfil;
	}
