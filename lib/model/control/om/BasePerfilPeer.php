...
/**
 * Base static class for performing query and update operations on the 'control.tb_perfiles' table.
 *
 * 
 *
...
abstract class BasePerfilPeer {
	...
	/**
	 * Selects a collection of Perfil objects pre-filled with their Departamento objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinDepartamento(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Perfil) to $obj2 (Departamento)
				$obj2->addPerfil($obj1);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Perfil) to the collection in $obj2 (Departamento)
				$obj2->addPerfil($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the control.tb_perfiles table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
