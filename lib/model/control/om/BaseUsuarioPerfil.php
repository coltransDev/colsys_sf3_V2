...
/**
 * Base class that represents a row from the 'control.tb_usuarios_perfil' table.
 *
 * 
 *
...
abstract class BaseUsuarioPerfil extends BaseObject  implements Persistent {
  ...
  const PEER = 'UsuarioPerfilPeer';
	...
	/**
	 * Initializes internal state of BaseUsuarioPerfil object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     UsuarioPerfil The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = UsuarioPerfilPeer::NUM_COLUMNS - UsuarioPerfilPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UsuarioPerfil (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     UsuarioPerfil Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aUsuario->addUsuarioPerfils($this);
			 */
		}
	...
	public function getPerfil(PropelPDO $con = null)
	{
		if ($this->aPerfil === null && (($this->ca_perfil !== "" && $this->ca_perfil !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aPerfil->addUsuarioPerfils($this);
			 */
		}
		return $this->aPerfil;
	}
