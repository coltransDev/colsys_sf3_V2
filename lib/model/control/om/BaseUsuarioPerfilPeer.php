...
/**
 * Base static class for performing query and update operations on the 'control.tb_usuarios_perfil' table.
 *
 * 
 *
...
abstract class BaseUsuarioPerfilPeer {
	...
	/** the column name for the CA_PERFIL field */
	const CA_PERFIL = 'control.tb_usuarios_perfil.CA_PERFIL';

	/**
	 * An identiy map to hold any loaded instances of UsuarioPerfil objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array UsuarioPerfil[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. UsuarioPerfilPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      UsuarioPerfil $value A UsuarioPerfil object.
	 ...
	 *
	 * @param      mixed $value A UsuarioPerfil object or a primary key value.
	 */
	 ...
	 * @return     UsuarioPerfil Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of UsuarioPerfil objects pre-filled with their Usuario objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of UsuarioPerfil objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinUsuario(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (UsuarioPerfil) to $obj2 (Usuario)
	...
	/**
	 * Selects a collection of UsuarioPerfil objects pre-filled with their Perfil objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of UsuarioPerfil objects.
	...
	public static function doSelectJoinPerfil(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (UsuarioPerfil) to $obj2 (Perfil)
				$obj2->addUsuarioPerfil($obj1);
	...
	/**
	 * Selects a collection of UsuarioPerfil objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (UsuarioPerfil) to the collection in $obj2 (Usuario)
				$obj2->addUsuarioPerfil($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (UsuarioPerfil) to the collection in $obj3 (Perfil)
	...
	/**
	 * Selects a collection of UsuarioPerfil objects pre-filled with all related objects except Usuario.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptUsuario(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = UsuarioPerfilPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (UsuarioPerfil) to the collection in $obj2 (Perfil)
				$obj2->addUsuarioPerfil($obj1);
	...
	/**
	 * Selects a collection of UsuarioPerfil objects pre-filled with all related objects except Perfil.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a UsuarioPerfil or Criteria object.
	 *
	 * @param      mixed $values Criteria or UsuarioPerfil object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from UsuarioPerfil object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a UsuarioPerfil or Criteria object.
	 *
	 * @param      mixed $values Criteria or UsuarioPerfil object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is UsuarioPerfil object
	...
	/**
	 * Method to DELETE all rows from the control.tb_usuarios_perfil table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a UsuarioPerfil or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or UsuarioPerfil object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given UsuarioPerfil object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      UsuarioPerfil $obj The object to validate.
...
} // BaseUsuarioPerfilPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the UsuarioPerfilPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the UsuarioPerfilPeer class:
//
// Propel::getDatabaseMap(UsuarioPerfilPeer::DATABASE_NAME)->addTableBuilder(UsuarioPerfilPeer::TABLE_NAME, UsuarioPerfilPeer::getMapBuilder());
//
