...
abstract class BaseAccesoGrupo extends BaseObject  implements Persistent {
  ...
  const PEER = 'AccesoGrupoPeer';
	...
	/**
	 * Initializes internal state of BaseAccesoGrupo object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     AccesoGrupo The current object (for fluent API support)
	 */
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = AccesoGrupoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			AccesoGrupoPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
