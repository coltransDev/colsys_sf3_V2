...
abstract class BaseAccesoGrupoPeer {
	...
	const CA_IDLOG = 'control.tb_accesos_grp.CA_IDLOG';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CaIdlog', 'CaRutina', 'CaGrupo', 'CaAcceso', ),
		BasePeer::TYPE_COLNAME => array (AccesoGrupoPeer::CA_IDLOG, AccesoGrupoPeer::CA_RUTINA, AccesoGrupoPeer::CA_GRUPO, AccesoGrupoPeer::CA_ACCESO, ),
		BasePeer::TYPE_FIELDNAME => array ('ca_idlog', 'ca_rutina', 'ca_grupo', 'ca_acceso', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CaIdlog' => 0, 'CaRutina' => 1, 'CaGrupo' => 2, 'CaAcceso' => 3, ),
		BasePeer::TYPE_COLNAME => array (AccesoGrupoPeer::CA_IDLOG => 0, AccesoGrupoPeer::CA_RUTINA => 1, AccesoGrupoPeer::CA_GRUPO => 2, AccesoGrupoPeer::CA_ACCESO => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('ca_idlog' => 0, 'ca_rutina' => 1, 'ca_grupo' => 2, 'ca_acceso' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AccesoGrupoPeer::CA_IDLOG);
	...
	const COUNT = 'COUNT(control.tb_accesos_grp.CA_IDLOG)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT control.tb_accesos_grp.CA_IDLOG)';
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(AccesoGrupoPeer::CA_IDLOG);
			$selectCriteria->add(AccesoGrupoPeer::CA_IDLOG, $criteria->remove(AccesoGrupoPeer::CA_IDLOG), $comparison);
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AccesoGrupoPeer::CA_IDLOG, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(AccesoGrupoPeer::CA_IDLOG, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(AccesoGrupoPeer::CA_IDLOG, $pks, Criteria::IN);
			$objs = AccesoGrupoPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
