...
abstract class BaseAccesoGrupoPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of AccesoGrupo objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array AccesoGrupo[]
	 */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('caRutina', 'caGrupo', 'caAcceso', ),
		BasePeer::TYPE_COLNAME => array (self::CA_RUTINA, self::CA_GRUPO, self::CA_ACCESO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('caRutina' => 0, 'caGrupo' => 1, 'caAcceso' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::CA_RUTINA => 0, self::CA_GRUPO => 1, self::CA_ACCESO => 2, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AccesoGrupoMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(AccesoGrupoPeer::TABLE_NAME);
		...
		if ($con === null) {
			$con = Propel::getConnection(AccesoGrupoPeer::DATABASE_NAME, Propel::CONNECTION_READ);
		}
	...
	{
		return AccesoGrupoPeer::populateObjects(AccesoGrupoPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      AccesoGrupo $value A AccesoGrupo object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(AccesoGrupo $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getCaRutina(), (string) $obj->getCaGrupo()));
			} // if key === null
	 ...
	 *
	 * @param      mixed $value A AccesoGrupo object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof AccesoGrupo) {
				$key = serialize(array((string) $value->getCaRutina(), (string) $value->getCaGrupo()));
			} elseif (is_array($value) && count($value) === 2) {
				// assume we've been passed a primary key
				$key = serialize(array((string) $value[0], (string) $value[1]));
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or AccesoGrupo object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     AccesoGrupo Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = AccesoGrupoPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = AccesoGrupoPeer::getInstanceFromPool($key))) {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				AccesoGrupoPeer::addInstanceToPool($obj, $key);
			} // if key exists
		}
		$stmt->closeCursor();
		return $results;
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(AccesoGrupoPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			AccesoGrupoPeer::clearInstancePool();

			// rename for clarity
			$criteria = clone $values;
		} elseif ($values instanceof AccesoGrupo) {
			// invalidate the cache for this single object
			AccesoGrupoPeer::removeInstanceFromPool($values);
			...
			foreach ($values as $value) {
				...
				$criterion = $criteria->getNewCriterion(AccesoGrupoPeer::CA_RUTINA, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(AccesoGrupoPeer::CA_GRUPO, $value[1]));
				$criteria->addOr($criterion);

				// we can invalidate the cache for this single PK
				AccesoGrupoPeer::removeInstanceFromPool($value);
			}
		}
	 ...
	 * @return     AccesoGrupo
	 */
	public static function retrieveByPK($ca_rutina, $ca_grupo, PropelPDO $con = null) {
		$key = serialize(array((string) $ca_rutina, (string) $ca_grupo));
 		if (null !== ($obj = AccesoGrupoPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
...
//
// NOTE: This static code cannot call methods on the AccesoGrupoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AccesoGrupoPeer class:
//
// Propel::getDatabaseMap(AccesoGrupoPeer::DATABASE_NAME)->addTableBuilder(AccesoGrupoPeer::TABLE_NAME, AccesoGrupoPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAccesoGrupoPeer::DATABASE_NAME)->addTableBuilder(BaseAccesoGrupoPeer::TABLE_NAME, BaseAccesoGrupoPeer::getMapBuilder());
