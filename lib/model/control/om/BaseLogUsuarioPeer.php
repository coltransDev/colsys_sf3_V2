...
/**
 * Base static class for performing query and update operations on the 'control.tb_log' table.
 *
 * 
 *
...
abstract class BaseLogUsuarioPeer {
	...
	/** the column name for the CA_IDLOG field */
	...
	/** the column name for the CA_MODULE field */
	...
	/**
	 * An identiy map to hold any loaded instances of LogUsuario objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array LogUsuario[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. LogUsuarioPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      LogUsuario $value A LogUsuario object.
	 ...
	 *
	 * @param      mixed $value A LogUsuario object or a primary key value.
	 */
	 ...
	 * @return     LogUsuario Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a LogUsuario or Criteria object.
	 *
	 * @param      mixed $values Criteria or LogUsuario object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from LogUsuario object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a LogUsuario or Criteria object.
	 *
	 * @param      mixed $values Criteria or LogUsuario object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is LogUsuario object
	...
	/**
	 * Method to DELETE all rows from the control.tb_log table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a LogUsuario or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or LogUsuario object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given LogUsuario object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      LogUsuario $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the LogUsuarioPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the LogUsuarioPeer class:
//
// Propel::getDatabaseMap(LogUsuarioPeer::DATABASE_NAME)->addTableBuilder(LogUsuarioPeer::TABLE_NAME, LogUsuarioPeer::getMapBuilder());
//
