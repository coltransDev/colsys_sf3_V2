...
/**
 * This class adds structure of 'control.tb_niveles' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class NivelesAccesoMapBuilder implements MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'lib.model.control.map.NivelesAccesoMapBuilder';
