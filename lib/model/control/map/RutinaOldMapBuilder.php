 ...
 */
class RutinaOldMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.control.map.RutinaOldMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(RutinaOldPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(RutinaOldPeer::TABLE_NAME);
		$tMap->setPhpName('RutinaOld');
		$tMap->setClassname('RutinaOld');
