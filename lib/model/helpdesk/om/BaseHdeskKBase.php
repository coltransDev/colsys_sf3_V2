...
/**
 * Base class that represents a row from the 'helpdesk.tb_kbase' table.
 *
 * 
 *
...
abstract class BaseHdeskKBase extends BaseObject  implements Persistent {
  ...
  const PEER = 'HdeskKBasePeer';
	...
	/**
	 * The value for the ca_idkbase field.
	 * @var        int
	 */
	...
	/**
	 * The value for the ca_private field.
	 * @var        boolean
	 */
	protected $ca_private;

	/**
	 * @var        HdeskKBaseCategory
	 */
	...
	/**
	 * Initializes internal state of BaseHdeskKBase object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [ca_idkbase] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Get the [ca_private] column value.
	 * 
	 * @return     boolean
	 */
	...
	/**
	 * Set the value of [ca_idkbase] column.
	 * 
	 * @param      int $v new value
	 * @return     HdeskKBase The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [ca_private] column.
	 * 
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = HdeskKBasePeer::NUM_COLUMNS - HdeskKBasePeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setCaIdkbase($pk);  //[IMV] update autoincrement primary key
	...
	/**
	 * Generic method to set the primary key (ca_idkbase column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of HdeskKBase (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaIdkbase(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     HdeskKBase Clone of current object.
	 * @throws     PropelException
	 */
	...
	/**
	 * Declares an association between this object and a HdeskKBaseCategory object.
	 *
	 * @param      HdeskKBaseCategory $v
	 * @return     HdeskKBase The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setHdeskKBaseCategory(HdeskKBaseCategory $v = null)
	{
		...
		// If this object has already been added to the HdeskKBaseCategory object, it will not be re-added.
		if ($v !== null) {
	...
	/**
	 * Get the associated HdeskKBaseCategory object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     HdeskKBaseCategory The associated HdeskKBaseCategory object.
	 * @throws     PropelException
	 */
	public function getHdeskKBaseCategory(PropelPDO $con = null)
	{
		if ($this->aHdeskKBaseCategory === null && ($this->ca_idcategory !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aHdeskKBaseCategory->addHdeskKBases($this);
			 */
		}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuario->addHdeskKBases($this);
			 */
		}
