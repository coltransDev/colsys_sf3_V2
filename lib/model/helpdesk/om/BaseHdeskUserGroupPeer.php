...
/**
 * Base static class for performing query and update operations on the 'helpdesk.tb_usersgroups' table.
 *
 * 
 *
...
abstract class BaseHdeskUserGroupPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of HdeskUserGroup objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array HdeskUserGroup[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. HdeskUserGroupPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      HdeskUserGroup $value A HdeskUserGroup object.
	 ...
	 *
	 * @param      mixed $value A HdeskUserGroup object or a primary key value.
	 */
	 ...
	 * @return     HdeskUserGroup Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of HdeskUserGroup objects pre-filled with their HdeskGroup objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of HdeskUserGroup objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinHdeskGroup(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (HdeskUserGroup) to $obj2 (HdeskGroup)
	...
	/**
	 * Selects a collection of HdeskUserGroup objects pre-filled with their Usuario objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of HdeskUserGroup objects.
	...
	public static function doSelectJoinUsuario(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (HdeskUserGroup) to $obj2 (Usuario)
				$obj2->addHdeskUserGroup($obj1);
	...
	/**
	 * Selects a collection of HdeskUserGroup objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (HdeskUserGroup) to the collection in $obj2 (HdeskGroup)
				$obj2->addHdeskUserGroup($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (HdeskUserGroup) to the collection in $obj3 (Usuario)
	...
	/**
	 * Selects a collection of HdeskUserGroup objects pre-filled with all related objects except HdeskGroup.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptHdeskGroup(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = HdeskUserGroupPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (HdeskUserGroup) to the collection in $obj2 (Usuario)
				$obj2->addHdeskUserGroup($obj1);
	...
	/**
	 * Selects a collection of HdeskUserGroup objects pre-filled with all related objects except Usuario.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a HdeskUserGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or HdeskUserGroup object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from HdeskUserGroup object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a HdeskUserGroup or Criteria object.
	 *
	 * @param      mixed $values Criteria or HdeskUserGroup object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is HdeskUserGroup object
	...
	/**
	 * Method to DELETE all rows from the helpdesk.tb_usersgroups table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a HdeskUserGroup or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or HdeskUserGroup object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given HdeskUserGroup object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      HdeskUserGroup $obj The object to validate.
...
} // BaseHdeskUserGroupPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the HdeskUserGroupPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the HdeskUserGroupPeer class:
//
// Propel::getDatabaseMap(HdeskUserGroupPeer::DATABASE_NAME)->addTableBuilder(HdeskUserGroupPeer::TABLE_NAME, HdeskUserGroupPeer::getMapBuilder());
//
