...
/**
 * Base class that represents a row from the 'helpdesk.tb_projects' table.
 *
 * 
 *
...
abstract class BaseHdeskProject extends BaseObject  implements Persistent {
  ...
  const PEER = 'HdeskProjectPeer';
	...
	/**
	 * The value for the ca_description field.
	 * @var        string
	 */
	protected $ca_description;

	/**
	 * The value for the ca_active field.
	 * @var        string
	 */
	protected $ca_active;
	...
	/**
	 * Initializes internal state of BaseHdeskProject object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [ca_description] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [ca_active] column value.
	 * 
	 * @return     string
	 */
	 ...
	 * @return     HdeskProject The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [ca_description] column.
	 * 
	 * @param      string $v new value
	 * @return     HdeskProject The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [ca_active] column.
	 * 
	 * @param      string $v new value
	 * @return     HdeskProject The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = HdeskProjectPeer::NUM_COLUMNS - HdeskProjectPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setCaIdproject($pk);  //[IMV] update autoincrement primary key
	...
	/**
	 * Generic method to set the primary key (ca_idproject column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of HdeskProject (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaIdproject(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     HdeskProject Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getHdeskGroup(PropelPDO $con = null)
	{
		if ($this->aHdeskGroup === null && ($this->ca_idgroup !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aHdeskGroup->addHdeskProjects($this);
			 */
		}
	 ...
	 * Otherwise if this HdeskProject has previously been saved, it will retrieve
	 * related HdeskTickets from storage. If this HdeskProject is new, it will return
	 ...
	 * Otherwise if this HdeskProject is new, it will return
	 * an empty collection; or if this HdeskProject has previously
	 * been saved, it will retrieve related HdeskTickets from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in HdeskProject.
	 */
