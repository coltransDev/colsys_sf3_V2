...
/**
 * Base class that represents a row from the 'helpdesk.tb_usersgroups' table.
 *
 * 
 *
...
abstract class BaseHdeskUserGroup extends BaseObject  implements Persistent {
  ...
  const PEER = 'HdeskUserGroupPeer';
	...
	/**
	 * Initializes internal state of BaseHdeskUserGroup object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     HdeskUserGroup The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = HdeskUserGroupPeer::NUM_COLUMNS - HdeskUserGroupPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of HdeskUserGroup (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     HdeskUserGroup Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getHdeskGroup(PropelPDO $con = null)
	{
		if ($this->aHdeskGroup === null && ($this->ca_idgroup !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aHdeskGroup->addHdeskUserGroups($this);
			 */
		}
	...
	public function getUsuario(PropelPDO $con = null)
	{
		if ($this->aUsuario === null && (($this->ca_login !== "" && $this->ca_login !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsuario->addHdeskUserGroups($this);
			 */
		}
