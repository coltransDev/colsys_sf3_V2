...
abstract class BaseEmailAttachmentPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of EmailAttachment objects.
	 ...
	 *
	 * @param      EmailAttachment $value A EmailAttachment object.
...
//
// NOTE: This static code cannot call methods on the EmailAttachmentPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the EmailAttachmentPeer class:
//
// Propel::getDatabaseMap(EmailAttachmentPeer::DATABASE_NAME)->addTableBuilder(EmailAttachmentPeer::TABLE_NAME, EmailAttachmentPeer::getMapBuilder());
//
