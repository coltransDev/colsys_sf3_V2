...
/**
 * Base static class for performing query and update operations on the 'tb_attachments' table.
 *
 * 
 *
...
abstract class BaseEmailAttachmentPeer {
	...
	/** the column name for the CA_IDATTACHMENT field */
	...
	/** the column name for the CA_EXTENSION field */
	const CA_EXTENSION = 'tb_attachments.CA_EXTENSION';

	/** the column name for the CA_HEADER_FILE field */
	const CA_HEADER_FILE = 'tb_attachments.CA_HEADER_FILE';

	/** the column name for the CA_FILESIZE field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (EmailAttachmentPeer::CA_IDATTACHMENT, EmailAttachmentPeer::CA_IDEMAIL, EmailAttachmentPeer::CA_EXTENSION, EmailAttachmentPeer::CA_HEADER_FILE, EmailAttachmentPeer::CA_FILESIZE, EmailAttachmentPeer::CA_CONTENT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (EmailAttachmentPeer::CA_IDATTACHMENT => 0, EmailAttachmentPeer::CA_IDEMAIL => 1, EmailAttachmentPeer::CA_EXTENSION => 2, EmailAttachmentPeer::CA_HEADER_FILE => 3, EmailAttachmentPeer::CA_FILESIZE => 4, EmailAttachmentPeer::CA_CONTENT => 5, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.public.map.EmailAttachmentMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = EmailAttachmentPeer::getTableMap();
	...
	const COUNT = 'COUNT(tb_attachments.CA_IDATTACHMENT)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_attachments.CA_IDATTACHMENT)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(EmailAttachmentPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(EmailAttachmentPeer::COUNT);
		}
		...
		$rs = EmailAttachmentPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return EmailAttachmentPeer::populateObjects(EmailAttachmentPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinEmail(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(EmailAttachmentPeer::CA_IDEMAIL, EmailPeer::CA_IDEMAIL);
	...
	public static function doSelectJoinEmail(Criteria $c, $con = null)
	{
		...
		$startcol = (EmailAttachmentPeer::NUM_COLUMNS - EmailAttachmentPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		EmailPeer::addSelectColumns($c);

		$c->addJoin(EmailAttachmentPeer::CA_IDEMAIL, EmailPeer::CA_IDEMAIL);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addEmailAttachment($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initEmailAttachments();
				$obj2->addEmailAttachment($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		EmailAttachmentPeer::addSelectColumns($c);
		$startcol2 = (EmailAttachmentPeer::NUM_COLUMNS - EmailAttachmentPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a EmailAttachment or Criteria object.
	 *
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(EmailAttachmentPeer::CA_IDATTACHMENT); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method perform an UPDATE on the database, given a EmailAttachment or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the tb_attachments table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a EmailAttachment or Criteria object OR a primary key value.
	 *
...
if (Propel::isInit()) {
	...
	try {
		BaseEmailAttachmentPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.public.map.EmailAttachmentMapBuilder');
}
