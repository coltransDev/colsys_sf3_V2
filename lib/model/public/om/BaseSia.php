...
abstract class BaseSia extends BaseObject  implements Persistent {
  ...
  const PEER = 'SiaPeer';
	...
	/**
	 * Initializes internal state of BaseSia object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Sia The current object (for fluent API support)
	 */
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaIdsia(NULL); // this is a auto-increment column, so set to default value
