...
/**
 * Base static class for performing query and update operations on the 'tb_transporlineas' table.
 *
 * 
 *
...
abstract class BaseTransportadorPeer {
	...
	/** the column name for the CA_IDTRANSPORTISTA field */
	...
	/** the column name for the CA_SIGLA field */
	...
	/**
	 * An identiy map to hold any loaded instances of Transportador objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array Transportador[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. TransportadorPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Transportador $value A Transportador object.
	 ...
	 *
	 * @param      mixed $value A Transportador object or a primary key value.
	 */
	 ...
	 * @return     Transportador Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Transportista table
	 *
	 * @param      Criteria $c
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	...
	/**
	 * Selects a collection of Transportador objects pre-filled with their Transportista objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Transportador objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinTransportista(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Transportador) to $obj2 (Transportista)
	...
	/**
	 * Selects a collection of Transportador objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined Transportista rows
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Transportador) to the collection in $obj2 (Transportista)
				$obj2->addTransportador($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Transportador or Criteria object.
	 *
	 * @param      mixed $values Criteria or Transportador object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Transportador object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Transportador or Criteria object.
	 *
	 * @param      mixed $values Criteria or Transportador object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is Transportador object
	...
	/**
	 * Method to DELETE all rows from the tb_transporlineas table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Transportador or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Transportador object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Transportador object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Transportador $obj The object to validate.
...
} // BaseTransportadorPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the TransportadorPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the TransportadorPeer class:
//
// Propel::getDatabaseMap(TransportadorPeer::DATABASE_NAME)->addTableBuilder(TransportadorPeer::TABLE_NAME, TransportadorPeer::getMapBuilder());
//
