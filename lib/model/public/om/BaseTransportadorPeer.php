...
abstract class BaseTransportadorPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (TransportadorPeer::CA_IDLINEA, TransportadorPeer::CA_IDTRANSPORTISTA, TransportadorPeer::CA_NOMBRE, TransportadorPeer::CA_SIGLA, TransportadorPeer::CA_TRANSPORTE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (TransportadorPeer::CA_IDLINEA => 0, TransportadorPeer::CA_IDTRANSPORTISTA => 1, TransportadorPeer::CA_NOMBRE => 2, TransportadorPeer::CA_SIGLA => 3, TransportadorPeer::CA_TRANSPORTE => 4, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.public.map.TransportadorMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = TransportadorPeer::getTableMap();
	...
	const COUNT = 'COUNT(tb_transporlineas.CA_IDLINEA)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_transporlineas.CA_IDLINEA)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(TransportadorPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(TransportadorPeer::COUNT);
		}
		...
		$rs = TransportadorPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return TransportadorPeer::populateObjects(TransportadorPeer::doSelectRS($criteria, $con));
	}
	/**
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(TransportadorPeer::CA_IDLINEA); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	try {
		BaseTransportadorPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.public.map.TransportadorMapBuilder');
}
