...
//
// NOTE: This static code cannot call methods on the MonedaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the MonedaPeer class:
//
// Propel::getDatabaseMap(MonedaPeer::DATABASE_NAME)->addTableBuilder(MonedaPeer::TABLE_NAME, MonedaPeer::getMapBuilder());
//
