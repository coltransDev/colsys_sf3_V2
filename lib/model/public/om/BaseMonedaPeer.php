...
/**
 * Base static class for performing query and update operations on the 'tb_monedas' table.
 *
 * 
 *
...
abstract class BaseMonedaPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (MonedaPeer::CA_IDMONEDA, MonedaPeer::CA_NOMBRE, MonedaPeer::CA_REFERENCIA, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (MonedaPeer::CA_IDMONEDA => 0, MonedaPeer::CA_NOMBRE => 1, MonedaPeer::CA_REFERENCIA => 2, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.public.map.MonedaMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(tb_monedas.CA_IDMONEDA)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_monedas.CA_IDMONEDA)';
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the tb_monedas table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('lib.model.public.map.MonedaMapBuilder');
}
