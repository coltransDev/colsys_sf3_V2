...
/**
 * Base static class for performing query and update operations on the 'tb_transportistas' table.
 *
 * 
 *
...
abstract class BaseTransportistaPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Transportista objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array Transportista[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. TransportistaPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Transportista $value A Transportista object.
	 ...
	 *
	 * @param      mixed $value A Transportista object or a primary key value.
	 */
	 ...
	 * @return     Transportista Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Transportista or Criteria object.
	 *
	 * @param      mixed $values Criteria or Transportista object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Transportista object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Transportista or Criteria object.
	 *
	 * @param      mixed $values Criteria or Transportista object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is Transportista object
	...
	/**
	 * Method to DELETE all rows from the tb_transportistas table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Transportista or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Transportista object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Transportista object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Transportista $obj The object to validate.
...
} // BaseTransportistaPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the TransportistaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the TransportistaPeer class:
//
// Propel::getDatabaseMap(TransportistaPeer::DATABASE_NAME)->addTableBuilder(TransportistaPeer::TABLE_NAME, TransportistaPeer::getMapBuilder());
//
