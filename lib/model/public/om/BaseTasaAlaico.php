...
abstract class BaseTasaAlaico extends BaseObject  implements Persistent {
  ...
  const PEER = 'TasaAlaicoPeer';
	...
	/**
	 * Initializes internal state of BaseTasaAlaico object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [ca_fechainicial] column value.
	 * 
	 *
	...
	/**
	 * Get the [optionally formatted] temporal [ca_fechafinal] column value.
	 * 
	 *
	 * @param      string $format The date/time format string (either date()-style or strftime()-style).
	 *							If format is NULL, then the raw DateTime object will be returned.
	...
	/**
	 * Sets the value of [ca_fechainicial] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     TasaAlaico The current object (for fluent API support)
	 */
	...
	/**
	 * Sets the value of [ca_fechafinal] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     TasaAlaico The current object (for fluent API support)
