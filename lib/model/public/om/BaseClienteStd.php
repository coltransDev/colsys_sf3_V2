...
abstract class BaseClienteStd extends BaseObject  implements Persistent {
  ...
  const PEER = 'ClienteStdPeer';
	...
	/**
	 * Initializes internal state of BaseClienteStd object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [ca_fchestado] column value.
	 * 
	 *
	 ...
	 * @return     ClienteStd The current object (for fluent API support)
	 */
	...
	/**
	 * Sets the value of [ca_fchestado] column to a normalized version of the date/time value specified.
	 * 
	...
	public function getCliente(PropelPDO $con = null)
	{
		if ($this->aCliente === null && ($this->ca_idcliente !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCliente->addClienteStds($this);
			 */
		}
