...
/**
 * Base class that represents a row from the 'tb_festivos' table.
 *
 * 
 *
...
abstract class BaseFestivo extends BaseObject  implements Persistent {
  ...
  const PEER = 'FestivoPeer';
	...
	/**
	 * The value for the ca_fchfestivo field.
	 * @var        string
	 */
	...
	/**
	 * Initializes internal state of BaseFestivo object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [ca_fchfestivo] column value.
	 * 
	 *
	...
	/**
	 * Sets the value of [ca_fchfestivo] column to a normalized version of the date/time value specified.
	 * 
	 * @param      mixed $v string, integer (timestamp), or DateTime value.  Empty string will
	 *						be treated as NULL for temporal objects.
	 * @return     Festivo The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 1; // 1 = FestivoPeer::NUM_COLUMNS - FestivoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	/**
	 * Generic method to set the primary key (ca_fchfestivo column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Festivo (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Festivo Clone of current object.
	 * @throws     PropelException
	 */
