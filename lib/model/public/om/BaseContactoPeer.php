...
abstract class BaseContactoPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Contacto objects.
	 ...
	 *
	 * @param      Contacto $value A Contacto object.
	 ...
	 *
	 * @param      mixed $value A Contacto object or a primary key value.
	 */
	 ...
	 * @return     Contacto Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinCliente(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Contacto) to $obj2 (Cliente)
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Contacto) to the collection in $obj2 (Cliente)
				$obj2->addContacto($obj1);
...
//
// NOTE: This static code cannot call methods on the ContactoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ContactoPeer class:
//
// Propel::getDatabaseMap(ContactoPeer::DATABASE_NAME)->addTableBuilder(ContactoPeer::TABLE_NAME, ContactoPeer::getMapBuilder());
//
