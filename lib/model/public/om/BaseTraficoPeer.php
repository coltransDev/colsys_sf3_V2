...
abstract class BaseTraficoPeer {
	...
	{
		return BasePeer::getMapBuilder('lib.model.public.map.TraficoMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(tb_traficos.CA_IDTRAFICO)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_traficos.CA_IDTRAFICO)';
	...
	{
		return TraficoPeer::populateObjects(TraficoPeer::doSelectRS($criteria, $con));
	}
	/**
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(TraficoPeer::CA_IDTRAFICO); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('lib.model.public.map.TraficoMapBuilder');
}
