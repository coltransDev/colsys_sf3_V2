...
/**
 * Base static class for performing query and update operations on the 'tb_traficos' table.
 *
 * 
 *
...
abstract class BaseTraficoPeer {
	...
	/** the column name for the CA_LINK field */
	...
	/**
	 * An identiy map to hold any loaded instances of Trafico objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. TraficoPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      Trafico $value A Trafico object.
	 ...
	 *
	 * @param      mixed $value A Trafico object or a primary key value.
	 */
	 ...
	 * @return     Trafico Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinTraficoGrupo(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Trafico) to $obj2 (TraficoGrupo)
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Trafico) to the collection in $obj2 (TraficoGrupo)
				$obj2->addTrafico($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Trafico or Criteria object.
	 *
	 * @param      mixed $values Criteria or Trafico object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Trafico object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Trafico or Criteria object.
	 *
	 * @param      mixed $values Criteria or Trafico object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the tb_traficos table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Trafico or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Trafico object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Trafico object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Trafico $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the TraficoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the TraficoPeer class:
//
// Propel::getDatabaseMap(TraficoPeer::DATABASE_NAME)->addTableBuilder(TraficoPeer::TABLE_NAME, TraficoPeer::getMapBuilder());
//
