...
abstract class BaseTraficoGrupo extends BaseObject  implements Persistent {
  ...
  const PEER = 'TraficoGrupoPeer';
	...
	/**
	 * @var        array PricSeguro[] Collection to store aggregation of PricSeguro objects.
	 */
	protected $collPricSeguros;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPricSeguros.
	 */
	private $lastPricSeguroCriteria = null;

	/**
	 * @var        array Trafico[] Collection to store aggregation of Trafico objects.
	 */
	protected $collTraficos;

	/**
	 * @var        Criteria The criteria used to select the current contents of collTraficos.
	 */
	...
	/**
	 * Initializes internal state of BaseTraficoGrupo object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     TraficoGrupo The current object (for fluent API support)
	 */
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaIdgrupo(NULL); // this is a auto-increment column, so set to default value
	...
	/**
	 * Clears out the collPricSeguros collection (array).
	 *
	...
	{
		$this->collPricSeguros = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collPricSeguros collection (array).
	 *
	 * By default this just sets the collPricSeguros collection to an empty array (like clearcollPricSeguros());
	...
	/**
	 * Gets an array of PricSeguro objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this TraficoGrupo has previously been saved, it will retrieve
	 * related PricSeguros from storage. If this TraficoGrupo is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array PricSeguro[]
	 * @throws     PropelException
	 */
	...
	/**
	 * Returns the number of related PricSeguro objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related PricSeguro objects.
	 * @throws     PropelException
	 */
	...
	public function addPricSeguro(PricSeguro $l)
	{
		...
		if (!in_array($l, $this->collPricSeguros, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPricSeguros, $l);
			$l->setTraficoGrupo($this);
		}
	}

	/**
	 * Clears out the collTraficos collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	{
		$this->collTraficos = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collTraficos collection (array).
	 *
	 * By default this just sets the collTraficos collection to an empty array (like clearcollTraficos());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	...
	/**
	 * Gets an array of Trafico objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this TraficoGrupo has previously been saved, it will retrieve
	 * related Traficos from storage. If this TraficoGrupo is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array Trafico[]
	 * @throws     PropelException
	 */
	...
	/**
	 * Returns the number of related Trafico objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Trafico objects.
	 * @throws     PropelException
	 */
	...
	public function addTrafico(Trafico $l)
	{
		...
		if (!in_array($l, $this->collTraficos, true)) { // only add it if the **same** object is not already associated
			array_push($this->collTraficos, $l);
			$l->setTraficoGrupo($this);
		}
	}
