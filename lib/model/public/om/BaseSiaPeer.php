...
abstract class BaseSiaPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (SiaPeer::CA_IDSIA, SiaPeer::CA_NOMBRE, SiaPeer::CA_TEL, SiaPeer::CA_CONTACTO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (SiaPeer::CA_IDSIA => 0, SiaPeer::CA_NOMBRE => 1, SiaPeer::CA_TEL => 2, SiaPeer::CA_CONTACTO => 3, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.public.map.SiaMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(tb_sia.CA_IDSIA)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_sia.CA_IDSIA)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(SiaPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(SiaPeer::COUNT);
		}
		...
		$rs = SiaPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return SiaPeer::populateObjects(SiaPeer::doSelectRS($criteria, $con));
	}
	/**
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(SiaPeer::CA_IDSIA); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('lib.model.public.map.SiaMapBuilder');
}
