...
/**
 * Base static class for performing query and update operations on the 'tb_sia' table.
 *
 * 
 *
...
abstract class BaseSiaPeer {
	...
	/** the column name for the CA_TEL field */
	...
	/**
	 * An identiy map to hold any loaded instances of Sia objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. SiaPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      mixed $value A Sia object or a primary key value.
	 */
	 ...
	 * @return     Sia Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Sia or Criteria object.
	 *
	 * @param      mixed $values Criteria or Sia object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Sia object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Sia or Criteria object.
	 *
	 * @param      mixed $values Criteria or Sia object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the tb_sia table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Sia or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Sia object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Sia object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Sia $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the SiaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SiaPeer class:
//
// Propel::getDatabaseMap(SiaPeer::DATABASE_NAME)->addTableBuilder(SiaPeer::TABLE_NAME, SiaPeer::getMapBuilder());
//
