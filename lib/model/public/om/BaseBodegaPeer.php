...
abstract class BaseBodegaPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Bodega objects.
	 ...
	 *
	 * @param      Bodega $value A Bodega object.
	 ...
	 *
	 * @param      mixed $value A Bodega object or a primary key value.
	 */
	 ...
	 * @return     Bodega Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
...
//
// NOTE: This static code cannot call methods on the BodegaPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the BodegaPeer class:
//
// Propel::getDatabaseMap(BodegaPeer::DATABASE_NAME)->addTableBuilder(BodegaPeer::TABLE_NAME, BodegaPeer::getMapBuilder());
//
