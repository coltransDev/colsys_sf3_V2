...
abstract class BaseCostoPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of Costo objects.
	 ...
	 *
	 * @param      Costo $value A Costo object.
	 ...
	 *
	 * @param      mixed $value A Costo object or a primary key value.
	 */
	 ...
	 * @return     Costo Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
...
//
// NOTE: This static code cannot call methods on the CostoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CostoPeer class:
//
// Propel::getDatabaseMap(CostoPeer::DATABASE_NAME)->addTableBuilder(CostoPeer::TABLE_NAME, CostoPeer::getMapBuilder());
//
