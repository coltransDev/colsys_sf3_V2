...
/**
 * Base static class for performing query and update operations on the 'tb_costos' table.
 *
 * 
 *
...
abstract class BaseCostoPeer {
	...
	/** the column name for the CA_COSTO field */
	...
	/** the column name for the CA_COMISIONABLE field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (CostoPeer::CA_IDCOSTO, CostoPeer::CA_COSTO, CostoPeer::CA_TRANSPORTE, CostoPeer::CA_IMPOEXPO, CostoPeer::CA_MODALIDAD, CostoPeer::CA_COMISIONABLE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (CostoPeer::CA_IDCOSTO => 0, CostoPeer::CA_COSTO => 1, CostoPeer::CA_TRANSPORTE => 2, CostoPeer::CA_IMPOEXPO => 3, CostoPeer::CA_MODALIDAD => 4, CostoPeer::CA_COMISIONABLE => 5, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.public.map.CostoMapBuilder');
	}
	/**
	 ...
	 * @param      string $column The column name for current table. (i.e. CostoPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	const COUNT = 'COUNT(tb_costos.CA_IDCOSTO)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_costos.CA_IDCOSTO)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(CostoPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(CostoPeer::COUNT);
		}
		...
		$rs = CostoPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return CostoPeer::populateObjects(CostoPeer::doSelectRS($criteria, $con));
	}
	/**
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a Costo or Criteria object.
	 *
	 * @param      mixed $values Criteria or Costo object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
	...
	/**
	 * Method perform an UPDATE on the database, given a Costo or Criteria object.
	 *
	 * @param      mixed $values Criteria or Costo object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the tb_costos table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Costo or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Costo object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Costo object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Costo $obj The object to validate.
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('lib.model.public.map.CostoMapBuilder');
}
