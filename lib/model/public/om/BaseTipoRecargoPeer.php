...
abstract class BaseTipoRecargoPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (TipoRecargoPeer::CA_IDRECARGO, TipoRecargoPeer::CA_RECARGO, TipoRecargoPeer::CA_TIPO, TipoRecargoPeer::CA_TRANSPORTE, TipoRecargoPeer::CA_INCOTERMS, TipoRecargoPeer::CA_REPORTE, TipoRecargoPeer::CA_IMPOEXPO, TipoRecargoPeer::CA_APLICACION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (TipoRecargoPeer::CA_IDRECARGO => 0, TipoRecargoPeer::CA_RECARGO => 1, TipoRecargoPeer::CA_TIPO => 2, TipoRecargoPeer::CA_TRANSPORTE => 3, TipoRecargoPeer::CA_INCOTERMS => 4, TipoRecargoPeer::CA_REPORTE => 5, TipoRecargoPeer::CA_IMPOEXPO => 6, TipoRecargoPeer::CA_APLICACION => 7, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.public.map.TipoRecargoMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = TipoRecargoPeer::getTableMap();
	...
	const COUNT = 'COUNT(tb_tiporecargo.CA_IDRECARGO)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_tiporecargo.CA_IDRECARGO)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(TipoRecargoPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(TipoRecargoPeer::COUNT);
		}
		...
		$rs = TipoRecargoPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return TipoRecargoPeer::populateObjects(TipoRecargoPeer::doSelectRS($criteria, $con));
	}
	/**
...
if (Propel::isInit()) {
	...
	try {
		BaseTipoRecargoPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.public.map.TipoRecargoMapBuilder');
}
