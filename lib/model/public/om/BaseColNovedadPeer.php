...
/**
 * Base static class for performing query and update operations on the 'tb_colnovedades' table.
 *
 * 
 *
...
abstract class BaseColNovedadPeer {
	...
	/** the column name for the CA_IDNOVEDAD field */
	const CA_IDNOVEDAD = 'tb_colnovedades.CA_IDNOVEDAD';

	/** the column name for the CA_FCHPUBLICACION field */
	...
	/** the column name for the CA_FCHARCHIVAR field */
	...
	/** the column name for the CA_FCHPUBLICADO field */
	const CA_FCHPUBLICADO = 'tb_colnovedades.CA_FCHPUBLICADO';

	/** the column name for the CA_USUPUBLICADO field */
	const CA_USUPUBLICADO = 'tb_colnovedades.CA_USUPUBLICADO';

	/**
	 * An identiy map to hold any loaded instances of ColNovedad objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array ColNovedad[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. ColNovedadPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      ColNovedad $value A ColNovedad object.
	 ...
	 *
	 * @param      mixed $value A ColNovedad object or a primary key value.
	 */
	 ...
	 * @return     ColNovedad Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a ColNovedad or Criteria object.
	 *
	 * @param      mixed $values Criteria or ColNovedad object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from ColNovedad object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ColNovedad or Criteria object.
	 *
	 * @param      mixed $values Criteria or ColNovedad object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is ColNovedad object
	...
	/**
	 * Method to DELETE all rows from the tb_colnovedades table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ColNovedad or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ColNovedad object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given ColNovedad object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ColNovedad $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the ColNovedadPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ColNovedadPeer class:
//
// Propel::getDatabaseMap(ColNovedadPeer::DATABASE_NAME)->addTableBuilder(ColNovedadPeer::TABLE_NAME, ColNovedadPeer::getMapBuilder());
//
