...
class BodegaMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tb_bodegas');
		$tMap->setPhpName('Bodega');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tb_bodegas_SEQ');

		$tMap->addPrimaryKey('CA_IDBODEGA', 'CaIdbodega', 'int', CreoleTypes::INTEGER, true, null);
