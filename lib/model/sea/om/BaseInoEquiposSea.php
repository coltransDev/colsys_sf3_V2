...
/**
 * Base class that represents a row from the 'tb_inoequipos_sea' table.
 *
 * 
 *
...
abstract class BaseInoEquiposSea extends BaseObject  implements Persistent {
  ...
  const PEER = 'InoEquiposSeaPeer';
	...
	/**
	 * Initializes internal state of BaseInoEquiposSea object.
	 * @see        applyDefaults()
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = InoEquiposSeaPeer::NUM_COLUMNS - InoEquiposSeaPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of InoEquiposSea (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     InoEquiposSea Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getInoMaestraSea(PropelPDO $con = null)
	{
		if ($this->aInoMaestraSea === null && (($this->ca_referencia !== "" && $this->ca_referencia !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aInoMaestraSea->addInoEquiposSeas($this);
			 */
		}
	...
	public function getConcepto(PropelPDO $con = null)
	{
		if ($this->aConcepto === null && ($this->ca_idconcepto !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aConcepto->addInoEquiposSeas($this);
			 */
		}
