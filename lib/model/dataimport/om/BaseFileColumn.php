...
abstract class BaseFileColumn extends BaseObject  implements Persistent {
  ...
  const PEER = 'FileColumnPeer';
	...
	/**
	 * Initializes internal state of BaseFileColumn object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     FileColumn The current object (for fluent API support)
	 */
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaIdcolumna(NULL); // this is a auto-increment column, so set to default value
	...
	public function getFileHeader(PropelPDO $con = null)
	{
		if ($this->aFileHeader === null && ($this->ca_idfileheader !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aFileHeader->addFileColumns($this);
			 */
		}
