...
abstract class BaseFileImported extends BaseObject  implements Persistent {
  ...
  const PEER = 'FileImportedPeer';
	...
	/**
	 * Initializes internal state of BaseFileImported object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [ca_fchimportacion] column value.
	 * 
	 *
	 ...
	 * @return     FileImported The current object (for fluent API support)
	 */
	...
	/**
	 * Sets the value of [ca_fchimportacion] column to a normalized version of the date/time value specified.
	 * 
	...
	public function setFileHeader(FileHeader $v = null)
	{
		...
		// If this object has already been added to the FileHeader object, it will not be re-added.
		if ($v !== null) {
	...
	public function getFileHeader(PropelPDO $con = null)
	{
		if ($this->aFileHeader === null && ($this->ca_idfileheader !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aFileHeader->addFileImporteds($this);
			 */
		}
