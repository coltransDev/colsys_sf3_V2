...
/**
 * Base static class for performing query and update operations on the 'tb_filecolumns' table.
 *
 * 
 *
...
abstract class BaseFileColumnPeer {
	 ...
	 * @param      string $column The column name for current table. (i.e. FileColumnPeer::COLUMN_NAME).
	 * @return     string
	 */
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is FileColumn object
	...
	/**
	 * Method to DELETE all rows from the tb_filecolumns table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a FileColumn or Criteria object OR a primary key value.
	 *
	...
	/**
	 * Validates all modified columns of given FileColumn object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      FileColumn $obj The object to validate.
