...
/**
 * Base static class for performing query and update operations on the 'tb_fileheader' table.
 *
 * 
 *
...
abstract class BaseFileHeaderPeer {
	...
	/** the column name for the CA_TIPOARCHIVO field */
	const CA_TIPOARCHIVO = 'tb_fileheader.CA_TIPOARCHIVO';

	/** the column name for the CA_SEPARADOR field */
	const CA_SEPARADOR = 'tb_fileheader.CA_SEPARADOR';

	/** the column name for the CA_SEPARADORDEC field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (FileHeaderPeer::CA_IDFILEHEADER, FileHeaderPeer::CA_DESCRIPCION, FileHeaderPeer::CA_TIPOARCHIVO, FileHeaderPeer::CA_SEPARADOR, FileHeaderPeer::CA_SEPARADORDEC, FileHeaderPeer::CA_FCHCREADO, FileHeaderPeer::CA_USUCREADO, FileHeaderPeer::CA_FCHACTUALIZADO, FileHeaderPeer::CA_USUACTUALIZADO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (FileHeaderPeer::CA_IDFILEHEADER => 0, FileHeaderPeer::CA_DESCRIPCION => 1, FileHeaderPeer::CA_TIPOARCHIVO => 2, FileHeaderPeer::CA_SEPARADOR => 3, FileHeaderPeer::CA_SEPARADORDEC => 4, FileHeaderPeer::CA_FCHCREADO => 5, FileHeaderPeer::CA_USUCREADO => 6, FileHeaderPeer::CA_FCHACTUALIZADO => 7, FileHeaderPeer::CA_USUACTUALIZADO => 8, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.dataimport.map.FileHeaderMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = FileHeaderPeer::getTableMap();
	 ...
	 * @param      string $column The column name for current table. (i.e. FileHeaderPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	const COUNT = 'COUNT(tb_fileheader.CA_IDFILEHEADER)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_fileheader.CA_IDFILEHEADER)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(FileHeaderPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(FileHeaderPeer::COUNT);
		}
		...
		$rs = FileHeaderPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return FileHeaderPeer::populateObjects(FileHeaderPeer::doSelectRS($criteria, $con));
	}
	/**
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a FileHeader or Criteria object.
	 *
	 * @param      mixed $values Criteria or FileHeader object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from FileHeader object
		}

		$criteria->remove(FileHeaderPeer::CA_IDFILEHEADER); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method perform an UPDATE on the database, given a FileHeader or Criteria object.
	 *
	 * @param      mixed $values Criteria or FileHeader object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, $con = null)
	{
		...
		} else { // $values is FileHeader object
	...
	/**
	 * Method to DELETE all rows from the tb_fileheader table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a FileHeader or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or FileHeader object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given FileHeader object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      FileHeader $obj The object to validate.
...
if (Propel::isInit()) {
	...
	try {
		BaseFileHeaderPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.dataimport.map.FileHeaderMapBuilder');
}
