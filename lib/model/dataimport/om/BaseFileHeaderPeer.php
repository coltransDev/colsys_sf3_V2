...
abstract class BaseFileHeaderPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of FileHeader objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array FileHeader[]
	 */
	 ...
	 *
	 * @param      FileHeader $value A FileHeader object.
	 ...
	 *
	 * @param      mixed $value A FileHeader object or a primary key value.
	 */
	 ...
	 * @return     FileHeader Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
...
//
// NOTE: This static code cannot call methods on the FileHeaderPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the FileHeaderPeer class:
//
// Propel::getDatabaseMap(FileHeaderPeer::DATABASE_NAME)->addTableBuilder(FileHeaderPeer::TABLE_NAME, FileHeaderPeer::getMapBuilder());
//
