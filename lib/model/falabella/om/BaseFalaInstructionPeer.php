...
/**
 * Base static class for performing query and update operations on the 'tb_falainstructions' table.
 *
 * 
 *
...
abstract class BaseFalaInstructionPeer {
	...
	/** the column name for the CA_INSTRUCTIONS field */
	const CA_INSTRUCTIONS = 'tb_falainstructions.CA_INSTRUCTIONS';

	/** the column name for the CA_IDFALAINSTRUCTIONS field */
	const CA_IDFALAINSTRUCTIONS = 'tb_falainstructions.CA_IDFALAINSTRUCTIONS';

	/**
	 * An identiy map to hold any loaded instances of FalaInstruction objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array FalaInstruction[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. FalaInstructionPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      FalaInstruction $value A FalaInstruction object.
	 ...
	 *
	 * @param      mixed $value A FalaInstruction object or a primary key value.
	 */
	 ...
	 * @return     FalaInstruction Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of FalaInstruction objects pre-filled with their FalaHeader objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of FalaInstruction objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinFalaHeader(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (FalaInstruction) to $obj2 (FalaHeader)
	...
	/**
	 * Selects a collection of FalaInstruction objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (FalaInstruction) to the collection in $obj2 (FalaHeader)
				$obj2->addFalaInstruction($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a FalaInstruction or Criteria object.
	 *
	 * @param      mixed $values Criteria or FalaInstruction object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from FalaInstruction object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a FalaInstruction or Criteria object.
	 *
	 * @param      mixed $values Criteria or FalaInstruction object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is FalaInstruction object
	...
	/**
	 * Method to DELETE all rows from the tb_falainstructions table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a FalaInstruction or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or FalaInstruction object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given FalaInstruction object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      FalaInstruction $obj The object to validate.
...
} // BaseFalaInstructionPeer

// This is the static code needed to register the MapBuilder for this table with the main Propel class.
//
// NOTE: This static code cannot call methods on the FalaInstructionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the FalaInstructionPeer class:
//
// Propel::getDatabaseMap(FalaInstructionPeer::DATABASE_NAME)->addTableBuilder(FalaInstructionPeer::TABLE_NAME, FalaInstructionPeer::getMapBuilder());
//
