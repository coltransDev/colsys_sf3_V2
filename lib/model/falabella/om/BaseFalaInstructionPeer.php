...
abstract class BaseFalaInstructionPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (FalaInstructionPeer::CA_IDDOC, FalaInstructionPeer::CA_INSTRUCTIONS, FalaInstructionPeer::CA_IDFALAINSTRUCTIONS, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (FalaInstructionPeer::CA_IDDOC => 0, FalaInstructionPeer::CA_INSTRUCTIONS => 1, FalaInstructionPeer::CA_IDFALAINSTRUCTIONS => 2, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.falabella.map.FalaInstructionMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = FalaInstructionPeer::getTableMap();
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(FalaInstructionPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(FalaInstructionPeer::COUNT);
		}
		...
		$rs = FalaInstructionPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return FalaInstructionPeer::populateObjects(FalaInstructionPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinFalaHeader(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(FalaInstructionPeer::CA_IDDOC, FalaHeaderPeer::CA_IDDOC);
	...
	public static function doSelectJoinFalaHeader(Criteria $c, $con = null)
	{
		...
		$startcol = (FalaInstructionPeer::NUM_COLUMNS - FalaInstructionPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		FalaHeaderPeer::addSelectColumns($c);

		$c->addJoin(FalaInstructionPeer::CA_IDDOC, FalaHeaderPeer::CA_IDDOC);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addFalaInstruction($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initFalaInstructions();
				$obj2->addFalaInstruction($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		FalaInstructionPeer::addSelectColumns($c);
		$startcol2 = (FalaInstructionPeer::NUM_COLUMNS - FalaInstructionPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
...
if (Propel::isInit()) {
	...
	try {
		BaseFalaInstructionPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.falabella.map.FalaInstructionMapBuilder');
}
