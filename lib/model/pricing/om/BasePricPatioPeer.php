...
/**
 * Base static class for performing query and update operations on the 'tb_pricpatios' table.
 *
 * 
 *
...
abstract class BasePricPatioPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of PricPatio objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. PricPatioPeer::COLUMN_NAME).
	 * @return     string
	 */
	 ...
	 *
	 * @param      PricPatio $value A PricPatio object.
	 ...
	 *
	 * @param      mixed $value A PricPatio object or a primary key value.
	 */
	 ...
	 * @return     PricPatio Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Selects a collection of PricPatio objects pre-filled with their Ciudad objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of PricPatio objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinCiudad(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PricPatio) to $obj2 (Ciudad)
	...
	/**
	 * Selects a collection of PricPatio objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PricPatio) to the collection in $obj2 (Ciudad)
				$obj2->addPricPatio($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a PricPatio or Criteria object.
	 *
	 * @param      mixed $values Criteria or PricPatio object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from PricPatio object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a PricPatio or Criteria object.
	 *
	 * @param      mixed $values Criteria or PricPatio object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		} else { // $values is PricPatio object
	...
	/**
	 * Method to DELETE all rows from the tb_pricpatios table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a PricPatio or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or PricPatio object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given PricPatio object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      PricPatio $obj The object to validate.
...
//
// NOTE: This static code cannot call methods on the PricPatioPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the PricPatioPeer class:
//
// Propel::getDatabaseMap(PricPatioPeer::DATABASE_NAME)->addTableBuilder(PricPatioPeer::TABLE_NAME, PricPatioPeer::getMapBuilder());
//
