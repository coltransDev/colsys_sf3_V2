...
abstract class BaseTrayectoPeer {
	...
	const CA_IDMONEDA = 'tb_trayectos.CA_IDMONEDA';

	/** the column name for the CA_FCHINICIO field */
	const CA_FCHINICIO = 'tb_trayectos.CA_FCHINICIO';

	/** the column name for the CA_FCHVENCIMIENTO field */
	const CA_FCHVENCIMIENTO = 'tb_trayectos.CA_FCHVENCIMIENTO';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TrayectoPeer::CA_IDMONEDA);

		$criteria->addSelectColumn(TrayectoPeer::CA_FCHINICIO);
