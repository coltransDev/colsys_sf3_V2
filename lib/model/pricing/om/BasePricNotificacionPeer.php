...
/**
 * Base static class for performing query and update operations on the 'tb_pricnotificaciones' table.
 *
 * 
 *
...
abstract class BasePricNotificacionPeer {
	...
	/** the column name for the CA_CADUCIDAD field */
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (PricNotificacionPeer::CA_IDNOTIFICACION, PricNotificacionPeer::CA_TITULO, PricNotificacionPeer::CA_MENSAJE, PricNotificacionPeer::CA_CADUCIDAD, PricNotificacionPeer::CA_FCHCREADO, PricNotificacionPeer::CA_USUCREADO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (PricNotificacionPeer::CA_IDNOTIFICACION => 0, PricNotificacionPeer::CA_TITULO => 1, PricNotificacionPeer::CA_MENSAJE => 2, PricNotificacionPeer::CA_CADUCIDAD => 3, PricNotificacionPeer::CA_FCHCREADO => 4, PricNotificacionPeer::CA_USUCREADO => 5, ),
	...
	{
		return BasePeer::getMapBuilder('lib.model.pricing.map.PricNotificacionMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = PricNotificacionPeer::getTableMap();
	 ...
	 * @param      string $column The column name for current table. (i.e. PricNotificacionPeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	const COUNT = 'COUNT(tb_pricnotificaciones.CA_IDNOTIFICACION)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT tb_pricnotificaciones.CA_IDNOTIFICACION)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(PricNotificacionPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(PricNotificacionPeer::COUNT);
		}
		...
		$rs = PricNotificacionPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return PricNotificacionPeer::populateObjects(PricNotificacionPeer::doSelectRS($criteria, $con));
	}
	/**
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method perform an INSERT on the database, given a PricNotificacion or Criteria object.
	 *
	 * @param      mixed $values Criteria or PricNotificacion object containing data that is used to create the INSERT statement.
	 * @param      Connection $con the connection to use
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from PricNotificacion object
		}

		$criteria->remove(PricNotificacionPeer::CA_IDNOTIFICACION); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method perform an UPDATE on the database, given a PricNotificacion or Criteria object.
	 *
	 * @param      mixed $values Criteria or PricNotificacion object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, $con = null)
	{
		...
		} else { // $values is PricNotificacion object
	...
	/**
	 * Method to DELETE all rows from the tb_pricnotificaciones table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a PricNotificacion or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or PricNotificacion object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given PricNotificacion object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      PricNotificacion $obj The object to validate.
...
if (Propel::isInit()) {
	...
	try {
		BasePricNotificacionPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	Propel::registerMapBuilder('lib.model.pricing.map.PricNotificacionMapBuilder');
}
