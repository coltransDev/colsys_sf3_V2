...
abstract class BasePricNotificacionPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of PricNotificacion objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array PricNotificacion[]
	 */
	 ...
	 *
	 * @param      PricNotificacion $value A PricNotificacion object.
	 ...
	 *
	 * @param      mixed $value A PricNotificacion object or a primary key value.
	 */
	 ...
	 * @return     PricNotificacion Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
...
//
// NOTE: This static code cannot call methods on the PricNotificacionPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the PricNotificacionPeer class:
//
// Propel::getDatabaseMap(PricNotificacionPeer::DATABASE_NAME)->addTableBuilder(PricNotificacionPeer::TABLE_NAME, PricNotificacionPeer::getMapBuilder());
//
