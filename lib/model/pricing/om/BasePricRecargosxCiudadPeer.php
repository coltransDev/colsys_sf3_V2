...
abstract class BasePricRecargosxCiudadPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of PricRecargosxCiudad objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array PricRecargosxCiudad[]
	 */
	 ...
	 *
	 * @param      PricRecargosxCiudad $value A PricRecargosxCiudad object.
	 ...
	 *
	 * @param      mixed $value A PricRecargosxCiudad object or a primary key value.
	 */
	 ...
	 * @return     PricRecargosxCiudad Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinCiudad(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PricRecargosxCiudad) to $obj2 (Ciudad)
	...
	public static function doSelectJoinTipoRecargo(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PricRecargosxCiudad) to $obj2 (TipoRecargo)
				$obj2->addPricRecargosxCiudad($obj1);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PricRecargosxCiudad) to the collection in $obj2 (Ciudad)
				$obj2->addPricRecargosxCiudad($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (PricRecargosxCiudad) to the collection in $obj3 (TipoRecargo)
	...
	public static function doSelectJoinAllExceptCiudad(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = PricRecargosxCiudadPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (PricRecargosxCiudad) to the collection in $obj2 (TipoRecargo)
				$obj2->addPricRecargosxCiudad($obj1);
...
//
// NOTE: This static code cannot call methods on the PricRecargosxCiudadPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the PricRecargosxCiudadPeer class:
//
// Propel::getDatabaseMap(PricRecargosxCiudadPeer::DATABASE_NAME)->addTableBuilder(PricRecargosxCiudadPeer::TABLE_NAME, PricRecargosxCiudadPeer::getMapBuilder());
//
