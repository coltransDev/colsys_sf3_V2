...
abstract class BasePricArchivo extends BaseObject  implements Persistent {
  ...
  const PEER = 'PricArchivoPeer';
	...
	/**
	 * Initializes internal state of BasePricArchivo object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PricArchivo The current object (for fluent API support)
	 */
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				...
				// Rewind the ca_datos LOB column, since PDO does not rewind after inserting value.
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PricArchivo (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaIdarchivo(NULL); // this is a auto-increment column, so set to default value
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PricArchivo Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getTrafico(PropelPDO $con = null)
	{
		if ($this->aTrafico === null && (($this->ca_idtrafico !== "" && $this->ca_idtrafico !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aTrafico->addPricArchivos($this);
			 */
		}
