...
/**
 * Base class that represents a row from the 'bs_pricrecargosxlinea' table.
 *
 * 
 *
 * @package    lib.model.pricing.om
 */
abstract class BasePricRecargosxLineaLog extends BaseObject  implements Persistent {


  const PEER = 'PricRecargosxLineaLogPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        PricRecargosxLineaLogPeer
	 */
	...
	/**
	 * Initializes internal state of BasePricRecargosxLineaLog object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PricRecargosxLineaLog The current object (for fluent API support)
	 */
	public function setCaIdtrafico($v)
	{
		...
		if ($this->ca_idtrafico !== $v) {
			$this->ca_idtrafico = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_IDTRAFICO;
		}
	...
	public function setCaIdlinea($v)
	{
		...
		if ($this->ca_idlinea !== $v) {
			$this->ca_idlinea = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_IDLINEA;
		}
	...
	public function setCaIdrecargo($v)
	{
		...
		if ($this->ca_idrecargo !== $v) {
			$this->ca_idrecargo = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_IDRECARGO;
		}
	...
	public function setCaIdconcepto($v)
	{
		...
		if ($this->ca_idconcepto !== $v) {
			...
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_IDCONCEPTO;
		}
	...
	public function setCaModalidad($v)
	{
		...
		if ($this->ca_modalidad !== $v) {
			$this->ca_modalidad = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_MODALIDAD;
		}
	...
	public function setCaImpoexpo($v)
	{
		...
		if ($this->ca_impoexpo !== $v) {
			$this->ca_impoexpo = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_IMPOEXPO;
		}
	...
	public function setCaVlrrecargo($v)
	{
		...
		if ($this->ca_vlrrecargo !== $v) {
			...
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_VLRRECARGO;
		}
	...
	public function setCaAplicacion($v)
	{
		...
		if ($this->ca_aplicacion !== $v) {
			...
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_APLICACION;
		}
	...
	public function setCaVlrminimo($v)
	{
		...
		if ($this->ca_vlrminimo !== $v) {
			$this->ca_vlrminimo = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_VLRMINIMO;
		}
	...
	public function setCaAplicacionMin($v)
	{
		...
		if ($this->ca_aplicacion_min !== $v) {
			...
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_APLICACION_MIN;
		}
	...
	public function setCaObservaciones($v)
	{
		...
		if ($this->ca_observaciones !== $v) {
			...
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_OBSERVACIONES;
		}
	...
	public function setCaFchinicio($v)
	{
		...
		if ( $this->ca_fchinicio !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_FCHINICIO;
			}
	...
	public function setCaFchvencimiento($v)
	{
		...
		if ( $this->ca_fchvencimiento !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_FCHVENCIMIENTO;
			}
		} // if either are not null
	...
	public function setCaFchcreado($v)
	{
		...
		if ( $this->ca_fchcreado !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_FCHCREADO;
			}
		} // if either are not null
	...
	public function setCaUsucreado($v)
	{
		...
		if ($this->ca_usucreado !== $v) {
			$this->ca_usucreado = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_USUCREADO;
		}
	...
	public function setCaIdmoneda($v)
	{
		...
		if ($this->ca_idmoneda !== $v) {
			$this->ca_idmoneda = $v;
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_IDMONEDA;
		}
	...
	public function setCaConsecutivo($v)
	{
		...
		if ($this->ca_consecutivo !== $v) {
			...
			$this->modifiedColumns[] = PricRecargosxLineaLogPeer::CA_CONSECUTIVO;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 17; // 17 = PricRecargosxLineaLogPeer::NUM_COLUMNS - PricRecargosxLineaLogPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PricRecargosxLineaLog object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PricRecargosxLineaLogPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			PricRecargosxLineaLogPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			PricRecargosxLineaLogPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PricRecargosxLineaLogPeer::doInsert($this, $con);
					...
					$affectedRows += PricRecargosxLineaLogPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PricRecargosxLineaLogPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PricRecargosxLineaLogPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = PricRecargosxLineaLogPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_IDTRAFICO)) $criteria->add(PricRecargosxLineaLogPeer::CA_IDTRAFICO, $this->ca_idtrafico);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_IDLINEA)) $criteria->add(PricRecargosxLineaLogPeer::CA_IDLINEA, $this->ca_idlinea);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_IDRECARGO)) $criteria->add(PricRecargosxLineaLogPeer::CA_IDRECARGO, $this->ca_idrecargo);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_IDCONCEPTO)) $criteria->add(PricRecargosxLineaLogPeer::CA_IDCONCEPTO, $this->ca_idconcepto);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_MODALIDAD)) $criteria->add(PricRecargosxLineaLogPeer::CA_MODALIDAD, $this->ca_modalidad);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_IMPOEXPO)) $criteria->add(PricRecargosxLineaLogPeer::CA_IMPOEXPO, $this->ca_impoexpo);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_VLRRECARGO)) $criteria->add(PricRecargosxLineaLogPeer::CA_VLRRECARGO, $this->ca_vlrrecargo);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_APLICACION)) $criteria->add(PricRecargosxLineaLogPeer::CA_APLICACION, $this->ca_aplicacion);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_VLRMINIMO)) $criteria->add(PricRecargosxLineaLogPeer::CA_VLRMINIMO, $this->ca_vlrminimo);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_APLICACION_MIN)) $criteria->add(PricRecargosxLineaLogPeer::CA_APLICACION_MIN, $this->ca_aplicacion_min);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_OBSERVACIONES)) $criteria->add(PricRecargosxLineaLogPeer::CA_OBSERVACIONES, $this->ca_observaciones);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_FCHINICIO)) $criteria->add(PricRecargosxLineaLogPeer::CA_FCHINICIO, $this->ca_fchinicio);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_FCHVENCIMIENTO)) $criteria->add(PricRecargosxLineaLogPeer::CA_FCHVENCIMIENTO, $this->ca_fchvencimiento);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_FCHCREADO)) $criteria->add(PricRecargosxLineaLogPeer::CA_FCHCREADO, $this->ca_fchcreado);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_USUCREADO)) $criteria->add(PricRecargosxLineaLogPeer::CA_USUCREADO, $this->ca_usucreado);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_IDMONEDA)) $criteria->add(PricRecargosxLineaLogPeer::CA_IDMONEDA, $this->ca_idmoneda);
		if ($this->isColumnModified(PricRecargosxLineaLogPeer::CA_CONSECUTIVO)) $criteria->add(PricRecargosxLineaLogPeer::CA_CONSECUTIVO, $this->ca_consecutivo);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PricRecargosxLineaLogPeer::CA_CONSECUTIVO, $this->ca_consecutivo);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PricRecargosxLineaLog (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PricRecargosxLineaLog Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PricRecargosxLineaLogPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PricRecargosxLineaLogPeer();
		}
		return self::$peer;
	}
	...
	public function setTransportador(Transportador $v = null)
	{
		...
		if ($v !== null) {
			$v->addPricRecargosxLineaLog($this);
		}
	...
	public function getTransportador(PropelPDO $con = null)
	{
		if ($this->aTransportador === null && (($this->ca_idlinea !== "" && $this->ca_idlinea !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aTransportador->addPricRecargosxLineaLogs($this);
			 */
		}
	...
	public function getTipoRecargo(PropelPDO $con = null)
	{
		if ($this->aTipoRecargo === null && ($this->ca_idrecargo !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTipoRecargo->addPricRecargosxLineaLogs($this);
			 */
		}
	...
	public function getConcepto(PropelPDO $con = null)
	{
		if ($this->aConcepto === null && ($this->ca_idconcepto !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aConcepto->addPricRecargosxLineaLogs($this);
			 */
		}
