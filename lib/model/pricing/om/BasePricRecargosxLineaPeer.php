...
abstract class BasePricRecargosxLineaPeer {
	...
	public static function addInstanceToPool(PricRecargosxLinea $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getCaIdtrafico(), (string) $obj->getCaIdlinea(), (string) $obj->getCaIdrecargo(), (string) $obj->getCaModalidad(), (string) $obj->getCaImpoexpo()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof PricRecargosxLinea) {
				$key = serialize(array((string) $value->getCaIdtrafico(), (string) $value->getCaIdlinea(), (string) $value->getCaIdrecargo(), (string) $value->getCaModalidad(), (string) $value->getCaImpoexpo()));
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion->addAnd($criteria->getNewCriterion(PricRecargosxLineaPeer::CA_MODALIDAD, $value[3]));
				$criterion->addAnd($criteria->getNewCriterion(PricRecargosxLineaPeer::CA_IMPOEXPO, $value[4]));
	 ...
	 * @return     PricRecargosxLinea
	 */
	public static function retrieveByPK($ca_idtrafico, $ca_idlinea, $ca_idrecargo, $ca_modalidad, $ca_impoexpo, PropelPDO $con = null) {
		$key = serialize(array((string) $ca_idtrafico, (string) $ca_idlinea, (string) $ca_idrecargo, (string) $ca_modalidad, (string) $ca_impoexpo));
 		if (null !== ($obj = PricRecargosxLineaPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
