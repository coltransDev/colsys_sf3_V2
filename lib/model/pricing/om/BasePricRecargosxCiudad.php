...
abstract class BasePricRecargosxCiudad extends BaseObject  implements Persistent {
  ...
  const PEER = 'PricRecargosxCiudadPeer';
	...
	/**
	 * Initializes internal state of BasePricRecargosxCiudad object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PricRecargosxCiudad The current object (for fluent API support)
	 */
	...
	public function getCiudad(PropelPDO $con = null)
	{
		if ($this->aCiudad === null && (($this->ca_idciudad !== "" && $this->ca_idciudad !== null))) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCiudad->addPricRecargosxCiudads($this);
			 */
		}
		return $this->aCiudad;
	}
	...
	public function getTipoRecargo(PropelPDO $con = null)
	{
		if ($this->aTipoRecargo === null && ($this->ca_idrecargo !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTipoRecargo->addPricRecargosxCiudads($this);
			 */
		}
