...
abstract class BasePricArchivoPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of PricArchivo objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array PricArchivo[]
	 */
	 ...
	 *
	 * @param      PricArchivo $value A PricArchivo object.
	 ...
	 *
	 * @param      mixed $value A PricArchivo object or a primary key value.
	 */
	 ...
	 * @return     PricArchivo Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinTrafico(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PricArchivo) to $obj2 (Trafico)
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (PricArchivo) to the collection in $obj2 (Trafico)
				$obj2->addPricArchivo($obj1);
...
//
// NOTE: This static code cannot call methods on the PricArchivoPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the PricArchivoPeer class:
//
// Propel::getDatabaseMap(PricArchivoPeer::DATABASE_NAME)->addTableBuilder(PricArchivoPeer::TABLE_NAME, PricArchivoPeer::getMapBuilder());
//
