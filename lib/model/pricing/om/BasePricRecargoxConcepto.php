...
abstract class BasePricRecargoxConcepto extends BaseObject  implements Persistent {
  ...
  const PEER = 'PricRecargoxConceptoPeer';
	...
	/**
	 * Initializes internal state of BasePricRecargoxConcepto object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PricRecargoxConcepto The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 14; // 14 = PricRecargoxConceptoPeer::NUM_COLUMNS - PricRecargoxConceptoPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getPricFlete(PropelPDO $con = null)
	{
		if ($this->aPricFlete === null && ($this->ca_idtrayecto !== null && $this->ca_idconcepto !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aPricFlete->addPricRecargoxConceptos($this);
			 */
		}
	...
	public function getTipoRecargo(PropelPDO $con = null)
	{
		if ($this->aTipoRecargo === null && ($this->ca_idrecargo !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aTipoRecargo->addPricRecargoxConceptos($this);
			 */
		}
