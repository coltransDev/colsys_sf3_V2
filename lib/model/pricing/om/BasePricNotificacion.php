...
abstract class BasePricNotificacion extends BaseObject  implements Persistent {
  ...
  const PEER = 'PricNotificacionPeer';
	...
	/**
	 * Initializes internal state of BasePricNotificacion object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [optionally formatted] temporal [ca_caducidad] column value.
	 * 
	 *
	 ...
	 * @return     PricNotificacion The current object (for fluent API support)
	 */
	...
	/**
	 * Sets the value of [ca_caducidad] column to a normalized version of the date/time value specified.
	 * 
