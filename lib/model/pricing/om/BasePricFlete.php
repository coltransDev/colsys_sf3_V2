...
abstract class BasePricFlete extends BaseObject  implements Persistent {
  ...
  const PEER = 'PricFletePeer';
	...
	/**
	 * Initializes internal state of BasePricFlete object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PricFlete The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 12; // 12 = PricFletePeer::NUM_COLUMNS - PricFletePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getTrayecto(PropelPDO $con = null)
	{
		if ($this->aTrayecto === null && ($this->ca_idtrayecto !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aTrayecto->addPricFletes($this);
			 */
		}
	...
	public function getConcepto(PropelPDO $con = null)
	{
		if ($this->aConcepto === null && ($this->ca_idconcepto !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aConcepto->addPricFletes($this);
			 */
		}
	 ...
	 * Otherwise if this PricFlete has previously been saved, it will retrieve
	 * related PricRecargoxConceptos from storage. If this PricFlete is new, it will return
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this PricFlete has previously been saved, it will retrieve
	 * related PricRecargoxConceptoLogs from storage. If this PricFlete is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
