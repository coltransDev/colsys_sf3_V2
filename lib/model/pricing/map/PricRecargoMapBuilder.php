...
/**
 * This class adds structure of 'tb_pricrecargos' table to 'propel' DatabaseMap object.
 *
 *
 *
 ...
 */
class PricRecargoMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.pricing.map.PricRecargoMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tb_pricrecargos');
		$tMap->setPhpName('PricRecargo');
