...
/**
 * This class adds structure of 'bs_pricrecargosxlinea' table to 'propel' DatabaseMap object.
 *
 *
 *
...
class PricRecargosxLineaLogMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('CA_IDLINEA', 'CaIdlinea', 'VARCHAR', 'tb_transporlineas', 'CA_IDLINEA', true, null);
...
} // PricRecargosxLineaLogMapBuilder
