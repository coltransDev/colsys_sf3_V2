 ...
 * @method InoConceptoParametro setCaIdparametro()        Sets the current record's "ca_idparametro" value
 * @method InoConceptoParametro setCaIdconcepto()         Sets the current record's "ca_idconcepto" value
 * @method InoConceptoParametro setCaIdccosto()           Sets the current record's "ca_idccosto" value
 * @method InoConceptoParametro setCaIdcuenta()           Sets the current record's "ca_idcuenta" value
 * @method InoConceptoParametro setCaIngresoPropio()      Sets the current record's "ca_ingreso_propio" value
 * @method InoConceptoParametro setCaIva()                Sets the current record's "ca_iva" value
 * @method InoConceptoParametro setCaBaseretencion()      Sets the current record's "ca_baseretencion" value
 * @method InoConceptoParametro setCaIdcuentaretencion()  Sets the current record's "ca_idcuentaretencion" value
 * @method InoConceptoParametro setCaValor()              Sets the current record's "ca_valor" value
 * @method InoConceptoParametro setCaConvenios()          Sets the current record's "ca_convenios" value
 * @method InoConceptoParametro setCaAutoretencion()      Sets the current record's "ca_autoretencion" value
 * @method InoConceptoParametro setCaTipoautoretencion()  Sets the current record's "ca_tipoautoretencion" value
 * @method InoConceptoParametro setInoConcepto()          Sets the current record's "InoConcepto" value
 * @method InoConceptoParametro setInoCentroCosto()       Sets the current record's "InoCentroCosto" value
 * @method InoConceptoParametro setInoCuenta()            Sets the current record's "InoCuenta" value
 * @method InoConceptoParametro setInoCuentaRetencion()   Sets the current record's "InoCuentaRetencion" value
 * 
 * @package    symfony
 * @subpackage model
 ...
 */
abstract class BaseInoConceptoParametro extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ino.tb_conceptos_parametros');
