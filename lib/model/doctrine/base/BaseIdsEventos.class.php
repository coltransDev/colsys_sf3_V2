 ...
 * @method IdsEventos setCaIdevento()       Sets the current record's "ca_idevento" value
 * @method IdsEventos setCaIdcliente()      Sets the current record's "ca_idcliente" value
 * @method IdsEventos setCaFchevento()      Sets the current record's "ca_fchevento" value
 * @method IdsEventos setCaTipo()           Sets the current record's "ca_tipo" value
 * @method IdsEventos setCaAsunto()         Sets the current record's "ca_asunto" value
 * @method IdsEventos setCaDetalle()        Sets the current record's "ca_detalle" value
 * @method IdsEventos setCaCompromisos()    Sets the current record's "ca_compromisos" value
 * @method IdsEventos setCaFchcompromiso()  Sets the current record's "ca_fchcompromiso" value
 * @method IdsEventos setCaIdantecedente()  Sets the current record's "ca_idantecedente" value
 * @method IdsEventos setCaUsuario()        Sets the current record's "ca_usuario" value
 * @method IdsEventos setCaDatos()          Sets the current record's "ca_datos" value
 * @method IdsEventos setIdsCliente()       Sets the current record's "IdsCliente" value
 * @method IdsEventos setUsuario()          Sets the current record's "Usuario" value
 * 
 * @package    symfony
 * @subpackage model
 ...
 */
abstract class BaseIdsEventos extends myDoctrineRecord
{
