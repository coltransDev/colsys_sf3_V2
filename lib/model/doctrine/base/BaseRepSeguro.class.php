 ...
 * @property string $ca_idmonedaventa
 ...
 * @method string    getCaIdmonedaventa()    Returns the current record's "ca_idmonedaventa" value
 ...
 * @method RepSeguro setCaIdmonedaventa()    Sets the current record's "ca_idmonedaventa" value
...
abstract class BaseRepSeguro extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('ca_idmonedaventa', 'string', null, array(
             'type' => 'string',
             ));
