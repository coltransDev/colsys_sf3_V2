 ...
 * @method ConceptoDeposito setCaConsecutivo()       Sets the current record's "ca_consecutivo" value
 * @method ConceptoDeposito setCaIdconcepto()        Sets the current record's "ca_idconcepto" value
 * @method ConceptoDeposito setCaValor()             Sets the current record's "ca_valor" value
 * @method ConceptoDeposito setCaAplicacion()        Sets the current record's "ca_aplicacion" value
 * @method ConceptoDeposito setCaValorminimo()       Sets the current record's "ca_valorminimo" value
 * @method ConceptoDeposito setCaParametro()         Sets the current record's "ca_parametro" value
 * @method ConceptoDeposito setCaAplicacionminimo()  Sets the current record's "ca_aplicacionminimo" value
 * @method ConceptoDeposito setCaFchini()            Sets the current record's "ca_fchini" value
 * @method ConceptoDeposito setCaFchfin()            Sets the current record's "ca_fchfin" value
 * @method ConceptoDeposito setCaFchcreado()         Sets the current record's "ca_fchcreado" value
 * @method ConceptoDeposito setCaUsucreado()         Sets the current record's "ca_usucreado" value
 * @method ConceptoDeposito setCaFcheliminado()      Sets the current record's "ca_fcheliminado" value
 * @method ConceptoDeposito setCaObservaciones()     Sets the current record's "ca_observaciones" value
 * @method ConceptoDeposito setCosto()               Sets the current record's "Costo" value
 * 
 * @package    symfony
 * @subpackage model
 ...
 */
abstract class BaseConceptoDeposito extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('pric.tb_conceptodeposito');
