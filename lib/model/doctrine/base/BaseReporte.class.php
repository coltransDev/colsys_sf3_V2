 ...
 * @method numeric             getCaIdclientefac()       Returns the current record's "ca_idclientefac" value
 * @method numeric             getCaIdclienteag()        Returns the current record's "ca_idclienteag" value
 * @method numeric             getCaIdclienteotro()      Returns the current record's "ca_idclienteotro" value
 ...
 * @method Cliente             getClienteFac()           Returns the current record's "ClienteFac" value
 * @method Cliente             getClienteAg()            Returns the current record's "ClienteAg" value
 * @method Cliente             getClienteOtro()          Returns the current record's "ClienteOtro" value
 ...
 * @method Reporte             setCaIdclientefac()       Sets the current record's "ca_idclientefac" value
 * @method Reporte             setCaIdclienteag()        Sets the current record's "ca_idclienteag" value
 * @method Reporte             setCaIdclienteotro()      Sets the current record's "ca_idclienteotro" value
 ...
 * @method Reporte             setClienteFac()           Sets the current record's "ClienteFac" value
 * @method Reporte             setClienteAg()            Sets the current record's "ClienteAg" value
 * @method Reporte             setClienteOtro()          Sets the current record's "ClienteOtro" value
 * @method Reporte             setBavaria()              Sets the current record's "Bavaria" value
 * @method Reporte             setInoHouse()             Sets the current record's "InoHouse" collection
