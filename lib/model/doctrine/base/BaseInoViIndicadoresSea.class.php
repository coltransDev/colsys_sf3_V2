 ...
 * @method InoViIndicadoresSea setCaAno()                  Sets the current record's "ca_ano" value
 * @method InoViIndicadoresSea setCaMes()                  Sets the current record's "ca_mes" value
 * @method InoViIndicadoresSea setCaIdreporte()            Sets the current record's "ca_idreporte" value
 * @method InoViIndicadoresSea setCaConsecutivo()          Sets the current record's "ca_consecutivo" value
 * @method InoViIndicadoresSea setCaVersion()              Sets the current record's "ca_version" value
 * @method InoViIndicadoresSea setCaIdmaster()             Sets the current record's "ca_idmaster" value
 * @method InoViIndicadoresSea setCaIdhouse()              Sets the current record's "ca_idhouse" value
 * @method InoViIndicadoresSea setCaSucursal()             Sets the current record's "ca_sucursal" value
 * @method InoViIndicadoresSea setCaTraorigen()            Sets the current record's "ca_traorigen" value
 * @method InoViIndicadoresSea setCaCiudestino()           Sets the current record's "ca_ciudestino" value
 * @method InoViIndicadoresSea setCaImpoexpo()             Sets the current record's "ca_impoexpo" value
 * @method InoViIndicadoresSea setCaTransporte()           Sets the current record's "ca_transporte" value
 * @method InoViIndicadoresSea setCaModalidad()            Sets the current record's "ca_modalidad" value
 * @method InoViIndicadoresSea setCaId()                   Sets the current record's "ca_id" value
 * @method InoViIndicadoresSea setCaIdcliente()            Sets the current record's "ca_idcliente" value
 * @method InoViIndicadoresSea setCaDoctransporte()        Sets the current record's "ca_doctransporte" value
 * @method InoViIndicadoresSea setCaCompania()             Sets the current record's "ca_compania" value
 * @method InoViIndicadoresSea setCaReferencia()           Sets the current record's "ca_referencia" value
 * @method InoViIndicadoresSea setCaContinuacion()         Sets the current record's "ca_continuacion" value
 * @method InoViIndicadoresSea setCaFchllegada()           Sets the current record's "ca_fchllegada" value
 * @method InoViIndicadoresSea setCaFchdesconsolidacion()  Sets the current record's "ca_fchdesconsolidacion" value
 * @method InoViIndicadoresSea setCaFchconfirmacion()      Sets the current record's "ca_fchconfirmacion" value
 * @method InoViIndicadoresSea setCaFchvaciado()           Sets the current record's "ca_fchvaciado" value
 * @method InoViIndicadoresSea setCaIdindicador()          Sets the current record's "ca_idindicador" value
 * @method InoViIndicadoresSea setCaIdgval()               Sets the current record's "ca_idgval" value
 * @method InoViIndicadoresSea setCaIdgest()               Sets the current record's "ca_idgest" value
 * @method InoViIndicadoresSea setCaIdgexc()               Sets the current record's "ca_idgexc" value
 * @method InoViIndicadoresSea setCaExclusion()            Sets the current record's "ca_exclusion" value
 * @method InoViIndicadoresSea setCaObservaciones()        Sets the current record's "ca_observaciones" value
 * @method InoViIndicadoresSea setCaFchrecibo()            Sets the current record's "ca_fchrecibo" value
 * @method InoViIndicadoresSea setCaFchenvio()             Sets the current record's "ca_fchenvio" value
 * @method InoViIndicadoresSea setCaUsuenvio()             Sets the current record's "ca_usuenvio" value
 * @method InoViIndicadoresSea setCaIdetapa()              Sets the current record's "ca_idetapa" value
 * @method InoViIndicadoresSea setCaEtapa()                Sets the current record's "ca_etapa" value
 * @method InoViIndicadoresSea setReporte()                Sets the current record's "Reporte" value
 * @method InoViIndicadoresSea setInoHouse()               Sets the current record's "InoHouse" value
 * @method InoViIndicadoresSea setUsuario()                Sets the current record's "Usuario" value
 * 
 * @package    symfony
 * @subpackage model
 ...
 */
abstract class BaseInoViIndicadoresSea extends myDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ino.vi_indicadores_sea');
