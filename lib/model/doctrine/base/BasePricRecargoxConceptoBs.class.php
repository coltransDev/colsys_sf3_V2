 ...
 * @method PricRecargoxConceptoBs setCaIdequipo()        Sets the current record's "ca_idequipo" value
 ...
 * @method PricRecargoxConceptoBs setCaFchactualizado()  Sets the current record's "ca_fchactualizado" value
 * @method PricRecargoxConceptoBs setCaUsuactualizado()  Sets the current record's "ca_usuactualizado" value
 ...
 * @method PricRecargoxConceptoBs setEquipo()            Sets the current record's "Equipo" value
 * 
 * @package    symfony
 * @subpackage model
...
abstract class BasePricRecargoxConceptoBs extends myDoctrineRecord
{
    ...
    {
        $this->setTableName('pric.bs_recargosxconcepto');
