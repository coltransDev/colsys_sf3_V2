...
class InoClientesAirTable extends Doctrine_Table
{
    ...
    public static function facturasPorReporte($referencia, $idcliente, $consecutivo, $usuenvio) {
        ...
        if ($referencia != null and $idcliente != null and $consecutivo != null) {
            $query = "select ic.ca_referencia, ic.ca_idcliente, ic.ca_idreporte as ca_consecutivo, ii.ca_usucreado, count(ii.ca_factura) as ca_cant_facturas ";
            ...
            $query.= "  group by ic.ca_referencia, ic.ca_idcliente, ic.ca_idreporte, ii.ca_usucreado ";
