...
abstract class BaseBavariaNotifyPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of BavariaNotify objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array BavariaNotify[]
	 */
	 ...
	 *
	 * @param      BavariaNotify $value A BavariaNotify object.
	 ...
	 *
	 * @param      mixed $value A BavariaNotify object or a primary key value.
	 */
	 ...
	 * @return     BavariaNotify Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
...
//
// NOTE: This static code cannot call methods on the BavariaNotifyPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the BavariaNotifyPeer class:
//
// Propel::getDatabaseMap(BavariaNotifyPeer::DATABASE_NAME)->addTableBuilder(BavariaNotifyPeer::TABLE_NAME, BavariaNotifyPeer::getMapBuilder());
//
