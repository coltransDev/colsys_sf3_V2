...
/**
 * Base class that represents a row from the 'tb_bavarianotify' table.
 *
 * 
 *
...
abstract class BaseBavariaNotify extends BaseObject  implements Persistent {
  ...
  const PEER = 'BavariaNotifyPeer';
	...
	/**
	 * Initializes internal state of BaseBavariaNotify object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     BavariaNotify The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = BavariaNotifyPeer::NUM_COLUMNS - BavariaNotifyPeer::NUM_LAZY_LOAD_COLUMNS).
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of BavariaNotify (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     BavariaNotify Clone of current object.
	 * @throws     PropelException
	 */
