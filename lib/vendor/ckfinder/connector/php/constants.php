...
define('CKFINDER_CONNECTOR_LANG_PATH',CKFINDER_LIB."connector".DIRECTORY_SEPARATOR
                              ."php".DIRECTORY_SEPARATOR."lang");
define('CKFINDER_CONNECTOR_CONFIG_FILE_PATH',CKFINDER_LIB."config.php");
...
if (CKFINDER_CONNECTOR_PHP_MODE == 4) {
    ...
    define('CKFINDER_CONNECTOR_LIB_DIR', CKFINDER_LIB."connector".DIRECTORY_SEPARATOR
                              ."php".DIRECTORY_SEPARATOR."php5");
}
