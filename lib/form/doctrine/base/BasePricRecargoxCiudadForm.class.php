 ...
 *
 * @package    form
 * @subpackage pric_recargox_ciudad
...
class BasePricRecargoxCiudadForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'ca_idtrafico'      => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxCiudad', 'column' => 'ca_idtrafico', 'required' => false)),
      'ca_idciudad'       => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxCiudad', 'column' => 'ca_idciudad', 'required' => false)),
      'ca_idrecargo'      => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxCiudad', 'column' => 'ca_idrecargo', 'required' => false)),
      'ca_modalidad'      => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxCiudad', 'column' => 'ca_modalidad', 'required' => false)),
      'ca_impoexpo'       => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxCiudad', 'column' => 'ca_impoexpo', 'required' => false)),
