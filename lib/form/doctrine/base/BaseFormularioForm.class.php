...
abstract class BaseFormularioForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ca_color'            => new sfWidgetFormInputText(),
      'ca_bold'             => new sfWidgetFormInputText(),
      'ca_strong'           => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'ca_color'            => new sfValidatorString(array('max_length' => 8, 'required' => false)),
      'ca_bold'             => new sfValidatorString(array('max_length' => 8, 'required' => false)),
      'ca_strong'           => new sfValidatorString(array('max_length' => 8, 'required' => false)),
