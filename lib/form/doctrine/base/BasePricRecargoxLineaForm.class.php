 ...
 *
 * @package    form
 * @subpackage pric_recargox_linea
...
class BasePricRecargoxLineaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'ca_idtrafico'      => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxLinea', 'column' => 'ca_idtrafico', 'required' => false)),
      'ca_idlinea'        => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxLinea', 'column' => 'ca_idlinea', 'required' => false)),
      'ca_idrecargo'      => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxLinea', 'column' => 'ca_idrecargo', 'required' => false)),
      'ca_idconcepto'     => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxLinea', 'column' => 'ca_idconcepto', 'required' => false)),
      'ca_modalidad'      => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxLinea', 'column' => 'ca_modalidad', 'required' => false)),
      'ca_impoexpo'       => new sfValidatorDoctrineChoice(array('model' => 'PricRecargoxLinea', 'column' => 'ca_impoexpo', 'required' => false)),
