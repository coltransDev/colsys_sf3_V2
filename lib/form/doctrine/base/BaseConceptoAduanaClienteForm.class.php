...
/**
 * ConceptoAduanaCliente form base class.
 *
 * @method ConceptoAduanaCliente getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseConceptoAduanaClienteForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('concepto_aduana_cliente[%s]');
