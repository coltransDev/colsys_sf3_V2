...
abstract class BaseRepExpoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ca_idsia'            => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Sia'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'ca_idsia'            => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Sia'), 'required' => false)),
