...
class BaseInoMaestraForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ca_idtrayecto'     => new sfWidgetFormDoctrineChoice(array('model' => 'Trayecto', 'add_empty' => false)),
      ...
      'ca_usuliquidado'   => new sfWidgetFormDoctrineChoice(array('model' => 'Usuario', 'add_empty' => true)),
      'ca_fchcerrado'     => new sfWidgetFormDateTime(),
      'ca_usucerrado'     => new sfWidgetFormDoctrineChoice(array('model' => 'Usuario', 'add_empty' => true)),
      'ca_fchanulado'     => new sfWidgetFormDateTime(),
      'ca_usuanulado'     => new sfWidgetFormDoctrineChoice(array('model' => 'Usuario', 'add_empty' => true)),
    ));
    ...
    $this->setValidators(array(
      ...
      'ca_idtrayecto'     => new sfValidatorDoctrineChoice(array('model' => 'Trayecto')),
      ...
      'ca_usuliquidado'   => new sfValidatorDoctrineChoice(array('model' => 'Usuario', 'required' => false)),
      'ca_fchcerrado'     => new sfValidatorDateTime(array('required' => false)),
      'ca_usucerrado'     => new sfValidatorDoctrineChoice(array('model' => 'Usuario', 'required' => false)),
      'ca_fchanulado'     => new sfValidatorDateTime(array('required' => false)),
      'ca_usuanulado'     => new sfValidatorDoctrineChoice(array('model' => 'Usuario', 'required' => false)),
    ));
