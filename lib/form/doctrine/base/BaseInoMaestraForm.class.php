...
abstract class BaseInoMaestraForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ca_idtrayecto'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Trayecto'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'ca_idtrayecto'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Trayecto'))),
