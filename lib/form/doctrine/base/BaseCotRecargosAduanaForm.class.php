...
/**
 * CotRecargosAduana form base class.
 *
 * @method CotRecargosAduana getObject() Returns the current form's model object
 *
 * @package    symfony
 * @subpackage form
 ...
 */
abstract class BaseCotRecargosAduanaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cot_recargos_aduana[%s]');
