...
/**
 * PricRecargosxCiudad form base class.
 *
 * @package    colsys
 * @subpackage form
 ...
 */
class BasePricRecargosxCiudadForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'ca_idtrafico'      => new sfValidatorPropelChoice(array('model' => 'PricRecargosxCiudad', 'column' => 'ca_idtrafico', 'required' => false)),
      ...
      'ca_modalidad'      => new sfValidatorPropelChoice(array('model' => 'PricRecargosxCiudad', 'column' => 'ca_modalidad', 'required' => false)),
      'ca_impoexpo'       => new sfValidatorPropelChoice(array('model' => 'PricRecargosxCiudad', 'column' => 'ca_impoexpo', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('pric_recargosx_ciudad[%s]');
