...
class BasePricRecargoxConceptoForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'ca_idtrayecto'     => new sfValidatorPropelChoice(array('model' => 'PricFlete', 'column' => 'ca_idtrayecto', 'required' => false)),
      'ca_idconcepto'     => new sfValidatorPropelChoice(array('model' => 'PricFlete', 'column' => 'ca_idconcepto', 'required' => false)),
