...
/**
 * ReporteConceptoSea form base class.
 *
 * @package    form
 * @subpackage reporte_concepto_sea
 * @version    SVN: $Id: sfPropelFormGeneratedTemplate.php 8807 2008-05-06 14:12:28Z fabien $
 */
class BaseReporteConceptoSeaForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'oid'             => new sfValidatorPropelChoice(array('model' => 'ReporteConceptoSea', 'column' => 'oid', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('reporte_concepto_sea[%s]');
