...
class BaseRepStatusForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'ca_idemail'         => new sfWidgetFormPropelChoice(array('model' => 'Email', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'ca_idstatus'        => new sfValidatorPropelChoice(array('model' => 'RepStatus', 'column' => 'ca_idstatus', 'required' => false)),
