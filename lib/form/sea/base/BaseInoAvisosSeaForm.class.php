...
class BaseInoAvisosSeaForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'ca_hbls'       => new sfValidatorPropelChoice(array('model' => 'InoAvisosSea', 'column' => 'ca_hbls', 'required' => false)),
      'ca_idemail'    => new sfValidatorPropelChoice(array('model' => 'InoAvisosSea', 'column' => 'ca_idemail', 'required' => false)),
