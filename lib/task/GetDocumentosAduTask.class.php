...
class GetDocumentosAduTask extends sfDoctrineBaseTask
{
  protected function configure()
  {
    $this->namespace        = 'colsys';
    $this->name             = 'get-documentos-adu';
    $this->briefDescription = 'captura los documentos de fatcura enviados por scanner';
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    sfContext::getInstance()->getRequest()->setParameter("folder", "DOCUMENTOSADU");
