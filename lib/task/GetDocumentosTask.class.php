...
class GetDocumentosTask extends sfDoctrineBaseTask
{
  protected function configure()
  {
    $this->namespace        = 'colsys';
    $this->name             = 'get-documentos';
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    /*sfContext::getInstance()->getRequest()->setParameter("folder", "FACTURAS");
	sfContext::getInstance()->getRequest()->setParameter("iddocumental", "7");
	echo sfContext::getInstance()->getController()->getPresentationFor( 'gestDocumental', 'mailDocumentosF');
    */
    sfContext::getInstance()->getRequest()->setParameter("folder", "DOCUMENTOS");
    sfContext::getInstance()->getRequest()->setParameter("iddocumental", "7");
	echo sfContext::getInstance()->getController()->getPresentationFor( 'gestDocumental', 'mailDocumentosF');
    
    
    /*sfContext::getInstance()->getRequest()->setParameter("folder", "DOCUMENTOSAEREO");
