...
class ControlMandatosClientesTask extends sfDoctrineBaseTask
{
  protected function configure()
  {
    $this->namespace        = 'colsys';
    $this->name             = 'controlMandatosClientes';
    $this->briefDescription = 'Genera Reporte Mensual de los Clientes que se les vence su Carta de Garantía';
    $this->detailedDescription = <<<EOF
The [controlMandatosClientes|INFO] task does things.
Call it with:

  [php symfony controlMandatosClientes|INFO]
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
	...
	echo sfContext::getInstance()->getController()->getPresentationFor( 'clientes', 'reporteControlMandatosEmail');
  }
}