...
class ImpoDataOpenTask extends sfDoctrineBaseTask
{
  protected function configure()
  {
    $this->namespace        = 'colsys';
    $this->name             = 'impo-data-open';
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
	...
	echo sfContext::getInstance()->getController()->getPresentationFor( 'falabellaAdu2', 'TaskImportarDo');
  }
}