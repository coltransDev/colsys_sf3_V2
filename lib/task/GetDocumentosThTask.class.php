...
class GetDocumentosThTask extends sfDoctrineBaseTask
{
  protected function configure()
  {
    $this->namespace        = 'colsys';
    $this->name             = 'get-documentos-th';
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    sfContext::getInstance()->getRequest()->setParameter("folder", "DOCUMENTOSTH");
    sfContext::getInstance()->getRequest()->setParameter("iddocumental", "84");
