				...
				<div style="float:left;">
					<div class="icon">
						<a href="<?=url_for("aduana/index")?>">
							<img src="/colmasweb/administrator/templates/khepri/images/header/icon-48-section.png" alt="Administrador de secciones"  />					<span>Aduana</span></a>
				...
				<div style="float:left;">
					<div class="icon">
						<a href="index.php?option=com_media">
							...
							<img src="/colmasweb/administrator/templates/khepri/images/header/icon-48-config.png" alt="Configuración global"  />						<span>Configuraci&oacute;n de la cuenta</span></a>
					</div>
				</div>
				<div style="float:left;">
					<div class="icon">
						...
						<a href="index.php?option=com_menus">
							<img src="/colmasweb/administrator/templates/khepri/images/header/icon-48-menumgr.png" alt="Administrador de menús"  />					<span>Salir</span></a>
					</div>
				</div>
