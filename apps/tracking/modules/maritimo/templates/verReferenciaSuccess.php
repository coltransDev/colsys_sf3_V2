...
foreach( $referenciasCliente as $referencia ){
	$maestra = $referencia->getInoMaestraSea();
?>
	<table width="90%" border="0" class="table1">
		...
		<tr>
			...
			<td width="22%"><div align="left"><strong>Origen</strong><br />
				<?=$maestra->getOrigen()?>			
			</div></td>
			<td width="26%"><div align="left"><strong>Destino</strong><br />
				<?=$maestra->getDestino()?>			
			</div></td>
		</tr>
		<tr>
			<td width="19%"><div align="left"><strong>HBL</strong> <br />
				<?=$referencia->getCaHbls()?>			
			</div></td>
		...
		?>
		<tr >
			<td colspan="3"><strong>Fecha Liberaci&oacute;n</strong><br />
			<?=$referencia->getCaFchLiberacion()?></td>
			<td colspan="2"><strong>Nota Liberaci&oacute;n</strong><br />
			<?=$referencia->getCaNotaLiberacion()?></td>
		</tr>
		<?
		}
		...
		<tr class="row0">
			...
			<td width="18%"><div align="left"><strong>Valor factura</strong><br />
				<?=$ingreso->getCaValor()?>
			</div></td>
			<td width="15%"><div align="left"><strong>Tasa de cambio </strong><br />
				<?=$ingreso->getCaTcambio()?>
			</div></td>
			<td><div align="left"><strong>Fecha factura</strong><br />
