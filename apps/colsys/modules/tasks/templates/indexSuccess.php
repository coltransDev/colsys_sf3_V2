...
include_component("tasks", "panelConsulta");
include_component("tasks", "panelTareas");
include_component("tasks", "editarTareaWindow");
...
<div id="center1" class="x-hide-display">
    <br />
	<h3>&nbsp;&nbsp;&nbsp;Bienvenido al sistema de administracion de tareas. </h3><br />
	<hr />
