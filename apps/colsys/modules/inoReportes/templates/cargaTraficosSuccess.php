...
<table class="tableList" width="600px" border="1" id="mainTable" align="center">
        ...
        <tr style ="text-align:center"><th>No</th><th >Reporte</th><th >Hbl</th><th>Importador</th><th>Modalidad</th><th  >Origen</th><th  >Destino</th> <th>CV</th> <th>DTM</th><th>Carta Porte</th><th>Opciones</th><th>Presentar</th><th>Chance</th></tr>
        <?
        $pos=1;
        ...
        <tr >
            <td><?=$pos++?></td>
            <td ><?=$r["ca_consecutivo"]?></td><td><?=$r["ca_hbls"]?></td><td><?=$r["ca_compania"]?></td><td><?=$r["ca_modalidad"]?></td><td><?=$r["ca_origen"]?></td><td><?=$r["ca_destino"]?></td>
