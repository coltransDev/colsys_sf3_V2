                    ...
                    items: [{
                        ...
                        items:[{
                            ...
                            items: [{
                                ...
                                id: 'rg_empresa',
                                items: [
                                    {boxLabel: 'COLOTM', name: 'nempresa', inputValue: 1, checked: true},
                    ...
                    items: [{
                        ...
                        items:[{
                            ...
                            items: [{
                                ...
                                id: 'rg_tipo',
                                items: [
                                    {boxLabel: 'ESTADISTICAS', name: 'ntipo', inputValue: 1, checked: true},
                                    {boxLabel: 'ASEGURADORA', name: 'ntipo', inputValue: 2,  <?= $ntipo == 2 ? "checked:'true'" : "" ?>},
                                    {boxLabel: 'MINISTERIO', name: 'ntipo', inputValue: 3, <?= $ntipo == 3 ? "checked:'true'" : "" ?>}
                                ]
                            }]
                        }]
                    }]
