...
<script type="text/javascript">
    ...
    FormConsultaPanelComplemento = function( config ){
        Ext.apply(this, config);       
        
        FormConsultaPanelComplemento.superclass.constructor.call(this, {
    ...
    Ext.extend(FormConsultaPanelComplemento, Ext.form.FormPanel, {
        consultar: function(){        
        ...
        onRender:function() {
            FormConsultaPanelComplemento.superclass.onRender.apply(this, arguments);
