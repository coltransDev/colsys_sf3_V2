...
<br />
<br />
<?=form_tag( "reportes/busquedaReporte?modo=".$modo	)?>
<table width="550px" align="center" border="0" cellpadding="5px" cellspacing="1px" id="mainTable">		
	<tr>	
		<th colspan="4" style='font-size: 12px; font-weight:bold;'><b><strong>Ingrese un criterio para realizar las busqueda</strong></b>		</th>		
		<th width="93" style='font-size: 12px; font-weight:bold;'><b>
			<?=link_to( image_tag("22x22/new.gif") , "reportes/formReporte?&modo=".$modo."&token=".md5(time()))?>
		</b></th>
	</tr>
	<tr>
