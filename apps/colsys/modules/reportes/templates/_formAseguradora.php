...
<table width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="listar"><strong>20.1 Valor Asegurado:</strong><br />
				<?
				if( $editable ){
		...
		<td class="listar"><strong> 20.2 Obtenci&oacute;n P&oacute;liza:</strong><br />
			<?
				if( $editable ){
				...
				?></td>
		<td class="listar"><strong>20.3 Prima Venta:</strong>
			<?
			if( $editable ){
