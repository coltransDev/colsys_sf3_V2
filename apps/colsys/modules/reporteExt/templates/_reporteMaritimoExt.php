...
if( $reporte->getCaIdmaster()){
	...
	$consignatario_m = $consignatario->getCaCompania()." Nit. ".number_format($consignatario->getCaIdcliente(),0)."-".$consignatario->getCaDigito()."<BR>Dirección: ".str_replace ("|"," ",$consignatario->getCaDireccion())."<BR>Teléfonos:".$consignatario->getCaTelefonos()." Fax:".$consignatario->getCaFax()."<BR>".$consignatario->getCiudad()->__toString();
}
...
if( !$reporte->getCaNotify() ){	
	...
	$notify_h = $cliente->getCaCompania()." Nit. ".number_format($cliente->getCaIdcliente(),0)."-".$cliente->getCaDigito()."<BR>Contacto: ".$contacto->getCaNombres()." ".$contacto->getCaPapellido()." ".$contacto->getCaSapellido()."<BR>Dirección: ".str_replace ("|"," ",$cliente->getCaDireccion())."<BR>Teléfonos:".$contacto->getCaTelefonos()." Fax:".$contacto->getCaFax()."<BR> Email:".$contacto->getCaEmail()."<BR>".$cliente->getCiudad()->getTrafico()->getcaNombre();		
}else{
