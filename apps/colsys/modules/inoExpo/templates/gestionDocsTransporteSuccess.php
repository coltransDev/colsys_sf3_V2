<center>    
    <h3>M&oacute;dulo para la Gestion de Documentos de Transporte</h3>
    <br />


    <form method="post" id="gestionDocsTransporte" action="<?= url_for('inoExpo/gestionDocsTransporteList') ?>">
