...
PanelTransporteAduana = function( config ){
    ...
    */
    ...
    <?
    $url = "cotizaciones/datosPanelTransporteAduana?idcotizacion=".$cotizacion->getCaIdcotizacion();
    if($modo=="consulta"){
        $url.="&modo=consulta";
    }
    ...
    */
    ...
    PanelTransporteAduana.superclass.constructor.call(this, {
       ...
       //store: storeProductos,
        ...
        title: 'Transporte Terrestre Nal.',
        height: 400,        

        root_title: 'impoexpo',
        closable: false,
        id: 'panel-transporte-aduana',
        <?
        if($modo!="consulta"){
        ?>
        tbar: [
    ...
    */
    ...
    eliminarTrayecto : function(){
        ...
        if( this.ctxRecord && confirm("Desea continuar?") ){
            var idtrayecto = this.ctxRecord.data.idtrayecto;

            Ext.Ajax.request(
            {
                waitMsg: 'Guardando cambios...',
                url: '<?=url_for("cotizaciones/eliminarPanelTransporteAduana?idcotizacion=".$cotizacion->getCaIdcotizacion())?>',
                //method: 'POST',
                //Solamente se envian los cambios
                params :	{
                ...
                success:function(response,options){
                    ...
                    if( res.success ){
                        storeProductos.each( function( record ){
                            if( record.data.idtrayecto==idtrayecto ){
                                 storeProductos.remove(record);
                            }
                        });
                    }
