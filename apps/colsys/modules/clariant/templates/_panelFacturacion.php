...
Ext.extend(PanelFacturacion, Ext.grid.EditorGridPanel, {
                ...
                Ext.Ajax.request(
                    {
                        ...
                        url: '<?=url_for("clariant/observePanelFacturacion?idclariant=".base64_encode($idclariant))?>',
						//method: 'POST',
    ...
    eliminarItem: function(){
        ...
        if( this.ctxRecord &&  confirm("Desea continuar?") ){
            ...
            {
                waitMsg: 'Eliminando...',
                url: '<?=url_for("clariant/eliminarFactura?idclariant=".base64_encode($idclariant))?>',
                //method: 'POST',
                //Solamente se envian los cambios
                params :	{
                    id: id,
