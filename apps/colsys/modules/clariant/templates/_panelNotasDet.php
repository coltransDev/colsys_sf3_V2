...
PanelNotasDet = function(){
    ...
    this.store = new Ext.data.Store({
        ...
        autoLoad : false,
        url: '<?=url_for("clariant/panelNotasDetData?idclariant=".base64_encode( $idclariant ) )?>',
                ...
                Ext.Ajax.request(
                    {
                        ...
                        url: '<?=url_for("clariant/observePanelNotasDet?idclariant=".base64_encode($idclariant))?>',
						//method: 'POST',
    ...
    eliminarItem: function(){
        ...
        if( this.ctxRecord &&  confirm("Desea continuar?") ){
            ...
            if( this.ctxRecord.data.idconcepto ){
                ...
                {
                    waitMsg: 'Eliminando...',
                    url: '<?=url_for("clariant/eliminarPanelNotasDet?idclariant=".base64_encode($idclariant))?>',
                    //method: 'POST',
                    //Solamente se envian los cambios
                    params :	{
                        id: id,
