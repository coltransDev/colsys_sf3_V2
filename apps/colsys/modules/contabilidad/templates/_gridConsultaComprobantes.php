    ...
    Ext.define('GridConsComprobantes',{
        ...
        store: Ext.create('Ext.data.Store', {
            fields: [
                ...
                { name: 'ca_idfacturado',        mapping: 'ca_idfacturado' },
                { name: 'ca_nomfacturado',        mapping: 'ca_nomfacturado' }
            ],
            autoLoad:false,
            remoteSort: false,
            proxy: {
        ...
        columns: [
            ...
            {text: "No. Comp"   ,    dataIndex: 'ca_consecutivo',    sortable: true,
                xtype:'templatecolumn',tpl:'<a href="javascript:verPdf(\'{ca_idcomprobante}\')" >{ca_consecutivo}</a>'},
            ...
            {text: "Id Cliente",      dataIndex: 'ca_idfacturado',      sortable: true},
            {text: "Cliente",      dataIndex: 'ca_nomfacturado',      sortable: true},            
