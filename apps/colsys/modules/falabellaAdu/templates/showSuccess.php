...
<tr>
<th>Ca reporte: </th>
<td><?php echo $fala_header->getCaReferencia() ?></td>
</tr>
<tr>
...
<hr />
<?php echo link_to('edit', 'falabellaAdu/edit?ca_iddoc='.$fala_header->getCaIddoc()) ?>
&nbsp;<?php echo link_to('list', 'falabellaAdu/list') ?>
