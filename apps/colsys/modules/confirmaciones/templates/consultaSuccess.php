...
<script language="javascript" type="text/javascript">
    ...
    function cambiarTextosFact(value) {
        if (value == "fletes") {
            ...
            var msg = "<?= str_replace("\n", "<br />", $textos['mensajeCertFletes']) ?>";
            $("#status_body").val(msg.split("<br />").join("\n"));
        } else if (value == "local") {
            var msg = "<?= str_replace("\n", "<br />", $textos['mensajeRecLocales']) ?>";
            $("#status_body").val(msg.split("<br />").join("\n"));
        }
    }
                    ...
                    <td class="mostrar" colspan="4" rowspan="6">
                        ...
                        <table id="status_fct" style="display: none;" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td class="mostrar"><input name="tipo_fact" id="tipo_fact" value="cert" type="radio" onclick="cambiarTextosFact(this.value)">Certificación de Fletes</td>
                                <td class="mostrar"><input name="tipo_fact" id="tipo_fact" value="local" type="radio" onclick="cambiarTextosFact(this.value)">Recargos Locales</td>
                            <table id="status_tbl" style="display: none;" cellspacing="1" width="100%">
                                <tbody>
                                    <tr>
