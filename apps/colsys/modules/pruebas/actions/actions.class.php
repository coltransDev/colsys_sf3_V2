...
ORDER BY ca_idtrayecto,ca_idconcepto,log_pricrecargosxconcepto.ca_idrecargo, ca_consecutivo ASC ";
    ...
    public function executeTraerProveedores(){
        ...
        /*    $proveedores = $reporte->getRepProveedor();
            ...
            foreach($proveedores as $proveedor){
                //echo "<pre>";print_r($proveedor);echo "</pre>";
                //exit();
                //echo $proveedor->getCaIdtercero()."<br/>";
                 
//+                $repProveedor = $proveedor->getRepProveedor();
                
                /*$repProveedor =  Doctrine::gettable("RepProveedor")
                        ->createQuery("rp")
                        ->where("rp.ca_idreporte = ?", $idreporte)
                        ->addWhere("rp.ca_idproveedor = ?", $proveedor->getCaIdtercero())
                        ->limit(1)
                        ->execute();
                        
                
                echo $repProveedor[0]->getCaIdrepproveedor().$repProveedor[0]->getCaIncoterms().$repProveedor[0]->getCaOrdenProv()."<br/>";
                ...
                if ($repProveedor) {
                    ...
                    $data["proveedor" . $i] = Utils::replace($proveedor->getCaNombre());
                    $data["incoterms" . $i] = $repProveedor[0]->getCaIncoterms();
                    $data["orden_pro" . $i] = $repProveedor[0]->getCaOrdenProv();
                    /*foreach($repProveedor as $rep){
                        echo $rep->getCaIdrepproveedor().$rep->getCaIncoterms().$rep->getCaOrdenProv()."<br/>";
                    }
                }
                $i++;
            }
        ...
        if($idproveedor){
            $repProveedor->addWhere("rp.ca_idproveedor = ?",$idproveedor);
        }
        
        $repProveedor->execute();
        $ordenes = "";
        if(count($repProveedor)>0){                        
            foreach($repProveedor as $proveedor){
                //echo "1777";
                $ordenes.= $repProveedor[0]->getCaIdrepproveedor();
                $ordenes.=" - ";
            }
        }
        ...
        foreach($proveedores as $proveedor){
            if($idproveedor){
                if($proveedor->getCaIdproveedor()==$idproveedor)
                    $ordenes.=$proveedor->getCaOrdenProv();
                else
                    continue;
            }else{
                $ordenes.=$proveedor->getCaOrdenProv();
    ...
    public function executeImportarProveedores() {
        ...
        $reportes = Doctrine::getTable("Reporte")
                ->createQuery("r")
                ->addWhere("r.ca_idreporte =?",339684)
        ...
        foreach($reportes as $reporte){
            //if ($reporte->getCaIdproveedor()) {
                ...
                $items = $values?count($values):($values1?count($values1):0);
                for ($i = 0; $i < $items; $i++) {
                    ...
                    $repProveedor->setCaIdproveedor(intval($values[$i]));
                    $repProveedor->setCaIncoterms($values1[$i]);
                    $repProveedor->setCaOrdenProv($values2[$i]);
                    $repProveedor->setCaUsucreado('alramirez');
                    $repProveedor->save();

                    //echo $reporte->getCaIdreporte()."|".$reporte->getCaIdproveedor()."<br/>";
                }
            //}            
        }
        //$offset=$offset+$limit;
...
//        $html="<div><caption>A continuacion encontrara el listado de Referencias por Desbloquear y el Libro de referencias</caption></div>";
        ...
        /*$html1 = '
              ...
              <span class="l11">Bogot&aacute;, 29 Agosto de 2014</span><br>
              <br>
...
<br><br><br>
        ...
        $html1 ='<html> // NotiColmas
            ...
            <meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
                                                    ...
                                                    <tbody><tr><td colspan="3">
                                                        ...
                                                        <tr>
                                                             ...
                                                             <div style="display:inline;" align="right">
                                                                ...
                                                                <!--<font size="4"><b><div style="display:inline"><font color="#0000ff" face="tahoma, sans-serif">                                                        
                                                                ...
                                                                <div style="font-family:tahoma,sans-serif;display:inline">
                                                                Apreciados Clientes,<br>
                                                                Adjunto encontrarán información muy importante acerca del cambio para hacer las consignaciones en BANCOLOMBIA.<br/>
                                                                Cualquier duda o información adicional estaremos atentos a atenderla.
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr><td colspan="5"><br><table width="100%" border="0" cellspacing="5" cellpadding="0" style="font-family:arial,sans-serif"><tbody><tr><td colspan="4">
                ...
                Usted ha recibido este mensaje por ser un cliente del grupo empresarial COLTRANS S.A.S, AGENCIA DE ADUANAS COLMAS LTDA Nivel 1 , COL OTM.<br/>
                                                        ...
                                                        <tr>
                                                             ...
                                                             <div style="display:inline;" align="right">
                                                                ...
                                                                <div style="font-family:tahoma,sans-serif;display:inline">
                                                                    ...
                                                                    Informamos que el d&iacute;a de hoy se ha presentado un da&ntilde;o con todas nuestras l&iacute;neas telef&oacute;nicas. La empresa ETB ya se encuentra revisando este inconveniente, pero mientras se logra una soluci&oacute;n definitiva, a continuaci&oacute;n suministramos un listado de los tel&eacute;fonos celulares a trav&eacute;s de los cuales podr&aacute;n comunicarse con nuestros departamentos:
                                                                    <br><br><br> 
                                                                    <table>
                                                                        <tbody>
                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">SERVICIO AL CLIENTE</td>                                                                                
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">310 212 42 01</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                            <td style="height:15pt;border-top-style:none" height="20">TRAFICO MARITIMO</td>                                                                            
                                                                            <td style="border-top-style:none;border-left-style:none" align="right">310 212 42 01</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">MARITIMO</td>                                                                                
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">314 358 26 89</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">AEREO</td>                                                                                
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">310 256 6747</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">EXPORTACIONES</td>
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">313 294 06 38</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">CUENTAS GLOBALES</td>
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">320 349 81 53</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">PRICING</td>                                                                                
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">314 295 75 58</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">ADUANAS - AGENCIA DE ADUANAS COLMAS</td>                                                                                
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">311 514 02 50 - 310 572 93 73</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">FINANCIERO</td>
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">313 467 63 20</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">CONTABILIDAD</td>                                                                                
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">320 801 35 36</td>
                                                                            </tr>

                                                                            <tr style="height:15pt" height="20">
                                                                                <td style="height:15pt;border-top-style:none" height="20">ADMINISTRATIVO</td>                                                                                
                                                                                <td style="border-top-style:none;border-left-style:none" align="right">320 863 37 37</td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
        ...
        $conteo = 0;
        $emails_Control = "";
        $asunto = "DAÑO EN LINEAS TELEFONICAS COLTRANS S.A.S - AGENCIA DE ADUANAS COLMAS LTDA NIVEL 1 - OFC BOGOTA";
        $emailFrom = "administrativobog@coltrans.com.co";
        $tipo_email = "Comunicado";
        $fromName = "COLTRANS S.A.S.";
