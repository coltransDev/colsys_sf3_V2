...
Ext.extend(FormComprobanteSubpanelConceptos, Ext.grid.EditorGridPanel, {
    height: 300,
    title: 'Conceptos',
    ...
    eliminarItem : function(){
        ...
        if( this.ctxRecord && this.ctxRecord.data.idtransaccion && confirm("Desea continuar?") ){
            ...
            {
                waitMsg: 'Eliminando...',
                url: '<?=url_for("inocomprobantes/eliminarFormComprobanteSubpanelConceptos?idcomprobante=".$comprobante->getCaIdcomprobante())?>',
                //method: 'POST',
                //Solamente se envian los cambios
                params :	{
                    id: id,
