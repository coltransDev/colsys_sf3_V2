...
<table align="center" width="500"><td><div id="formulario_bodegas" style="width: 700px"></div></td></table>
    ...
    FormBodegaPanel = function( config ){
        ...
        FormBodegaPanel.superclass.constructor.call(this, {
            ...
            tbar: [
            {
				...
				id     : 'verificarbtn',
				//handler: function(){
				//	Ext.getCmp('certificarbtn').setDisabled(false);
				//}
            },
			//{
			//	text: 'Certifico que he verificado las bodegas',
			//	disabled: true,
			//	id     : 'certificarbtn',
			//	handler: function(){
