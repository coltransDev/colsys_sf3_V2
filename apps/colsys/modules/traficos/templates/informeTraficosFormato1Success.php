...
$objPHPExcel->getProperties()->setLastModifiedBy("Dpto de Servicio al Cliente");//TODO, verificar sucursales y aereo
...
foreach ($reportes as $reporte) {
    ...
    /*
      ...
      if( !$reporte->getEsAG()&&$reporte->getCaImpoExpo()=="Importación"&&!$reporte->getReporteExterior() ){
      continue;
      } */
