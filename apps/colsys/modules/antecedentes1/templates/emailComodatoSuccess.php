...
<div align="center">
      <h2>INFORMACION PARA CONTENEDORES</h2><br/>
...
<div class="content">
    ...
    <div id="emailForm"  style="display:none" align="center">
        ...
        $asunto  = "Envio de Información para Contenedores ".$ref->getCaReferencia();
        $mensaje = "Adjunto encontrará los datos de contenedores para la referencia ".$ref->getCaReferencia();
    ...
    <br />
    <div align="center">
        <h2>Informaci&oacute;n para Divisi&oacute;n de Contenedores</h2>
