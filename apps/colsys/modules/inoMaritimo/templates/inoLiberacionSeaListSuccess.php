    ...
    <table width="600" border="1" cellspacing="1" cellpadding="5" class="tableList">
        <tbody>
            ...
            foreach ($data as $key => $referencia) {
                ?>
                <tr>
                    <td class="listar" rowspan="3" style="vertical-align: top; font-weight: bold"><a href="/inoMaritimo/formLiberacionSeaExt5/id/<?= base64_encode($referencia["ca_referencia"]) ?>"><?= $referencia["ca_referencia"] ?></a></td>
                    <td class="listar" colspan="6" style="font-weight: bold"><?= $referencia["ca_impoexpo"] ?></td>
                </tr>
                <tr>
