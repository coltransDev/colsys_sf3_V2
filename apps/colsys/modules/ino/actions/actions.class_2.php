        ...
        if ($request->isMethod('post')) {
            ...
            if ($this->form->isValid()) {
                ...
                try {
                    ...
                    $inoDetalle->setCaIdcomprobante( $comprobante->getCaIdcomprobante() );
                    $inoDetalle->setCaDb( $valor );
                    $inoDetalle->setCaIdconcepto( $bindValues["idcosto"]  );       
                                      
                    $inoDetalle->setCaIdmaster( $referencia->getCaIdmaster() );
                    $inoDetalle->setCaId( $bindValues["idproveedor"] );
                    $inoDetalle->save( $conn ); 
