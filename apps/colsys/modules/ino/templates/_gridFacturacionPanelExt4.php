...
include_component("ino", "formFacturaExt4", array("idmaster" => $idmaster));
...
//Ext.Loader.setPath('Ext.ux', '../ux');
    ...
    extend: 'Ext.data.Model',
            ...
            {name: 'fchcomprobante', type: 'date', type: 'date', dateFormat: 'Y-m-d'},
            ...
            model: 'recfac',
                    proxy: {
                    type: 'ajax',
                            url: '<?= url_for('ino/datosFacturas?idmaster=' . $idmaster) ?>',
                            reader: {
                            type: 'json',
                                    root: 'root'
                            }
            ...
            Ext.define('Ext.colsys.gridFacturacion', {
            extend: 'Ext.grid.Panel',
                    alias: 'widget.gFacturacion',
                    store: store,
                    //id:'grid-facturacion',
                    features: [{
                    id: 'comprobante',
...
?>
            ...
            plugins: [
                    ...
                    var rec = e.record;
                            ...
                            if (e.field == "concepto")
                    {
                    Ext.getCmp("combo-cosnceptos").setModo('<?= $modo->getCaIdmodo() ?>')
                    }
                    },
                            ...
                            text: 'Anular Comprobante',
                                    ...
                                    Ext.MessageBox.confirm('Confirmacion', 'esta seguro de Anular el Comprobante',
                                            ...
                                            var box = Ext.MessageBox.wait('Procesando', 'Anulando Comprobante')
                                                    Ext.Ajax.request({
                                                    url: '<?= url_for("ino/AnularComprobante") ?>',
                                                            params: {
                                                            idcomprobante: record.get('idcomprobante'),
                                                                    modo:'<?= $modo->getCaIdmodo() ?>'
                                                            },
                            ...
                            text: 'Enviar a Siigo',
                                    ...
                                    Ext.MessageBox.confirm('Confirmacion', 'esta seguro de generar de nuevo el Comprobante',
                                            ...
                                            var box = Ext.MessageBox.wait('Procesando', 'Enviando Comprobante')
                                                    Ext.Ajax.request({
                                                    url: '<?= url_for("ino/EnviarSiigoConect") ?>',
                                                            params: {
                                                            idcomprobante: record.get('idcomprobante')
                                                            },
                                                            success: function(response, opts) {
