...
include_component("ino", "gridHousePanelExt4",array("idmaster"=>$idmaster,"modo"=>$modo,"permisos"=>$permisos,"readOnly"=>$readOnly));
include_component("ino", "gridFacturacionPanelExt4",array("idmaster"=>$idmaster,"modo"=>$modo,"permisos"=>$permisos,"readOnly"=>$readOnly));

if($permisos["restringido"]!=true)
    include_component("ino", "gridCostosPanelExt4",array("idmaster"=>$idmaster,"modo"=>$modo,"permisos"=>$permisos,"readOnly"=>$readOnly));
