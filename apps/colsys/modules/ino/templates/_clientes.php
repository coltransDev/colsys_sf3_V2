...
<table class="tableList" width="100%">
    ...
    foreach( $inoClientes as $inoCliente ){
        ?>        
        <tr >
            <td><?=$inoCliente->getCliente()->getCaIdcliente()?></td>
            <td><?=$inoCliente->getCliente()->getCaCompania()?></td>
            ...
            <td> <?=link_to(image_tag("16x16/edit.gif"), "ino/formClientes?id=".$referencia->getCaIdmaestra()."&idinocliente=".$inoCliente->getCaIdinocliente())?> </td>
        </tr>
        <?
    }
    ?>
