    ...
    Ext.define('GridConsComprobantes',{
        ...
        columns: [
            ...
            {text: "no. Ref",     dataIndex: 'ca_referencia',     sortable: true,width:130,
                xtype:'templatecolumn',tpl:'<a href="/ino/verReferenciaExt4/modo/5/idmaster/{ca_idmaster}" target="_blank">{ca_referencia}</a>'
            },
            ...
            {text: "Empresa",           dataIndex: 'empresa',           sortable: true}
        ],
        tbar: botones,        
        height:500,
        viewConfig: {
