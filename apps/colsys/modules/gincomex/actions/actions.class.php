...
class gincomexActions extends sfActions {
	...
	*/
        ...
        $url = sfConfig::get('app_gincomex_url');
        $pass = sfConfig::get('app_gincomex_pass');
        ...
        try {
            ...
            $client->__soapCall("nuevasOrdenes", array('clave' => '$pass'));
                ...
                foreach($records as $record){       // Hace una primera lectura para verificar la estructura del archivo
                    ...
                    if(strpos(strtolower($record), 'pais') === FALSE) {
                        ...
                        if ($fields[2] != $docCompra){
                            ...
                            $gincomex = new Gincomex();
                            $gincomex->setCaPais($fields[0]);
                            $gincomex->setCaProveedor($fields[1]);
                            $gincomex->setCaOrden($fields[2]);
                            $gincomex->setCaDocumentoFch($documentoFch);
                            $gincomex->setCaIncoterm($fields[8]);
                            $gincomex->save();

                            $idgincomex = $gincomex->getCaIdgincomex();
                            $docCompra  = $fields[2];
                        }
                        ...
                        $clarDetail->setCaIdgincomex($idgincomex);
