...
switch ($action) {
    ...
    case "index":
        ...
        if ($permiso <= 1) {
        $button[$i]["name"] = "Nueva Opci&oacute;n";
        $button[$i]["tooltip"] = "Nueva Opci&oacute;n";
        $button[$i]["image"] = "formularios/add.gif";
        $button[$i]["link"] = "opcion/new";
        $i++;
        }
        break;
    case "filtrar":
    ...
    case "show":
        ...
        if ($permiso <= 1) {
        $button[$i]["name"] = "Editar Opci&oacute;n";
        $button[$i]["tooltip"] = "Editar Opci&oacute;n";
        $button[$i]["image"] = "formularios/edit.gif";
        $button[$i]["link"] = "opcion/edit?ca_id=" . $this->getRequestParameter('ca_id');
        $i++;
        }
        break;
    case "edit":
        ...
        $button[$i]["link"] = "opcion/show?ca_id=" . $this->getRequestParameter('ca_id');
        $i++;
        }
        if ($permiso <= 1) {
        ...
        $button[$i]["link"] = "opcion/delete?ca_id=" . $this->getRequestParameter('ca_id');
        $i++;
        }
        break;
    case "create":
