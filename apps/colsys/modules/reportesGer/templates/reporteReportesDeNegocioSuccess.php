<center>    
    <h3>Reportes de Negocio por Periodo</h3>
    <br />


    <form method="post" id="reporteCargaForm" action="reporteReportesDeNegocioList">
        <table width="600" border="0" cellspacing="1" cellpadding="5" class="tableList">
            ...
            <tr>
                ...
                <td class="listar">Fecha Inicial : <br/>
                    <div id="fch_ini_div"></div>
                </td>    
                <td class="listar">Fecha Final : <br/>
                    <div id="fch_fin_div"></div>
                </td>    
            </tr>
            <tr>
...
<script type="text/javascript">
    var fch_ini_div = document.getElementById('fch_ini_div');
    var fch_fin_div = document.getElementById('fch_fin_div');
