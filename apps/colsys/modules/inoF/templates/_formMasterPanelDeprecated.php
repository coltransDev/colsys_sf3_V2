...
<script type="text/javascript">
    ...
    Ext.extend(FormMasterPanel, Ext.form.FormPanel, {
        onSave: function(){        
            ...
            if( form.isValid() ){
                form.submit({
                    url: "<?= url_for("inoF/guardarMaster") ?>",
                    waitMsg:'Guardando...',
                    ...
                    success:function(form,action){
                        document.location = "<?=url_for("inoF/verReferenciaExt4")?>?modo="+modo+"&idmaster="+action.result.idmaster;
                    },
        ...
        onCancel: function(){
            ...
            if( this.idmaster ){
                document.location = "<?=url_for("inoF/verReferenciaExt4")?>?modo="+this.modo+"&idmaster="+this.idmaster;
            }else{
                document.location = "<?=url_for("inoF/index")?>?modo="+this.modo;
            }
        },
        onRender:function() {
