...
<script type="text/javascript">
    ...
    GridAuditoriaPanel = function( config ){
        ...
        this.store = new Ext.data.GroupingStore({
            ...
            autoLoad : true,
            url: '<?= url_for("inoF/datosGridAuditoriaPanel") ?>',
            baseParams : {
    ...
    Ext.extend(GridAuditoriaPanel, Ext.grid.GridPanel, {
        ...
        newItem: function(){
            document.location = "<?= url_for("inoF/formAuditoria") ?>?modo="+this.modo+"&idmaster="+ this.idmaster;
        },
        ...
        eliminar: function( idevento, gridId ){
            ...
            Ext.Ajax.request(
            {               
                url: '<?= url_for("inoF/eliminarGridAuditoriaPanel") ?>',
                params :	{
                    idevento: idevento,
                    modo: modo                        
                },
