...
<script type="text/javascript">
    GridAuditoriaComentarioFormPanel = function( config ) {
        ...
        GridAuditoriaFormPanel.superclass.constructor.call(this, {            
            autoHeight: true,
            autoWidth: true,
            id: 'form-auditoria',
            items: this.items,
    ...
    Ext.extend(GridAuditoriaComentarioFormPanel, Ext.form.FormPanel, {
        ...
        onRender:function() {
            ...
            if( this.idcomprobante ){
                ...
                this.load({
                    url:'<?= url_for("inoF/datosGridFacturacionFormPanel") ?>',
                    waitMsg:'Cargando...',
