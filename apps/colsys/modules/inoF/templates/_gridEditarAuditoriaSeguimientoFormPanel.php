...
<script type="text/javascript">
    GridEditarAuditoriaSeguimientoFormPanel = function( config ) {
        ...
        GridEditarAuditoriaSeguimientoFormPanel.superclass.constructor.call(this, {            
            autoHeight: true,
            autoWidth: true,
            id: 'form-auditoria',
            items: this.items,
    ...
    Ext.extend(GridEditarAuditoriaSeguimientoFormPanel, Ext.form.FormPanel, {
