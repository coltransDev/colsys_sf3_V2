...
GridCostosDiscriminadosPanel = function( config ){
    ...
    this.store = new Ext.data.GroupingStore({
        ...
        autoLoad : true,
        url: '<?=url_for("inoF/datosGridCostosDiscriminadosPanel")?>',
        baseParams : {
...
Ext.extend(GridCostosDiscriminadosPanel, Ext.grid.GridPanel, {
    ...
    newItem: function(){
        document.location = "<?=url_for("inoF/formCostoDiscriminados")?>?modo="+this.modo+"&idmaster="+ this.idmaster;
    },
    ...
    onRowDblclick: function( grid , rowIndex, e ){
		if( !this.readOnly ){
            ...
            document.location = "<?=url_for("inoF/formCostoDiscriminados")?>?modo="+this.modo+"&idmaster="+record.data.idmaster+"&idcomprobante="+record.data.idcomprobante;
        }
	}
    ,
                ...
                Ext.Ajax.request(
                    {
                        ...
                        url: '<?=url_for("inoF/guardarGridCostosDiscriminadosPanel")?>',
                        params :	changes,
