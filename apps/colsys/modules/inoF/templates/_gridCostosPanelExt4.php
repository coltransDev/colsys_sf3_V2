 ...
 */   
   ...
   var store = Ext.create('Ext.data.Store', {
     ...
     proxy: {
         type: 'ajax',
         url: '<?=url_for('inoF/datosGridCostosPanel?idmaster='.$idmaster)?>',         
         reader: {
             type: 'json',
             root: 'root',
             totalProperty: 'total'
...
Ext.define('Ext.colsys.gridCosto', {
  ...
  alias: 'widget.gCosto',
    ...
    tbar: [{
        ...
        iconCls: 'add',
        handler : function(){
            document.location = "<?=url_for("inoF/formCosto")?>?modo=<?=$modo->getCaIdmodo()?>&idmaster=<?=$idmaster?>";       
            ...
            items: [
              {
                    text: 'Editar',                    
                    handler: function() {
                    document.location = "<?=url_for("inoF/formCosto")?>?modo=<?=$modo->getCaIdmodo()?>&idinocosto="+record.get('idinocosto');
                    }
                },
                {
                    text: 'Eliminar',
