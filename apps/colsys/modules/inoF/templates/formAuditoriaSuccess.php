...
<div class="content" align="center">
    ...
    <form action="<?= url_for("inoF/formAuditoria?modo=" . $modo->getCaIdmodo() . "&idmaster=" . $idmaster) ?>" method="post">          
            ...
            <tr>
                <td colspan="6">
                    <div align="center">
                        ...
                        &nbsp;
                        <input type="button" value="Cancelar" class="button" onclick="document.location='<?=url_for("inoF/verReferencia?modo=".$modo->getCaIdmodo()."&idmaster=".$idmaster) ?>'" />
                    </div>
                </td>
            </tr>
        </table>
