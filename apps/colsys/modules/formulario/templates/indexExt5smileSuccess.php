...
<script>
    ...
    //                                                Ext.MessageBox.alert("Mensaje", 'Muchas gracias por su tiempo!!! Sus datos han sido diligenciados correctamente.');
                                        ...
                                        Ext.MessageBox.alert("Mensaje", 'Por favor seleccione la encuesta desde el enlace enviado en el correo!');
                                    }
                                }else{
                                    Ext.MessageBox.alert("Mensaje", 'Por favor complete todos los campos resaltados en rojo!');
                                }
                            }
                        }],
                        listeners:{
