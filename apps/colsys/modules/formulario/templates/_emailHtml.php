            ...
            <tr>
                <td style="padding:20px"  >
                    <div style="text-align: justify;font-size: 12px">
                        <p>Para <?=  strtoupper($empresa->getCaNombre())?> es importante conocer lo que más le gusta de nuestro servicio, queremos que nos brinde la oportunidad de trabajar en esos  aspectos que podemos mejorar.</p>
                        ...
                        <div style="text-align:center; font-size: 15px;">
                            <a href="https://10.192.1.70/formulario/servicios/id/<?php echo base64_encode($idformulario) ?>/co/<?php echo base64_encode($contacto) ?>">Encuesta de servicio</a>
                        </div><br/><br/><br/>
                        <hr>
