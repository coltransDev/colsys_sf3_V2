                    ...
                    <table width="100%" border="0" cellspacing="15" cellpadding="0" bgcolor="#FFFFFF"><tr><td>
                                ...
                                <table width="100%" border="0" cellspacing="5" cellpadding="0">
                                    ...
                                    <tr><td colspan="3"><table><tr><td width="135"><img src="https://www.coltrans.com.co/images/logo_colsys.gif" width="178" height="30" alt="COLSYS"></td>
                                                    <td><font size="4" face="arial, helvetica, sans-serif" color="#D99324">Aprobación de Proveedor</font></td></tr></table></td></tr>
                                    ...
                                    <tr>
                                        <td>&nbsp;</td><td>
                                            ...
                                            Nos permitimos informarle que el proveedor <b> <?=$nombre?></b> ha sido correctamente creado en el sistema. <br /><br />
                                            Proceda por favor a dar su aprobación: <br /><a href="https://www.coltrans.com.co/ids/verIds/modo/prov/id/<?=$id?>"><b>Aprobar</b></a>
                                            </div>
