        ...
        if($l->TipoDoc != "PR"){
                ...
                if($l->TipoDoc != "PC" ){                    
                    ...
                    if(substr($idalterno, 0, 4) != "4444"){
                        ...
                        if(is_object($cliente))
                            ...
                            $ids = "SIN IDENTIFICAR EN COLSYS. REVISAR";
                            $class = "row_pink";
                        }
                    }else{                        
            ...
            if($l->TipoDoc == "C" || $l->TipoDoc=="RC"){
                ...
                $q = Doctrine::getTable("InoComprobante")
                        ...
                        ->select("ca_consecutivo,ca_fchanulado")
                        ->where("ca_consecutivo = ? AND ca_docentry = ? and tc.ca_prefijo_sap in ('V','RV') AND ca_aplicacion >=1", array(intval($l->CodigoDoc), intval($l->DocEntry)))                        
                        ->fetchOne();
                ...
                if(is_object($q)){
                    if($q->getCaFchanulado() != null || $q->getCaFchanulado() != ""){
//                        echo "anulado".$q->getCaFchanulado();
                        $class="row_purple";
                        $anulado = "anulado3";
                    }
                }else{
...
<table class="tableList">        
    ...
    <tr class="row_pink"><td>COMPROBANTE NO EXISTE EN COLSYS. FAVOR REVISAR CON CONTABILIDAD</td></tr>
