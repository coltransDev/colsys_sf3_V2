                                                    ...
                                                    foreach( $files as $file ){
                                                        ?>
                                                           <li>
                                                               ...
                                                               <a style="text-decoration:none;color:#0000FF;" href="https://www.coltrans.com.co<?=url_for("/gestDocumental/verArchivo?folder=".base64_encode($formulario->getDirectorioBase())."&idarchivo=".base64_encode(basename($file)))?>" target="_blank">
                                                                <b><?=basename($file)?></b>
                                                            </a>
